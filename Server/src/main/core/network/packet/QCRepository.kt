...
import core.network.packet.incoming.QCPacketType
...
object QCRepository {
    ...
    fun sendQC(
        ...
        player?.setAttribute(
            "qc_offset",
            offset
        ) //Slapping this in an attribute because it's only useful for one or two messages
        ...
        if (forClan) {
            ...
            builder.clanName = player.communication.clan.owner.lowercase().replace(" ", "_")
    ...
    fun getSingleQC(index: Int, selectionIndex: Int): String {
        ...
        if ((qcString.contains("item") || qcString.contains("Can I buy your") || qcString.contains("What is the best world to buy") || qcString.contains(
                "What is the best world to sell"
            ) || qcString.contains("Would you like to borrow") || qcString.contains("Could I please borrow")) && qcString.contains(
                "<"
            )
        ) {
        ...
        //Cooking
        else if (qcString.contains("I'm cooking") || qcString.contains("Would you please cook me") || qcString.contains(
                "Try cooking"
            )
        ) {
        ...
        //Fishing
        else if (qcString.contains("I'm fishing") || qcString.contains("Would you please fish me") || qcString.contains(
                "Try fishing for"
            )
        ) {
        ...
        //Herblore
        else if (qcString.contains("I'm mixing potion") || qcString.contains("Would you please mix me a potion") || qcString.contains(
                "Try mixing potion"
            )
        ) {
