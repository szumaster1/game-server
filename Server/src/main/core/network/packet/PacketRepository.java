...
public final class PacketRepository {
    ...
    static {
        ...
        OUTGOING_PACKETS.put(LogoutPacket.class, new LogoutPacket());
        ...
        OUTGOING_PACKETS.put(AnimateScenery.class, new AnimateScenery());
        ...
        //OUTGOING_PACKETS.put(WeightUpdatePacket.class, new WeightUpdatePacket());
        ...
        OUTGOING_PACKETS.put(CSConfig.class, new CSConfig());
