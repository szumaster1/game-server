    ...
    */
    ...
    public void initCombatGraphics(Map<String, Object> config) {
        ...
        if (config.containsKey(NPCConfigParser.PROJECTILE)) {
            combatGraphics[1] = new Graphic((Integer) config.get(NPCConfigParser.PROJECTILE), getConfiguration(NPCConfigParser.PROJECTILE_HEIGHT, 42));
        }
        if (config.containsKey(NPCConfigParser.END_GRAPHIC)) {
            combatGraphics[2] = new Graphic((Integer) config.get(NPCConfigParser.END_GRAPHIC), getConfiguration(NPCConfigParser.END_HEIGHT, 96));
        }
    }
