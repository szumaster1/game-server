...
object Vars {
    ...
    const val VARP_ROMEO_AND_JULIET_NOTSET_NOTSET_ = 2629 // 10-100
    const val VARP_WATCHTOWER_NOTSET_NOTSET_ = 2397 // 1-13
    const val VARP_ERNEST_THE_CHICKEN_NOTSET_NOTSET_ = 2183 // 1-3
    const val VARP_RESTLESS_GHOST_NOTSET_NOTSET_ = 2324 // 1-5
    const val VARP_MURDER_MYSTERY_NOTSET_NOTSET_ = 2364 // 1-2
    const val VARP_DWARF_CANNON_NOTSET_NOTSET_ = 2732 // 1-11
    const val VARP_SHEEP_HERDER_NOTSET_NOTSET_ = 2274 // 1-3
    const val VARP_TRIBAL_TOTEM_NOTSET_NOTSET_ = 2783 // 1-5
    const val VARP_CLOCK_TOWER_NOTSET_NOTSET_ = 2197 // 1-8
    const val VARP_RUNE_MYSTERIES_NOTSET_NOTSET_ = 2689 // 1-6
    const val VARP_PLAGUE_CITY_NOTSET_NOTSET_ = 2386 // 1-29
    const val VARP_JUNGLE_POTION_NOTSET_NOTSET_ = 2484 // 1-12
    const val VARP_PIRATE_TREASURE_NOTSET_NOTSET_ = 2227 // 1-4
    const val VARP_SHIELD_OF_ARRAV_NOTSET_NOTSET_ = 2738 // 1-7
    const val VARP_DRAGON_SLAYER_NOTSET_NOTSET_ = 2268 // 1-10
    const val VARP_SHILO_VILLAGE_NOTSET_NOTSET_ = 2793 // 1-15
    const val VARP_IMP_CATCHER_NOTSET_NOTSET_ = 2669 // 1-2
    const val VARP_EADGARS_RUSE_NOTSET_NOTSET_ = 2549 // 10-110
    const val VARP_FISHING_CONTEST_NOTSET_NOTSET_ = 2331 // 1-5
    const val VARP_TROLL_STRONGHOLD_NOTSET_NOTSET_ = 2347 // 10-50
    const val VARP_TROLL_ROMANCE_NOTSET_NOTSET_ = 2135 // 1-45
    const val VARP_CREATURE_OF_FENKENSTRAIN_NOTSET_NOTSET_ = 2615 // 1-8
    const val VARP_WATERFALL_NOTSET_NOTSET_ = 2353 // 1-10
    const val VARP_RUM_DEAL_NOTSET_NOTSET_ = 2100 // 1-19
    const val VARP_BIG_CHOMPY_BIRD_HUNTING_NOTSET_NOTSET_ = 2772 // 5-65
    const val VARP_MERLIN_CRYSTAL_NOTSET_NOTSET_ = 2178 // 1-7
    const val VARP_ROVING_ELVES_NOTSET_NOTSET_ = 2286 // 2-6
    const val VARP_HOLY_GRAIL_NOTSET_NOTSET_ = 2330 // 2-10
    const val VARP_FAMILY_CREST_NOTSET_NOTSET_ = 2663 // 1-11
    const val VARP_HAUNTED_MINE_NOTSET_NOTSET_ = 2201 // 1-11
    const val VARP_SEA_SLUG_NOTSET_NOTSET_ = 2700 // 1-12
    const val VARP_HAAZEL_CULT_NOTSET_NOTSET_ = 2592 // 2-9
    const val VARP_TEMPLE_OF_IKOV_NOTSET_NOTSET_ = 2148 // 10-80
    const val VARP_BIOHAZARD_NOTSET_NOTSET_ = 2535 // 1-16
    const val VARP_MONKEY_MADNESS_NOTSET_NOTSET_ = 2762 // 1-9
    const val VARP_NATURE_SPIRIT_NOTSET_NOTSET_ = 2355 // 5-110
    const val VARP_GERTRUDES_CAT_NOTSET_NOTSET_ = 2175 // 1-6
    const val VARP_ONE_SMALL_FAVOUR_NOTSET_NOTSET_ = 2671 // 5-280
    const val VARP_CABIN_FEVER_NOTSET_NOTSET_ = 2326 // 10-140
    const val VARP_FREMENNIK_TRAILS_NOTSET_NOTSET_ = 2262 // 1-10
    ...
    const val VARBIT_IFACE_WARNING_MESSAGES_1045 = 1045
    const val VARBIT_IFACE_GRAVE_DISPLAY = 4191
    const val VARBIT_IFACE_QUICKCHAT_TUTORIAL_4762 = 4762
    ...
    const val VARBIT_SCENERY_BREWING_VAT = 736
    const val VARBIT_SCENERY_BREWING_VAT_WITH_WATER = 737
    ...
    const val VARBIT_VARROCK_MUSEUM_CENSUS = 5390

    const val VARBIT_MINI_QUEST_MOGRE_AND_SKIPPY = 1344
}
