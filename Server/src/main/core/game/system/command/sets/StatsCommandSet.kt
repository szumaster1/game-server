                ...
                when(pageNum) {
                    0 -> {
                        when(i) {
                            ...
                            //Boss KC
                            82 -> sendLine(player, "KBD KC: ${globalData.getBossCounters()[BossKillCounter.KING_BLACK_DRAGON.ordinal]}",i)
                            83 -> sendLine(player, "TDs KC: ${globalData.getBossCounters()[BossKillCounter.TORMENTED_DEMONS.ordinal]}",i)
                            84 -> sendLine(player, "Supreme KC: ${globalData.getBossCounters()[BossKillCounter.DAGANNOTH_SUPREME.ordinal]}",i)
                            85 -> sendLine(player, "Rex KC: ${globalData.getBossCounters()[BossKillCounter.DAGANNOTH_REX.ordinal]}",i)
                            86 -> sendLine(player, "Prime KC: ${globalData.getBossCounters()[BossKillCounter.DAGANNOTH_PRIME.ordinal]}",i)
                            87 -> sendLine(player, "Barrows KC: ${globalData.getBarrowsLoots()}",i)
                            88 -> sendLine(player, "Chaos Ele: ${globalData.getBossCounters()[BossKillCounter.CHAOS_ELEMENTAL.ordinal]}",i)
                            89 -> sendLine(player, "Mole KC: ${globalData.getBossCounters()[BossKillCounter.GIANT_MOLE.ordinal]}",i)
                            90 -> sendLine(player, "Sara KC: ${globalData.getBossCounters()[BossKillCounter.SARADOMIN.ordinal]}",i)
                            91 -> sendLine(player, "Zammy KC: ${globalData.getBossCounters()[BossKillCounter.ZAMORAK.ordinal]}",i)
                            92 -> sendLine(player, "Bandos KC: ${globalData.getBossCounters()[BossKillCounter.BANDOS.ordinal]}",i)
                            93 -> sendLine(player, "Arma KC: ${globalData.getBossCounters()[BossKillCounter.ARMADYL.ordinal]}",i)
                            94 -> sendLine(player, "Jad KC: ${globalData.getBossCounters()[BossKillCounter.JAD.ordinal]}",i)
                            95 -> sendLine(player, "KQ KC: ${globalData.getBossCounters()[BossKillCounter.KALPHITE_QUEEN.ordinal]}",i)
                            96 -> sendLine(player, "Corp KC: ${globalData.getBossCounters()[BossKillCounter.CORPOREAL_BEAST.ordinal]}",i)
