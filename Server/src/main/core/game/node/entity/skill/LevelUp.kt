...
object LevelUp {
    ...
    private val SKILLCAPES = intArrayOf(
        9747, 9753, 9750, 9768, 9756, 9759, 9762, 9801, 9807, 9783, 9798, 9804, 9780, 9795, 9792, 9774, 9771, 9777, 9786, 9810, 9765, 9948, 9789, 12169
    )
    private val SKILL_ICON = intArrayOf(
        67108864, 335544320, 134217728, 402653184, 201326592, 469762048, 268435456, 1073741824, 1207959552, 1275068416, 1006632960, 1140850688, 738197504, 939524096, 872415232, 603979776, 536870912, 671088640, 1342177280, 1409286144, 805306368, 1543503872, 1476395008, 1610612736, 1677721600
    )
    private val FLASH_ICONS = intArrayOf(
        1, 4, 2, 64, 8, 16, 32, 32768, 131072, 2048, 16384, 65536, 1024, 8192, 4096, 256, 128, 512, 524288, 1048576, 262144, 4194304, 2097152, 8388608, 16777216
    )
    private val ADVANCE_CONFIGS = intArrayOf(
        9, 40, 17, 49, 25, 57, 33, 641, 659, 664, 121, 649, 89, 114, 107, 72, 64, 80, 673, 680, 99, 698, 689, 705
    )
    private val CLIENT_ID = intArrayOf(
        1, 5, 2, 6, 3, 7, 4, 16, 18, 19, 15, 17, 11, 14, 13, 9, 8, 10, 20, 21, 12, 23, 22, 24, 24
    )
    private val SKILL_MILESTONES = intArrayOf(
        1, 50, 75, 100
    )
    private val COMBAT_MILESTONES = intArrayOf(
        3, 5, 10, 15, 25, 75, 90, 100, 110, 120, 126, 130, 138
    )
    private val TOTAL_LEVEL_MILESTONES = intArrayOf(
        50, 75, 100, 150, 200, 300, 400, 500, 600, 700, 800, 900, 1000,
