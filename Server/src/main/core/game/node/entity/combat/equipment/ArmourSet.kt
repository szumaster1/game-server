...
enum class ArmourSet(private val endGraphic: Graphic?, set: Array<IntArray>) {
    ...
    AHRIM(
        ...
        set = arrayOf(
            ...
            intArrayOf(Items.AHRIMS_ROBETOP_4712, Items.AHRIMS_TOP_100_4868, Items.AHRIMS_TOP_75_4869, Items.AHRIMS_TOP_50_4870, Items.AHRIMS_TOP_25_4871),
            intArrayOf(Items.AHRIMS_ROBESKIRT_4714, Items.AHRIMS_SKIRT_100_4874, Items.AHRIMS_SKIRT_75_4875, Items.AHRIMS_SKIRT_50_4876, Items.AHRIMS_SKIRT_25_4877)
        )
    ) {
    ...
    DHAROK(
        ...
        set = arrayOf(
            ...
            intArrayOf(Items.DHAROKS_PLATEBODY_4720, Items.DHAROKS_BODY_100_4892, Items.DHAROKS_BODY_75_4893, Items.DHAROKS_BODY_50_4894, Items.DHAROKS_BODY_25_4895),
            intArrayOf(Items.DHAROKS_PLATELEGS_4722, Items.DHAROKS_LEGS_100_4898, Items.DHAROKS_LEGS_75_4899, Items.DHAROKS_LEGS_50_4900, Items.DHAROKS_LEGS_25_4901)
        )
    ) {
        override fun isUsing(e: Entity?): Boolean {
            // Check if the entity is an NPC with a specific ID
    ...
    GUTHAN(
        ...
        set = arrayOf(
            ...
            intArrayOf(Items.GUTHANS_PLATEBODY_4728, Items.GUTHANS_BODY_100_4916, Items.GUTHANS_BODY_75_4917, Items.GUTHANS_BODY_50_4918, Items.GUTHANS_BODY_25_4919),
            intArrayOf(Items.GUTHANS_CHAINSKIRT_4730, Items.GUTHANS_SKIRT_100_4922, Items.GUTHANS_SKIRT_75_4923, Items.GUTHANS_SKIRT_50_4924, Items.GUTHANS_SKIRT_25_4925)
        )
    ) {
        override fun effect(e: Entity, victim: Entity, state: BattleState): Boolean {
    ...
    KARIL(
        ...
        set = arrayOf(
            ...
            intArrayOf(Items.KARILS_LEATHERTOP_4736, Items.KARILS_TOP_100_4940, Items.KARILS_TOP_75_4941, Items.KARILS_TOP_50_4942, Items.KARILS_TOP_25_4943),
            intArrayOf(Items.KARILS_LEATHERSKIRT_4738, Items.KARILS_SKIRT_100_4946, Items.KARILS_SKIRT_75_4947, Items.KARILS_SKIRT_50_4948, Items.KARILS_SKIRT_25_4949)
        )
    ) {
        override fun effect(e: Entity, victim: Entity, state: BattleState): Boolean {
    ...
    TORAG(
        ...
        set = arrayOf(
            ...
            intArrayOf(Items.TORAGS_PLATEBODY_4749, Items.TORAGS_BODY_100_4964, Items.TORAGS_BODY_75_4965, Items.TORAGS_BODY_50_4966, Items.TORAGS_BODY_25_4967),
            intArrayOf(Items.TORAGS_PLATELEGS_4751, Items.TORAGS_LEGS_100_4970, Items.TORAGS_LEGS_75_4971, Items.TORAGS_LEGS_50_4972, Items.TORAGS_LEGS_25_4973)
        )
    ) {
        override fun effect(e: Entity, victim: Entity, state: BattleState): Boolean {
    ...
    VERAC(
        ...
        set = arrayOf(
            ...
            intArrayOf(Items.VERACS_BRASSARD_4757, Items.VERACS_TOP_100_4988, Items.VERACS_TOP_75_4989, Items.VERACS_TOP_50_4990, Items.VERACS_TOP_25_4991),
            intArrayOf(Items.VERACS_PLATESKIRT_4759, Items.VERACS_SKIRT_100_4994, Items.VERACS_SKIRT_75_4995, Items.VERACS_SKIRT_50_4996, Items.VERACS_SKIRT_25_4997)
        )
    ) {
        override fun isUsing(e: Entity?): Boolean {
            // Check if the entity is an NPC with a specific ID
     ...
     *
     * @param e The entity applying the effect.
