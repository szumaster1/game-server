...
public final class JoinClanRequest extends
    ...
    getDescriptor() {
        return ManagementProtos.internal_static_management_JoinClanRequest_descriptor;
    }

    @Override
    protected FieldAccessorTable
    internalGetFieldAccessorTable() {
        return ManagementProtos.internal_static_management_JoinClanRequest_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        JoinClanRequest.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof JoinClanRequest)) {
            return super.equals(obj);
        }
        JoinClanRequest other = (JoinClanRequest) obj;
    ...
    /**
     * Parse from join clan request.
     *
     * @param data the data
     * @return the join clan request
     * @throws InvalidProtocolBufferException the invalid protocol buffer exception
     */
    public static JoinClanRequest parseFrom(
     ...
     * @throws InvalidProtocolBufferException the invalid protocol buffer exception
     */
    public static JoinClanRequest parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
     ...
     */
    public static JoinClanRequest parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    /**
     * Parse delimited from join clan request.
     *
     * @param input the input
     * @return the join clan request
     * @throws IOException the io exception
     */
    public static JoinClanRequest parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
     ...
     * @throws IOException the io exception
     */
    public static JoinClanRequest parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
     ...
     * @return the builder
     */
    public static Builder newBuilder(JoinClanRequest prototype) {
    ...
    public static final class Builder extends
        ...
        @Override
        public JoinClanRequest getDefaultInstanceForType() {
            return JoinClanRequest.getDefaultInstance();
        }

        @Override
        public JoinClanRequest build() {
            JoinClanRequest result = buildPartial();
        ...
        @Override
        public JoinClanRequest buildPartial() {
            JoinClanRequest result = new JoinClanRequest(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof JoinClanRequest) {
                return mergeFrom((JoinClanRequest) other);
            } else {
         ...
         * @return the builder
         */
        public Builder mergeFrom(JoinClanRequest other) {
            if (other == JoinClanRequest.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
                ...
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            JoinClanRequest parsedMessage = null;
            try {
                parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                parsedMessage = (JoinClanRequest) e.getUnfinishedMessage();
    ...
    private static final JoinClanRequest DEFAULT_INSTANCE;

    static {
        DEFAULT_INSTANCE = new JoinClanRequest();
    }
     ...
     */
    public static JoinClanRequest getDefaultInstance() {
     ...
     */
    @Deprecated
    public static final com.google.protobuf.Parser<JoinClanRequest>
