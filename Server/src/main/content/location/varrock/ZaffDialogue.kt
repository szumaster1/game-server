...
class ZaffDialogue : OptionHandler() {
    ...
    class ZaffQuestDialogue : Dialogue {
        ...
        override fun handle(interfaceId: Int, buttonId: Int): Boolean {
            when (stage) {
                ...
                1 -> when (buttonId) {
                    1 -> {
                        sendPlayerDialogue(player, "Yes, please.", FacialExpression.HALF_GUILTY)
                        stage = 10
                    }

                    2 -> {
                        sendPlayerDialogue(player, "No, thank you.", FacialExpression.HALF_GUILTY)
                        stage = 20
                    }
                    ...
                    3 -> {
                        if (quest!!.getStage(player) == 60) {
                            ...
                            sendPlayerDialogue(player, "Can I have another ring?", FacialExpression.HALF_GUILTY)
                            stage = 50
                        }
                    }
                }
                ...
                20 -> {
                    npc(FacialExpression.HALF_GUILTY, "Well, 'stick' your head in again if you change your mind.")
                    stage = 21
                }
    ...
    inner class ZaffBattlestaffsDialogue : Dialogue {
        ...
        override fun open(vararg args: Any): Boolean {
            ...
            player(FacialExpression.HALF_GUILTY, "Do you have any battlestaves?")
            stage = 0
            return true
        }
