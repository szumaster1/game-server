...
class FatherLawrenceDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (quest.getStage(player) < 30) {
            npc(FacialExpression.HALF_GUILTY, "Oh to be a father in the times of whiskey.")
            stage = 0
        }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            1 -> {
                npc(FacialExpression.HALF_GUILTY, "Top of the morning to you.")
                stage = 2
            }
            ...
            44 -> {
                player("Yes, well, it certainly seems like you have a captive",
                    "audience!"
                )
                stage = 45
            }
            ...
            823 -> {
                npc("I heard some kids saying they saw some the other day.",
