        ...
        when (stage) {
            0 -> {
                npc(FacialExpression.HALF_GUILTY,
                    "Hello old bean. Is there something I can help you",
                    "with?"
                )
                stage = 1
            }
            ...
            10 -> {
                npc(FacialExpression.HALF_GUILTY, "My name is Tarquin Marjoribanks.")
                stage = 11
            }
            ...
            13 -> {
                npc(FacialExpression.HALF_GUILTY, "It's pronounced 'Marchbanks'!")
                stage = 14
            }
            ...
            15 -> {
                player(FacialExpression.HALF_GUILTY, "Are you related to King Roald?")
                stage = 16
            }

            16 -> {
                npc(FacialExpression.HALF_GUILTY, "Oh yes! Quite closely actually.")
                stage = 17
            }
