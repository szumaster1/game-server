    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        when (getAttribute(player, "tutorial:stage", 0)) {
            18 -> Component.setUnclosable(
                player,
                interpreter.sendDialogues(npc, FacialExpression.FRIENDLY, "Ah! Welcome, newcomer. I am the Master Chef, Lev. It", "is here I will teach you how to cook food truly fit for a", "king.")
            )
