...
/**
 * Represents the Bill teach dialogue.
 */
@Initializable
        ...
        when (stage) {
            1 -> when (buttonId) {
                ...
                2 -> if (!inInventory(player, Items.BOOK_O_PIRACY_7144)) {
                    playerl(FacialExpression.SAD, "Cap'n, I lost that book you gave me.").also { stage = 2 }
                } else {
            ...
            5 -> npc(FacialExpression.NEUTRAL, "Then here, have this other copy I dug up.").also {
