...
class FirstMateDaveyBoyDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> player(FacialExpression.FRIENDLY, "Oh....").also { stage = END_DIALOGUE }
            ...
            13 -> npcl(FacialExpression.FRIENDLY, "Try not to distract any of the crew either, Zamorak knows it's hard enough to get them to do any work around here without strangers wandering round the ship asking them inane questions.").also { stage = END_DIALOGUE }
        }
        return true
    }
