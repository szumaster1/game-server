...
/**
 * Represents the Veronica dialogue.
 */
@Initializable
class VeronicaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        when (quest.getStage(player)) {
            0 -> {
                npc(FacialExpression.HALF_ASKING, "Can you please help me? I'm in a terrible spot of", "trouble.")
                stage = 0
            }

            10 -> {
                npc(FacialExpression.HALF_ASKING, "Have you foudn my sweetheart yet?")
                stage = 0
            }
            ...
            100 -> {
                npc(FacialExpression.HALF_ASKING, "Thank you for resucing Ernest.")
                stage = 0
            }
        }
        return true
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (quest.getStage(player)) {
            0 -> when (stage) {
                ...
                2 -> {
                    npc(FacialExpression.HALF_GUILTY, "Oooh, you violent person you.")
                    stage = 3
                }
                ...
                7 -> {
                    player(FacialExpression.HALF_GUILTY, "Ok, I'll see what I can do.")
                    stage = 8
                }
            ...
            20 -> when (stage) {
                0 -> {
                    player(FacialExpression.HALF_GUILTY, "Yes, he's a chicken.")
                    stage = 1
                }
                ...
                3 -> {
                    npc(FacialExpression.HALF_GUILTY, "Eeeeeek!")
                    stage = 4
                }
            ...
            100 -> when (stage) {
                0 -> {
                    player(FacialExpression.HALF_GUILTY, "Where is he now?")
                    stage = 1
                }
