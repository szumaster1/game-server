...
class KjutDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> showTopics(Topic(FacialExpression.FRIENDLY, "Sure, one kebab please.", 2, true), Topic(FacialExpression.FRIENDLY, "I'm looking for a drunken dwarf.", 6), Topic(FacialExpression.FRIENDLY, "Do you have any quests?", 17))
            2 -> if (!inInventory(player, Items.COINS_995, 1)) {
            ...
            5 -> npcl(FacialExpression.OLD_DEFAULT, "The bank is Keldagrim-West. Hurry back!").also { stage = END_DIALOGUE }
            6 -> {
            ...
            13 -> npcl(FacialExpression.OLD_DEFAULT, "I think he was back here quite recently, so I doubt he'll be back any time soon.").also { stage = END_DIALOGUE }
            ...
            16 -> playerl(FacialExpression.FRIENDLY, "Right, right.").also { stage = END_DIALOGUE }
            17 -> npcl(FacialExpression.OLD_DEFAULT, "Not really! I have a steady supply of meat coming in through the carts and I don't really need anything else!").also { stage = END_DIALOGUE }
        }
        return true
    }
