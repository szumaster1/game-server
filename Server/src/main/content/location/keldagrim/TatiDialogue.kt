...
class TatiDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> showTopics(Topic(FacialExpression.FRIENDLY, "Do you have any pickaxes?", 2, true), Topic(FacialExpression.FRIENDLY, "Do you have any quests?", 7, true), Topic(FacialExpression.FRIENDLY, "Nothing really.", 14))
            ...
            13 -> npcl(FacialExpression.OLD_ANGRY1, "Pfft, I doubt it... maybe when my son fouls up again, but not now.").also { stage = END_DIALOGUE }
            14 -> npcl(FacialExpression.OLD_ANGRY1, "Then clear off!").also { stage = END_DIALOGUE }
        }
        return true
    }
