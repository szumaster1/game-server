...
class AgmundiDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> showTopics(Topic(FacialExpression.FRIENDLY, "Who makes these clothes then?", 10), Topic(FacialExpression.FRIENDLY, "I still want to buy your clothes.", 8, true), Topic(FacialExpression.FRIENDLY, "So do you have any quests for me?", 20))
            8 -> {
                end()
