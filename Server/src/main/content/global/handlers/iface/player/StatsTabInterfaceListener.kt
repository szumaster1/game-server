...
class StatsTabInterfaceListener : InterfaceListener {
    ...
    override fun defineInterfaceListeners() {
        ...
        on(LEVEL_UP_INTERFACE_740) { player, _, _, buttonID, _, _ ->
            if (buttonID == 3) {
    ...
    companion object {
        ...
        val ADVANCE_CONFIGS = intArrayOf(9, 40, 17, 49, 25, 57, 33, 641, 659, 664, 121, 649, 89, 114, 107, 72, 64, 80, 673, 680, 99, 698, 689, 705)
