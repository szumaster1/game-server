...
public class FishbowlPlugin extends OptionHandler {
    ...
    private final class FeedPetFishHandler extends UseWithHandler {
        /**
         * Instantiates a new Feed pet fish handler.
         */
     ...
     */
    public final class FishbowlDialogue extends Dialogue {
        private Item fishbowl;
        private String option;

        /**
         * Instantiates a new Fishbowl dialogue.
         */
    ...
    public static final class AquariumPlugin extends OptionHandler {
        ...
        public boolean getFish(final Player player) {
            if (!player.getInventory().containsAtLeastOneItem(TINY_NET)) {
                ...
                WeightedChanceItem[] fishChance = new WeightedChanceItem[]{new WeightedChanceItem(FISHBOWL_BLUE, 1, blueChance), new WeightedChanceItem(FISHBOWL_GREEN, 1, greenChance), new WeightedChanceItem(FISHBOWL_SPINE, 1, spineChance)};
        ...
        private final class TinyNetHandler extends UseWithHandler {
            /**
             * Instantiates a new Tiny net handler.
             */
