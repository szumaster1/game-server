 ...
 *
 * @constructor Poisoned weapon listeners
 */
class PoisonedWeaponListeners : InteractionListener {
    ...
    /**
     * Karambwan poison sets
     *
     * @property base
     * @property kp
     * @constructor Karambwan poison sets
     */
    internal enum class KarambwanPoisonSets(val base: Int, val kp: Int) {
        /**
         * Bronze Spear
         *
         * @constructor Bronze Spear
         */
