            ...
            openDialogue(player, object : DialogueFile() {
                override fun handle(componentID: Int, buttonID: Int) {
                    ...
                    when (stage) {
                        ...
                        14 -> when (buttonID) {
                            1 -> {
                                interpreter!!.sendItemMessage(Items.FREMENNIK_SEA_BOOTS_3_14573, "Remember that you must be wearing your Fremennik sea boots if you want to teleport to an alternative location.")
