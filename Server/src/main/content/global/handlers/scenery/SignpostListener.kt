    ...
    override fun defineListeners() {
        ...
        */
        ...
        on(Scenery.SIGNPOST_25397, IntType.SCENERY, "read") { player, _ ->
            setInterfaceText(player, "Grave of Scorpius.", 135, 3) // North
            setInterfaceText(player, "Tree Gnome Village.", 135, 8) // East
            setInterfaceText(player, "Castle Wars.", 135, 9) // South
            setInterfaceText(player, "Observatory reception.", 135, 12) // West
            openInterface(player, Components.AIDE_COMPASS_135)
            return@on true
        }
    }
