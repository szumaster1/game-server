...
class ChromaticDragonNPC(id: Int = 0, location: Location? = null) : AbstractNPC(id, location) {
    ...
    override fun getIds(): IntArray {
        return intArrayOf(
            NPCs.GREEN_DRAGON_941, NPCs.GREEN_DRAGON_4677, NPCs.GREEN_DRAGON_4678, NPCs.GREEN_DRAGON_4679, NPCs.GREEN_DRAGON_4680,
            NPCs.RED_DRAGON_53, NPCs.RED_DRAGON_4669, NPCs.RED_DRAGON_4670, NPCs.RED_DRAGON_4671, NPCs.RED_DRAGON_4672,
            NPCs.BLACK_DRAGON_54, NPCs.BLACK_DRAGON_4673, NPCs.BLACK_DRAGON_4674, NPCs.BLACK_DRAGON_4675, NPCs.BLACK_DRAGON_4676,
            NPCs.BLUE_DRAGON_55, NPCs.BLUE_DRAGON_4681, NPCs.BLUE_DRAGON_4682, NPCs.BLUE_DRAGON_4683, NPCs.BLUE_DRAGON_4684
        )
    }

    companion object {
        private val DRAGONFIRE: SwitchAttack =
            DragonfireSwingHandler.get(true, 52, Animation(81, Priority.HIGH), Graphic(1, 64), null, null)
    }
}
