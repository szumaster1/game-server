...
class AlkharidPitShortcut : AgilityShortcut(intArrayOf(9331, 9332), 38, 0.0, "climb") {
    ...
    override fun run(player: Player, scenery: Scenery, option: String, failed: Boolean) {
        ...
        val animation = if (scenery.id == 9331) content.global.transport.shortcuts.AlkharidPitShortcut.Companion.ANIMATION else content.global.transport.shortcuts.AlkharidPitShortcut.Companion.SCALE
