...
enum class Penguin(val id: Int, val hint: String, val location: Location) {
    ...
    BUSH_9(NPCs.BUSH_8105, "located in the northern desert.", Location.create(3350, 3311, 0)), BUSH_10(NPCs.BUSH_8105, "located somewhere in the kingdom of Kandarin.", Location.create(2633, 3501, 0)),
    BUSH_11(NPCs.BUSH_8105, "located south of Ardougne.", Location.create(2440, 3206, 0)), BUSH_12(NPCs.BUSH_8105, "located where wizards study.", Location.create(3112, 3149, 0)),
    ...
    ROCK_3(NPCs.ROCK_8109, "located near some ogres.", Location.create(2631, 2980, 0)), ROCK_4(NPCs.ROCK_8109, "located in the Kingdom of Asgarnia.", Location.create(3013, 3501, 0)),
