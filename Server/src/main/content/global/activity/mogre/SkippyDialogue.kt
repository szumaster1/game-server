...
class SkippyDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            11 -> end().also { setVarbit(player!!, SkippyUtils.VARBIT_SKIPPY_AND_THE_MOGRES_PROGRESS, 1, true) }
            ...
            54 -> npcl(FacialExpression.HALF_GUILTY, "I wish you wouldn't go looking for them. Those vicious killers will tear you apart.").also { stage++ }
            ...
            77 -> npcl(FacialExpression.HALF_GUILTY, "Hey you!").also { stage++ }
            78 -> playerl(FacialExpression.HALF_GUILTY, "How do I annoy the Mogres again?").also { stage++ }
            79 -> npcl(FacialExpression.HALF_GUILTY, "Go south to Mudskipper Point and lob a Fishing Explosive into the sea. You can grab them from the Slayer masters.").also { stage++ }
            80 -> playerl(FacialExpression.HALF_GUILTY, "Thanks! So, what are you going to do now?").also { stage++ }
            81 -> npcl(FacialExpression.HALF_GUILTY, "Well, I was planning on continuing my hobby of wandering up and down this bit of coastline, bellowing random threats and throwing bottles.").also { stage++ }
            82 -> npcl(FacialExpression.HALF_GUILTY, "And you?").also { stage++ }
            83 -> playerl(FacialExpression.HALF_GUILTY, "I was planning on wandering up and down the landscape, bugging people to see if they had mindblowingly dangerous quests for me to undertake.").also { stage++ }
            84 -> npcl(FacialExpression.HALF_GUILTY, "Well, good luck with that!").also { stage++ }
            85 -> playerl(FacialExpression.HALF_GUILTY, "You too!").also { stage++ }
            86 -> npcl(FacialExpression.DISGUSTED, "Weirdo...").also { stage++ }
            87 -> playerl(FacialExpression.DISGUSTED, "Loony...").also { stage = END_DIALOGUE }
        }
        return true
    }
