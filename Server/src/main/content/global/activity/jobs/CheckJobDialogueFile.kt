...
/**
 * The dialogue file to handle a player asking about work with
 * the employer that assigned them their current job.
 */
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            START_DIALOGUE -> showTopics(
                ...
                Topic(FacialExpression.HALF_ASKING, "Can you remind me what job you gave me?", REMIND_JOB),
                Topic(FacialExpression.HALF_ASKING, "Can I have a task list to remind me of my job?", GET_TASK_LIST),
                Topic(FacialExpression.HALF_GUILTY, "I'd like a new job please.", GET_NEW_JOB_1)
            )
