...
/**
 * The Trader crewmember dialogue.
 */
@Initializable
public class TraderCrewmemberDialogue extends Dialogue {

    private ShipCharter.Destination destination;

    private int cost;

    /**
     * Instantiates a new Trader crewmember dialogue.
     */
    ...
    public boolean open(Object... args) {
        npc = (NPC) args[0];
        if (args.length > 1) {
            destination = ((ShipCharter.Destination) args[1]);
            cost = (int) args[2];
