        ...
        when (stage) {
            0 -> {
                if (getAttribute(player!!, EvilBobUtils.eventComplete, false)) {
                    ...
                    npcl(FacialExpression.SAD, "F-f-f-fish... give him the f-f-f-fish he likes and he might f- f-f-fall asleep.").also { stage = END_DIALOGUE }
                }
            }
            1 -> {
                end()
            ...
            3 -> playerl(FacialExpression.FRIENDLY, "Away from this place! To " + GameWorld.settings!!.name + " proper!").also { stage++ }
