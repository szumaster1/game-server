package content.global.interaction.iface.bank
...
class BankChargeInterfaceListener : InterfaceListener {
    companion object {
        ...
        private val RUNE_BUTTONS = intArrayOf(BUTTON_AIR_RUNE, BUTTON_MIND_RUNE, BUTTON_WATER_RUNE, BUTTON_EARTH_RUNE, BUTTON_FIRE_RUNE, BUTTON_BODY_RUNE, BUTTON_COSMIC_RUNE, BUTTON_CHAOS_RUNE, BUTTON_ASTRAL_RUNE, BUTTON_LAW_RUNE, BUTTON_DEATH_RUNE, BUTTON_BLOOD_RUNE, BUTTON_NATURE_RUNE, BUTTON_SOUL_RUNE)
    ...
    private fun handleButtonClick(
        ...
        runeItemId?.let {
            if (amountInInventory(player, it) < 20) {
                sendNPCDialogue(player, NPCs.ENIOLA_6362, "I'm afraid you don't have the necessary runes with you at this time, so " + "I can't allow you to access your account. Please bring 20 runes of one type " + "and you'll be able to open your bank.", FacialExpression.NEUTRAL)
                return true
            }
