...
class AlchemicalNotes : InteractionListener {
    companion object {
        ...
        private val CONTENTS = arrayOf(
            PageSet(
                Page(
                    BookLine("<col=08088A>Acetic acid and Cupric", 55),
                    BookLine("<col=08088A>Sulphate:", 56),
                    ...
                    BookLine("<col=08088A>Acetic acid and Gypsum:", 66),
                    BookLine("<col=08088A>Endothermic.", 67),
                ...
                Page(
                    BookLine("<col=08088A>Acetic acid and Sodium", 55),
                    BookLine("<col=08088A>Chloride:", 56),
                    BookLine("Endothermic.", 57),
                    ...
                    BookLine("<col=08088A>Acetic acid and", 66),
                    BookLine("<col=08088A>Dihydrogen Monoxide:", 67),
                ...
                Page(
                    BookLine("<col=08088A>Acetic acid and Cupric", 55),
                    BookLine("<col=08088A>Ore Powder:", 56),
                    BookLine("Endothermic.", 57),
                    ...
                    BookLine("<col=08088A>Acetic acid and Tin Ore", 66),
                    BookLine("<col=08088A>powder:", 67),
                    BookLine("Endothermic.", 68),
                ...
                Page(
                    BookLine("<col=08088A>Cupric Sulphate and", 55),
                    BookLine("<col=08088A>Dihyrdogen Monoxide:", 56),
                    BookLine("Exothermic.", 57),
                    BookLine("A blue compound was", 58),
                    BookLine("produced, along with heat.", 59),
                ), Page(
                    BookLine("<col=08088A>Cupric Sulphate and", 66),
                    BookLine("<col=08088A>Gypsum:", 67),
                    BookLine("Endothermic.", 68),
                ...
                Page(
                    BookLine("<col=08088A>Cupric Sulphate and", 55),
                    BookLine("<col=08088A>Sodium Chloride:", 56),
                    BookLine("Endothermic.", 57),
                    BookLine("A pungent odour was", 58),
                    BookLine("released when combined.", 59),
                ), Page(
                    BookLine("<col=08088A>Cupric Sulphate and", 66),
                    BookLine("<col=08088A>Cupric Ore powder:", 67),
                    BookLine("Endothermic.", 68),
                ...
                Page(
                    BookLine("<col=08088A>Cupric Sulphate and Tin", 55),
                    BookLine("<col=08088A>Ore powder:", 56),
                    BookLine("Endothermic.", 57),
                    ...
                    BookLine("<col=08088A>Gypsum and Dihydrogen", 66),
                    BookLine("<col=08088A>Monoxide:", 67),
                ...
                Page(
                    ...
                    BookLine("<col=08088A>Gypsum and Sodium", 66),
                    BookLine("<col=08088A>Chloride:", 67),
                    BookLine("Endothermic.", 68),
                ...
                Page(
                    BookLine("<col=08088A>Gypsum and Culpric Ore:", 55),
                    ...
                    BookLine("<col=08088A>Gypsum and Tin Ore:", 66),
            ...
            PageSet(
                Page(
                    BookLine("<col=08088A>Sodium Chloride and", 55),
                    BookLine("<col=08088A>Dihydrogen Monoxide:", 56),
                    BookLine("Endothermic.", 57),
                    ...
                    BookLine("<col=08088A>Sodium Chloride and", 66),
                    BookLine("<col=08088A>Cupric Ore:", 67),
                    BookLine("Endothermic.", 68),
                ...
                Page(
                    BookLine("<col=08088A>Sodium Chloride and Tin", 55),
                    BookLine("<col=08088A>Ore:", 56),
                    BookLine("Endothermic.", 57),
                    BookLine("Another very similar ", 58),
                    BookLine("result as with Cupric Ore.", 59),
                ), Page(
                    BookLine("<col=08088A>Cupric Ore Powder and", 66),
                    BookLine("<col=08088A>Tin Ore Powder:", 67),
                    BookLine("Endothermic.", 68),
                ...
                Page(
                    ...
                    BookLine("<col=08088A>Nitrous Monoxide:", 66),
