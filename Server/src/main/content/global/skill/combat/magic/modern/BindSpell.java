...
public final class BindSpell extends CombatSpell {
    ...
    private static final Graphic BIND_START = new Graphic(177, 96);
    private static final Projectile BIND_PROJECTILE = Projectile.create((Entity) null, null, 178, 40, 36, 52, 75, 15, 11);
    private static final Graphic BIND_END = new Graphic(181, 96);
    private static final Graphic SNARE_START = new Graphic(177, 96);
    private static final Projectile SNARE_PROJECTILE = Projectile.create((Entity) null, null, 178, 40, 36, 52, 75, 15, 11);
    private static final Graphic SNARE_END = new Graphic(180, 96);
    private static final Graphic ENTANGLE_START = new Graphic(177, 96);
    ...
    private BindSpell(SpellType type, int level, double baseExperience, int sound, int impactAudio, Graphic start, Projectile projectile, Graphic end, Item... runes) {
