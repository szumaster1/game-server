...
public final class BloodSpells extends CombatSpell {
    ...
    private BloodSpells(SpellType type, int level, double baseExperience, int sound, int impactSound, Animation anim, Graphic start, Projectile projectile, Graphic end, Item... runes) {
