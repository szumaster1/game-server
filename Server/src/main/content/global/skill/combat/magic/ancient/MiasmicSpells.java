...
public final class MiasmicSpells extends CombatSpell {
    ...
    private static final Graphic RUSH_END = new Graphic(1847, 40);
    private static final Graphic BURST_START = new Graphic(1848, 0);
    private static final Graphic BURST_END = new Graphic(1849, 20, 30);
    private static final Graphic BLITZ_START = new Graphic(1850, 15);
    private static final Graphic BLITZ_END = new Graphic(1851, 0);
    private static final Graphic BARRAGE_START = new Graphic(1853, 0);
    ...
    private MiasmicSpells(SpellType type, int level, double baseExperience, int castAudio, int impactSound, Animation anim, Graphic start, Projectile projectile, Graphic end, Item... runes) {
