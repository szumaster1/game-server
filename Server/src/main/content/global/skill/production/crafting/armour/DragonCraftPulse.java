...
public final class DragonCraftPulse extends SkillPulse<Item> {
    ...
    private final LeatherCrafting.DragonHide hide;
    private int amount;
    private int ticks;

    /**
     * Instantiates a new Dragon craft pulse.
     *
     ...
     */
    public DragonCraftPulse(Player player, Item node, LeatherCrafting.DragonHide hide, int amount) {
        super(player, node);
        this.hide = hide;
        this.amount = amount;
    }
