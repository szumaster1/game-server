package content.global.skill.production.herblore.barb

import core.api.consts.Items

enum class BarbarianMixes {
    ...
    SUPER_ANTIPOISION_POTION(Items.SUPER_ANTIPOISON2_183, 51, Items.ANTI_P_SUPERMIX2_11473, 35.0, false),
    FISHING_POTION(Items.FISHING_POTION2_153, 53, Items.FISHING_MIX2_11477, 38.0, false),
    SUPER_ENERGY_POTION(Items.SUPER_ENERGY2_3020, 56, Items.SUP_ENERGY_MIX2_11481, 42.0, false),
    ...
    companion object {
        @JvmStatic
        fun forId(id: Int): BarbarianMixes? {
            for (pot in BarbarianMixes.values()) {
                if (pot.getItem() == id) {
                    return pot
                }
            }
