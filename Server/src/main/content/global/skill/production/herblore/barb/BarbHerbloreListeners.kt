...
class BarbHerbloreListeners : InteractionListener {

    override fun defineListeners() {
        for (potion in BarbarianMixes.values()) {
            if (potion.isBoth()) {
    ...
    fun handle(player: Player, inputPotion: Node, egg: Node): Boolean {
        val potion: BarbarianMixes = BarbarianMixes.forId(inputPotion.id) ?: return false
