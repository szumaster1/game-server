...
public enum MysteriousRuin {
     ...
     * The Water.
     */
    WATER(new int[]{2454, 7107, 7108}, Location.create(3183, 3163, 0), Location.create(3494, 4832, 0), Talisman.WATER, Tiara.WATER),
    /**
     * The Earth.
     */
     ...
     * The Fire.
     */
    FIRE(new int[]{2456, 7111, 7112}, Location.create(3312, 3253, 0), Location.create(2576, 4845, 0), Talisman.FIRE, Tiara.FIRE),
    /**
     * The Body.
     */
     ...
     * The Blood.
     */
    BLOOD(new int[]{2464, 30529, 30530}, Location.create(3561, 9779, 0), Location.create(2468, 4889, 1), Talisman.BLOOD, Tiara.BLOOD);
