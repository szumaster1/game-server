...
enum class MysteriousRuin(
    ...
    LAW(
        intArrayOf(2459, 7117, 7118),
        Location.create(2857, 3379, 0),
        Location.create(2464, 4818, 0),
        Talisman.LAW,
        Tiara.LAW
    ),
    DEATH(
        intArrayOf(2462, 7123, 7124),
