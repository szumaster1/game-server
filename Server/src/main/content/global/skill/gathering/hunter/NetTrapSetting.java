...
/**
 * The Net trap setting.
 */
public final class NetTrapSetting extends TrapSetting {

    /**
     * Instantiates a new Net trap setting.
     */
    ...
    public enum NetTrap {
         ...
         * Green net trap.
         */
        GREEN(19679, 19678, 19676, 19677, 19674, 19675, 19651),
        /**
         * Squirel net trap.
         */
        SQUIREL(28564, 28563, 28752, 28753, 28750, 28751, 28566),
        /**
         * Orange net trap.
         */
        ORANGE(19652, 19650, 19657, 19656, 19655, 19654, 19665),
        /**
         * Red net trap.
         */
        RED(19663, 19662, 19660, 19661, 19658, 19659, 19673),
        /**
         * Black net trap.
         */
        BLACK(19671, 19670, 19668, 19669, 19666, 19667, 19681);
