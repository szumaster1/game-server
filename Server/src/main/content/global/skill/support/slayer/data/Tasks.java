...
public enum Tasks {
    ...
    BIRDS(1, new int[]{147, 1018, 1403, 1475, 5120, 5121, 5122, 5123, 5133, 1475, 1476, 41, 951, 1017, 1401, 1402, 2313, 2314, 2315, 3476, 1016, 1550, 1180, 1754, 1755, 1756, 2252, 4570, 4571, 1911, 6114, 46, 2693, 6113, 6112, 146, 149, 150, 450, 451, 1179, 1322, 1323, 1324, 1325, 1400, 2726, 2727, 3197, 138, 48, 4373, 4374, 4535, 139, 1751, 148, 1181, 6382, 2459, 2460, 2461, 2462, 2707, 2708, 6115, 6116, 3296, 6378, 1996, 3675, 3676, 6792, 6946, 7320, 7322, 7324, 7326, 7328, 1692, 6285, 6286, 6287, 6288, 6289, 6290, 6291, 6292, 6293, 6294, 6295, 6322, 6323, 6324, 6325, 6326, 6327, 6328, 6329, 6330, 6331, 6332,}, new String[]{"irds aren't the most intelligent of creatures, but watch out for their", "sharp, stabbing beaks."}, 1, false, false),
    ...
    DAGANNOTHS(75, new int[]{1338, 1339, 1340, 1341, 1342, 1343, 1344, 1345, 1346, 1347, 2454, 2455, 2456, 2880, 2881, 2882, 2883, 2887, 2888, 3591,}, new String[]{"There are many types of Dagannoth, the most powerful being the three Dagannoth Kings."}, 1, false, false),
    ...
    GREEN_DRAGONS(52, new int[]{ 742, 941, 4677, 4678, 4679, 4680, 5362}, new String[]{"Green dragons are very powerful, they have", "fierce fiery breath."}, 1, false, true),
    ...
    IRON_DRAGONS(80, new int[]{1591}, new String[]{"Iron dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath."}, 1, false, true, 40 | 59 << 16),
    ...
    MOGRES(1, new int[] { 114 }, new String[] { "Mogres are large foes often found inhabiting areas close " , "to water." }, 32, false, false),
    MITHRIL_DRAGONS(60, new int[]{5363}, new String[]{"Mithril dragons aren't as strong as other dragons but they're still", "very powerful, watch out for their firey breath."}, 1, false, true, 5 | 9 << 16),
    ...
    GENERAL_GRAARDOR(90, new int[]{6260}, new String[]{"General Grardoor is one of the four Godwars bosses."}, 1, false, false, 5 | 25 << 16),
