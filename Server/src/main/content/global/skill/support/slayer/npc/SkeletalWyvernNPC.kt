...
class SkeletalWyvernNPC : NPCBehavior(*Tasks.SKELETAL_WYVERN.ids) {
    private val COMBAT_HANDLER = MultiSwingHandler(
        ...
        DragonfireSwingHandler.get(false, 54, Animation(2988),
            Graphic(501), null, null, false)
    )

    private val COMBAT_HANDLER_FAR =
        MultiSwingHandler(SwitchAttack(CombatStyle.RANGE.swingHandler, Animation(2989),
            Graphic(499)
        ))
