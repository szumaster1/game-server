...
class ZanarisSqueezeShortcut : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(12127, IntType.SCENERY, "squeeze-past") { player, node ->
            ...
            ForceMovement.run(player, player.location, to, Animation(2240), Animation(2240), dir, 13).endAnimation = Animation.RESET
            return@on true
        }
    }
