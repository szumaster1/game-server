...
enum class Pickpockets(
    ...
    MAN(
        ...
        stunDamageMax = 1,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 3, 3, 1.0, true))
    ),
    GANG_OF_THIEVES(
    ...
    TOWER_OF_LIFE_QUEST_NPCS(
        ...
        stunDamageMax = 1,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.TRIANGLE_SANDWICH_6962, 1, 1, 1.0, true))
    ),
    FARMER(
        ...
        stunDamageMax = 1,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 9, 9, 1.0, true), WeightedItem(Items.POTATO_SEED_5318, 1, 1, 1.0, true))
    ),
    MALE_HAM_MEMBER(
    ...
    WARRIOR(
        ...
        stunDamageMax = 2,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 18, 18, 1.0, true))
    ),
    ROGUE(
        ...
        stunDamageMax = 2,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 25, 40, 5.0, true), WeightedItem(Items.JUG_OF_WINE_1993, 1, 1, 6.0), WeightedItem(Items.AIR_RUNE_556, 8, 8, 8.0), WeightedItem(Items.LOCKPICK_1523, 1, 1, 5.0), WeightedItem(Items.IRON_DAGGERP_1219, 1, 1, 1.0))
    ),
    CAVE_GOBLIN(
        ...
        stunDamageMax = 1,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.BAT_SHISH_10964, 1, 1, 2.5), WeightedItem(Items.FINGERS_10965, 1, 1, 2.5), WeightedItem(Items.COATED_FROGS_LEGS_10963, 1, 1, 2.5), WeightedItem(Items.COINS_995, 30, 30, 6.5), WeightedItem(Items.OIL_LAMP_4522, 1, 1, 0.5), WeightedItem(Items.BULLSEYE_LANTERN_4544, 1, 1, 0.5), WeightedItem(Items.UNLIT_TORCH_596, 1, 1, 0.5), WeightedItem(Items.TINDERBOX_590, 1, 1, 0.5), WeightedItem(Items.SWAMP_TAR_1939, 1, 1, 0.5), WeightedItem(Items.IRON_ORE_441, 1, 4, 0.25))
    ),
    MASTER_FARMER(
    ...
    GUARD(
        ...
        stunDamageMax = 2,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 30, 30, 1.0, true))
    ),
    FREMENNIK_CITIZEN(
        ...
        stunDamageMax = 2,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 40, 40, 1.0, true))
    ),
    BEARDED_BANDIT(
        ...
        stunDamageMax = 5,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.ANTIPOISON4_2446, 1, 1, 1.0), WeightedItem(Items.LOCKPICK_1523, 1, 1, 2.0), WeightedItem(Items.COINS_995, 1, 1, 4.0))
    ),
    DESERT_BANDIT(
        ...
        stunDamageMax = 3,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 50, 1, 3.0), WeightedItem(Items.ANTIPOISON4_2446, 1, 1, 1.0), WeightedItem(Items.LOCKPICK_1523, 1, 1, 1.0))
    ),
    KNIGHT_OF_ADROUGNE(
        ...
        stunDamageMax = 3,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 50, 50, 1.0, true))
    ),
    YANILLE_WATCHMAN(
        ...
        stunDamageMax = 3,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 60, 60, 1.0, true), WeightedItem(Items.BREAD_2309, 1, 1, 1.0, true))
    ),
    MENAPHITE_THUG(
        ...
        stunDamageMax = 5,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 60, 60, 1.0, true))
    ),
    PALADIN(
        ...
        stunDamageMax = 3,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 80, 80, 1.0, true), WeightedItem(Items.CHAOS_RUNE_562, 2, 2, 1.0, true))
    ),
    GNOME(
        ...
        stunDamageMax = 1,
        stunTime = 5,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 300, 300, 2.5), WeightedItem(Items.EARTH_RUNE_557, 1, 1, 3.5), WeightedItem(Items.GOLD_ORE_445, 1, 1, 1.0), WeightedItem(Items.FIRE_ORB_569, 1, 1, 5.0), WeightedItem(Items.SWAMP_TOAD_2150, 1, 1, 8.0), WeightedItem(Items.KING_WORM_2162, 1, 1, 9.0))
    ),
    HERO(
        ...
        stunDamageMax = 6,
        stunTime = 4,
        table = WeightBasedTable.create(WeightedItem(Items.COINS_995, 200, 300, 1.5), WeightedItem(Items.DEATH_RUNE_560, 2, 2, 1.0), WeightedItem(Items.BLOOD_RUNE_565, 1, 1, 0.5), WeightedItem(Items.FIRE_ORB_569, 1, 1, 2.5), WeightedItem(Items.DIAMOND_1601, 1, 1, 2.0), WeightedItem(Items.GOLD_ORE_444, 1, 1, 1.5), WeightedItem(Items.JUG_OF_WINE_1993, 1, 1, 3.0))
    );
