...
enum class Stall(
    ...
    VEGETABLE_STALL(
        full_ids = arrayOf(4706, 4708),
        empty_ids = arrayOf(634),
        level = 2,
    ...
    BAKER_STALL(
        full_ids = arrayOf(2561, 6163, 34384),
        empty_ids = arrayOf(634, 6984, 34381),
        level = 5,
    ...
    CRAFTING_STALL(
        full_ids = arrayOf(4874, 6166),
        empty_ids = arrayOf(4797, 6984),
        level = 5,
    ...
    TEA_STALL(
        full_ids = arrayOf(635, 6574),
        empty_ids = arrayOf(634, 6573),
        level = 5,
    ...
    SILK_STALL(
        full_ids = arrayOf(34383, 2560),
        empty_ids = arrayOf(34381, 634),
        level = 20,
    ...
    FUR_STALL(
        full_ids = arrayOf(34387, 2563, 4278),
        empty_ids = arrayOf(34381, 634, 634),
        level = 35,
    ...
    FISH_STALL(
        full_ids = arrayOf(4277, 4705, 4707),
        empty_ids = arrayOf(634, 634, 634),
        level = 42,
    ...
    CROSSBOW_STALL(
        full_ids = arrayOf(17031),
        empty_ids = arrayOf(6984),
        level = 49,
    ...
    SILVER_STALL(
        full_ids = arrayOf(2565, 6164, 34382),
        empty_ids = arrayOf(634, 6984, 34381),
        level = 50,
    ...
    SPICE_STALL(
        full_ids = arrayOf(34386, 6166),
        empty_ids = arrayOf(34381, 6984),
        level = 65,
    ...
    GEM_STALL(
        full_ids = arrayOf(2562, 6162, 34385),
        empty_ids = arrayOf(634, 6984, 34381),
        level = 75,
    ...
    //Ape Atoll Stalls
    SCIMITAR_STALL(
        full_ids = arrayOf(4878),
        empty_ids = arrayOf(4797),
        level = 65,
    ...
    CANDLES(
        full_ids = arrayOf(core.api.consts.Scenery.CANDLES_19127),
        empty_ids = arrayOf(core.api.consts.Scenery.CANDLES_19127),
        level = 20,
