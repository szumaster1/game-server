    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            START_DIALOGUE -> {
                ...
                showTopics(
                    IfTopic(FacialExpression.ASKING, "Would you chop my tree down for me?", 1000, patch.patch.type == PatchType.TREE_PATCH && patch.plantable != null && patch.isGrown()),
                    IfTopic(FacialExpression.ASKING, "Would you look after my crops for me?", 10, !(patch.patch.type == PatchType.TREE_PATCH && patch.plantable != null && patch.isGrown())),
