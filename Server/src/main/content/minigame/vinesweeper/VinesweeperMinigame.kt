...
class VinesweeperMinigame : InteractionListener, InterfaceListener, MapArea {
        ...
        on(HOLES, IntType.SCENERY, "dig") { player, node ->
            if (!inInventory(player, Items.SPADE_952, 1)) {
                ...
                player.visualize(
                    ...
                    Graphic(Gfx.VINESWEEPER_DIRT_DIG_1543)
                )
    ...
    companion object {
        ...
        val SIGNS = intArrayOf(
            Sceneries.INSTRUCTION_SIGN_29461,
            Sceneries.INSTRUCTION_SIGN_29462,
            Sceneries.INSTRUCTION_SIGN_29463,
            Sceneries.INSTRUCTION_SIGN_29464
        )
        ...
        val INSTRUCTION_SIGNS = hashMapOf(
            29463 to 684, 29464 to 687, 29462 to 688, 29461 to 690
        )
        ...
        fun plantFlag(player: Player, hole: Scenery) {
            if (player.inventory.remove(Item(Items.FLAG_12625, 1))) {
                ...
                player.visualize(
                    ...
                    Graphic(Gfx.VINESWEEPER_PLANT_FLAG_1541)
                )
        ...
        object VinesweeperTeleport {
            ...
            fun teleport(npc: NPC, player: Player) {
                ...
                spawnProjectile(npc, player, 109)
