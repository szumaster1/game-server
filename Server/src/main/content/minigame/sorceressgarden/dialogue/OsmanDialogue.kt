...
class OsmanDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        when (quest!!.getStage(player)) {
            ...
            60 -> {
                npc("The prince is safe on his way home with Leela.",
            ...
            20 -> {
                if (!player.inventory.containsItem(KEY_PRINT)) {
                    player( "Can you tell me what I need to get?")
                } else if (!player.inventory.containsItem(BRONZE_BAR) && player.inventory.containsItem(KEY_PRINT)) {
                    npc("Good, you have the print of the key. Get a bar of",
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            ...
            30 -> when (stage) {
                ...
                15 -> if (player.inventory.containsItem(ROPE)) {
            ...
            20 -> when (stage) {
                ...
                81 -> if (player.inventory.remove(BRONZE_BAR) && player.inventory.remove(KEY_PRINT)) {
                ...
                71 -> end()
                0 -> {
                    npc("A print of the key in soft clay and a bronze bar.",
                ...
                1 -> {
                    npc("When you have the full disguise talk to",
                ...
                2 -> end()
                10 -> {
                    npc("The prince is guarded by some stupid guards and a",
                ...
                11 -> {
                    npc("I think you will need to tie her up. One coil of rope",
                ...
                13 -> {
                    npc("Only enough to fool the guards at a distance. Get a",
                ...
                14 -> {
                    npc("Get a blonde wig, too. that is up to you to make or",
                ...
                15 -> {
                    npc("My daughter and top spy, Leela, can help you. She has",
                ...
                16 -> {
                    npc("It's near Draynor Village. She is lurking somewhere",
                        "near there now."
                    )
                    stage = 17
                }
                ...
                17 -> {
                    ...
                    options("Explain the first thing again.",
                ...
                20 -> {
                    npc("We need the key, or we need a copy made. If you can",
                ...
                21 -> {
                    npc("...If you can convince Lady Keli to show it to you",
                ...
                23 -> {
                    quest!!.setStage(player, 20)
                    options("What is the first thing I must do?",
                ...
                25 -> {
                    npc("May good luck travel with you. Don't forget to find",
            ...
            10 -> when (stage) {
                0 -> {
                    npc("Our prince is captive by the Lady Keli. We just need",
    ...
    fun handleSqirks(buttonId: Int) {
        when (stage) {
            0 -> if (!hasSqirks()) {
                options("Where do I get sq'irks?",
            ...
            301 -> {
                options("How should I squeeze the fruit?",
            ...
            119 -> {
                options("I've another question about sq'irks.",
