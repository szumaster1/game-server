...
/**
 * Represents the Pontimer dialogue.
 */
@Initializable
class PontimerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                2 -> player("Who's the weird looking giant earwig?").also { stage = 36 }
            ...
            17 -> when (buttonId) {
                1 -> npc("Well, this is Getorix's silly theory. Listen to it, if you must.", "At the end of the God Wars, Guthix returned to Gielinor", "and was angered by the destruction caused by the other", "gods in their vanity and quest for power.").also { stage = 19 }
                2 -> npc("If you want the true story, then this is it. After the", "God Wars, Guthix found something dangerous here and", "used his power to protect it.").also { stage = 27 }
                3 -> npc("This is what Alran thinks, for what it's worth...which isn't", "very much, if you ask me. Guthix has apparently left us", "a test. He deliberately created this site of power", "as a test of individual strength and balance.").also { stage = 33 }
                4 -> player("I'd better get going.").also { stage = END_DIALOGUE }
            }

            19 -> npc("So, maybe he punched the ground in anger, leaving an", "imprint of power on the ground that has lasted ever since.").also { stage++ }
            ...
            26 -> when (buttonId) {
                1 -> npc("If you want the true story, then this is it. After the", "God Wars, Guthix found something dangerous here and", "used his power to protect it.").also { stage++ }
                2 -> npc("This is what Alran thinks, for what it's worth...which", " isn't very much, if you ask me. Guthix has apparently", "left us a test. He deliberately created this site of power", "as a test of individual strength and balance.").also { stage = 33 }
                3 -> player("I'd better get going.").also { stage = END_DIALOGUE }
            }

            27 -> player("What did he find?").also { stage++ }
            28 -> npc("I don't know for certain, but it must be under that strange", "impression in the big cave. I think that mark is some sort of", "ward that Guthix has left to protect the site.").also { stage++ }
            29 -> player("So where does the Fist of Guthix come into this, then?").also { stage++ }
            30 -> npc("Hmmm. I'm not really sure. I think that when Fiara refers", "to the Fist of Guthix she is talking metaphorically about an", "abstract concept of fist-ness rather than the clenched", "right hand of Guthix itself.").also { stage++ }
            31 -> player("That sounds a bit...made up to me.").also { stage++ }
            32 -> npc("Why you impudent...bah. It's better than anything", "that Getorix and Alran can come up with, anyway.").also { stage = 16 }
            ...
            43 -> npc("Errr, ages. Since the end of the God Wars I think.", "She doesn't talk about that much.").also { stage = END_DIALOGUE }
        }
        return true
    }
