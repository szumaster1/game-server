package content.dialogue.catherby
...
class ArheinDialogue(player: Player? = null) : Dialogue(player) {
    ...
    fun getGoods(requestedItem: Int, requestedAmount: Int): Int {
        ...
        realamount = ServerStore.getNPCItemAmount(
            NPCs.ARHEIN_563,
            requestedItem,
        ...
        when (stage) {
            ...
            501 -> {
                showTopics(
                    ...
                    Topic(FacialExpression.NEUTRAL, "Aren't you worried about supplying evil knights?", 505)
                )
            }
