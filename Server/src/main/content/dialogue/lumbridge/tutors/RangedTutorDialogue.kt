    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                2 -> {
                    player(FacialExpression.HALF_GUILTY, "What about fletching?")
                    stage = 20
                }
            ...
            11 -> {
                npc("Mikasi, the Magic Combat tutor and I both give you",
            ...
            12 -> {
                npc("Claim, to claim runes right-click on the Magic Combat",
            ...
            13 -> {
                npc("When you have both bow and arrows, wield them by",
            ...
            14 -> {
                npc("To set the way you shoot, click on the crossed swords",
            ...
            15 -> {
                npc("more likely to hit, rapid means you shoot more often",
            ...
            16 -> {
                npc("The Training Shortbow and Training Arrows can only",
            ...
            17 -> end()
            20 -> {
                npc("Ahh the art of making your own bow and arrows. It's",
            ...
            21 -> {
                npc(FacialExpression.HALF_GUILTY, "General store upstairs.")
                stage = 22
            }

            22 -> {
                npc("Use your knife on the logs, this will bring up a list of",
            ...
            23 -> {
                npc("For arrows you will need to smith some arrow heads",
            ...
            24 -> {
                npc("You'll need to find a flax field, there's one south of",
            ...
            25 -> {
                npc(FacialExpression.HALF_GUILTY, "to make a working bow!")
                stage = 26
            }
