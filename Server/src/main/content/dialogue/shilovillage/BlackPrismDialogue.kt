...
/**
 * Represents the Black prism dialogue.
 */
class BlackPrismDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> npcl(FacialExpression.FRIENDLY, "Ah you'd like to sell this to me would you? I can offer you 5000 coins!").also { stage++ }
            2 -> {
                setTitle(player!!, 2)
                sendDialogueOptions(player!!, "SELL THE PRISM FOR 5000 COINS?", "Yes, I'll sell it for 5000", "No, I think I'll hold on it a while longer yet.")
                stage++
