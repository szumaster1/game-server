...
class LunderwinDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npc(FacialExpression.OLD_CALM_TALK1, "Pity be that, I want badly do.").also { stage = END_DIALOGUE }
            2 -> when (buttonId) {
                1 -> player("Yes, I'll sell you all my cabbages.").also { stage = 3 }
            ...
            3 -> {
                ...
                npcl(FacialExpression.OLD_CALM_TALK1, "Business good doing with you! Please, again come, buying always.")
                stage = END_DIALOGUE
            }
        }
        return true
