    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
           ...
           -3 -> npc("you must, yes.").also { stage = 3 }
            ...
            6 -> npc(FacialExpression.HALF_GUILTY, "It is as you say.").also { stage++ }
            7 -> player(FacialExpression.HALF_GUILTY, "So will I lose my armour?").also { stage++ }
            8 -> npc(FacialExpression.HALF_GUILTY, "Lose armour you will if damaged to much it becomes.", "Rare this is, but still possible. If kill you the armour does,", "also lose armour you will.").also { stage++ }
            9 -> player(FacialExpression.HALF_GUILTY, "So, occasionally I might lose a bit because it's being", "bashed about and I'll obviously lose it if I die... that it?").also { stage++ }
            10 -> npc(FacialExpression.HALF_GUILTY, "It is as you say.").also { stage = 0 }
            11 -> npc(FacialExpression.HALF_GUILTY, "Make them I did, with magics.").also { stage++ }
            12 -> player(FacialExpression.HALF_GUILTY, "Magic, in the Warrior's Guild?").also { stage++ }
            13 -> npc(FacialExpression.HALF_GUILTY, "A skilled warrior also am I. Harrallak mistakes does not", "make. Potential in my invention he sees and opportunity", "grasps.").also { stage++ }
            14 -> player(FacialExpression.HALF_GUILTY, "I see, so you made the magical machines and Harrallak", "saw how they could be used in the guild to train warrior's", "combat... interesting. Harrallak certainly is an intelligent", "guy.").also { stage++ }
