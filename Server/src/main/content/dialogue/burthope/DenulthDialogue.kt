    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        if (isQuestComplete(player!!, "Troll Stronghold")) {
            when (stage) {
                ...
                2 -> showTopics(Topic("How goes your fight with the trolls?", 10), Topic("I thought the White Knights controlled Asgarnia?", 20), Topic(FacialExpression.HAPPY, "See you about Denulth!", 30))
        ...
        if (isQuestComplete(player!!, "Death Plateau")) {
            when (stage) {
                ...
                13 -> showTopics(Topic(FacialExpression.SAD, "I'm sorry to hear that.", END_DIALOGUE), Topic("Is there anything I can do to help?", 14))
