package content.dialogue.yanille
...
class BartenderDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        npc = args[0] as NPC
        npc(FacialExpression.HALF_ASKING, "What can I get you?").also { stage = 0 }
        return true
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            11 -> npc(FacialExpression.HAPPY, "Have a super day!").also { stage = END_DIALOGUE }
        }
        return true
    }
