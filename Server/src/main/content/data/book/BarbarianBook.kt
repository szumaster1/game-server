...
class BarbarianBook : InteractionListener {
     ...
     */
    private fun displayGuide(player: Player, guideType: content.data.book.GuideType): Boolean {
        val guideContent = when (guideType) {
            content.data.book.GuideType.FISHING_BASE -> content.data.book.BarbarianBook.Companion.FISHING_BASICS
            content.data.book.GuideType.FISHING_FULL -> content.data.book.BarbarianBook.Companion.FISHING_COMPLETE
            content.data.book.GuideType.BAREHAND_BASE -> content.data.book.BarbarianBook.Companion.BAREHAND_BASICS
            content.data.book.GuideType.BAREHAND_FULL -> content.data.book.BarbarianBook.Companion.BAREHAND_COMPLETE
            content.data.book.GuideType.FIREMAKING_BASE -> content.data.book.BarbarianBook.Companion.FM_BOW_BASICS
            content.data.book.GuideType.FIREMAKING_FULL -> content.data.book.BarbarianBook.Companion.FM_BOW_COMPLETE
            content.data.book.GuideType.PYRESHIP_BASE -> content.data.book.BarbarianBook.Companion.PYRESHIP_BASICS
            content.data.book.GuideType.PYRESHIP_FULL -> content.data.book.BarbarianBook.Companion.PYRESHIP_COMPLETE
            content.data.book.GuideType.HERBLORE_BASE -> content.data.book.BarbarianBook.Companion.HERBLORE_BASICS
            content.data.book.GuideType.HERBLORE_FULL -> content.data.book.BarbarianBook.Companion.HERBLORE_COMPLETE
            content.data.book.GuideType.FISHING_FM_FULL -> content.data.book.BarbarianBook.Companion.FISHING_FM_COMPLETE
            content.data.book.GuideType.FISHING_FM_HERBLORE_FULL -> content.data.book.BarbarianBook.Companion.FISHING_FM_HERBLORE_COMPLETE
            content.data.book.GuideType.SMITHING_WITHOUT_REQS -> content.data.book.BarbarianBook.Companion.SMITHING_SPEAR_BASICS_NO_QUEST
            content.data.book.GuideType.SMITHING_MEETS_REQS -> content.data.book.BarbarianBook.Companion.SMITHING_SPEAR_BASICS
            content.data.book.GuideType.SMITHING_SPEAR_FULL -> content.data.book.BarbarianBook.Companion.SMITHING_SPEAR_COMPLETE
            content.data.book.GuideType.SMITHING_HASTAE_BASE -> content.data.book.BarbarianBook.Companion.SMITHING_HASTAE_BASICS
            content.data.book.GuideType.SMITHING_HASTAE_FULL -> content.data.book.BarbarianBook.Companion.SMITHING_HASTAE_COMPLETE
            else -> content.data.book.BarbarianBook.Companion.BARB_TRAINING_BASIC_PAGE
        }
        BookInterfaceListener.pageSetup(player, BookInterfaceListener.FANCY_BOOK_26,
            content.data.book.BarbarianBook.Companion.TITLE, guideContent, false)
        return true
    }
    ...
    override fun defineListeners() {
        on(Items.BARBARIAN_SKILLS_11340, IntType.ITEM, "read") { player, _ ->
            val guideType = when {
                getAttribute(player, BarbarianTraining.FISHING_BASE, false) -> content.data.book.GuideType.FISHING_BASE
                getAttribute(player, BarbarianTraining.FISHING_FULL, false) -> {
                    if (getAttribute(player, BarbarianTraining.FM_FULL, false)) content.data.book.GuideType.FISHING_FM_FULL
                    else content.data.book.GuideType.FISHING_FULL
                }
                getAttribute(player, BarbarianTraining.FM_BASE, false) -> content.data.book.GuideType.FIREMAKING_BASE
                getAttribute(player, BarbarianTraining.FM_FULL, false) -> {
                    if (getAttribute(player, BarbarianTraining.PYRESHIP_BASE, false)) content.data.book.GuideType.PYRESHIP_FULL
                    else content.data.book.GuideType.FIREMAKING_FULL
                }
                getAttribute(player, BarbarianTraining.PYRESHIP_BASE, false) -> content.data.book.GuideType.PYRESHIP_BASE
                getAttribute(player, BarbarianTraining.PYRESHIP_FULL, false) -> content.data.book.GuideType.PYRESHIP_FULL
                getAttribute(player, BarbarianTraining.HERBLORE_BASE, false) -> content.data.book.GuideType.HERBLORE_BASE
                getAttribute(player, BarbarianTraining.HERBLORE_FULL, false) -> {
                    if (getAttribute(player, BarbarianTraining.FISHING_FULL, false) && getAttribute(player, BarbarianTraining.FM_FULL, false)) {
                        content.data.book.GuideType.FISHING_FM_HERBLORE_FULL
                    } else content.data.book.GuideType.HERBLORE_FULL
                }
                getAttribute(player, BarbarianTraining.SPEAR_BASE, false) -> {
                    if (getAttribute(player, BarbarianTraining.FISHING_FULL, false)) content.data.book.GuideType.SMITHING_MEETS_REQS
                    else content.data.book.GuideType.SMITHING_WITHOUT_REQS
                }
                getAttribute(player, BarbarianTraining.SPEAR_FULL, false) -> {
                    if (getAttribute(player, BarbarianTraining.HASTA_BASE, false)) content.data.book.GuideType.SMITHING_HASTAE_BASE
                    else content.data.book.GuideType.SMITHING_SPEAR_FULL
                }
                getAttribute(player, BarbarianTraining.HASTA_FULL, false) -> content.data.book.GuideType.SMITHING_HASTAE_FULL
                else -> content.data.book.GuideType.DEFAULT
            }
