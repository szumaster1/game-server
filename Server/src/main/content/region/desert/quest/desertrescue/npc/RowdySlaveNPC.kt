...
class RowdySlaveNPC : AbstractNPC {
    ...
    override fun finalizeDeath(killer: Entity) {
        ...
        if (killer is Player) {
            val player = killer
            GroundItemManager.create(Item(526), getLocation(), player)
            if (!TouristTrap.hasSlaveClothes(player) && !player.equipment.containsItems(*TouristTrap.SLAVE_CLOTHES)) {
                player.packetDispatch.sendMessages("The slave drops his shirt.", "The slave drops his robe.", "The slave drops his boots.")
    ...
    companion object {
        private val CHATS = arrayOf("Oi! Are you looking at me?", "I'm going to teach you some respect!", "Hey, you're in for a good beating!")
    }
}
