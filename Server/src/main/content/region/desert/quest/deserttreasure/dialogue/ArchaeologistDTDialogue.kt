...
class ArchaeologistDTDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            20 -> npc(
                FacialExpression.HALF_THINKING, "Well, it's funny you should say that.",
            ...
            21 -> npc(
                FacialExpression.FRIENDLY, "could go and take it back to the digsite for me and get",
                "it examined."
            ).also { stage++ }

            22 -> npc(
                FacialExpression.NEUTRAL, "It's very old, and I don't recognise and of the",
                "inscriptions on it."
            ).also { stage++ }
            ...
            24 -> when (buttonId) {
                1 -> player(
                    FacialExpression.FRIENDLY, "Sure, I was heading that way anyways.",
            ...
            30 -> npc(
                FacialExpression.NEUTRAL, "His name's Terry Balando. Give it to nobody but him.",
            ...
            31 -> npc(
                FacialExpression.NEUTRAL, "a preliminary translation on.",
