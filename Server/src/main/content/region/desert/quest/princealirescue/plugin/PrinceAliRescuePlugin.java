package content.region.desert.quest.princealirescue.plugin;
...
public class PrinceAliRescuePlugin extends OptionHandler {
    ...
    public boolean handle(Player player, Node node, String option) {
        ...
        final int id = node instanceof Scenery ? node.getId() : node instanceof NPC ? ((NPC) node).getId() : 0;
        switch (id) {
            case 925:
