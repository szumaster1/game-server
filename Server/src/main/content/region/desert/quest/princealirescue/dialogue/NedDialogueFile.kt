...
/**
 * Represents the Ned dialogue file.
 */
class NedDialogueFile(val questStage: Int) : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            START_DIALOGUE -> options("Ned, could you make other things from wool?", "Yes, I would like some rope.", "No thanks Ned, I don't need any.").also { stage++ }
            ...
            4 -> when (buttonID) {
                ...
                3 -> player("Could you repair the arrow holes in the", "back of my shirt?").also {
                    stage = STAGE_REPAIR_HOLES
                }
            }

            // Knit Sweater.
            STAGE_KNIT_SWEATER -> npc("Do I look like a member of a sewing circle?", "Be off wi' you. I have fought monsters.", "that would turn your hair blue.").also { stage++ }
            STAGE_KNIT_SWEATER.substage(1) -> npc("I dont't need to be laughted at just 'cos I am getting", "a bit old.").also { stage = END_DIALOGUE }

            // Knit Wig.
            STAGE_KNIT_WIG -> npc("Well... That's an interesting thought. Yes, I think I", "could do something. Give me 3 balls of wool and I", "might be able to do it.").also { stage++ }
            STAGE_KNIT_WIG.substage(1) -> options("I have that now. Please, make me a wig.", "I will come back when I need you to make me one.").also { stage++ }
