...
/**
 * Ali the farmer dialogue.
 */
@Initializable
class AliTheFarmerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            19 -> npcl(FacialExpression.FRIENDLY, "I'm going to set up a shop selling farming implements. That patch out there may be small, but it's all we've got.").also { stage = 11 }
            ...
            42 -> npcl(FacialExpression.FRIENDLY, "Those people just don't want us to succeed. Don't listen to them!").also { stage = END_DIALOGUE }
        }
        return true
    }
