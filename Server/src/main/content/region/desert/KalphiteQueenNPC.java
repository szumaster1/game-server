...
/**
 * Represents the Kalphite queen npc.
 */
@Initializable
public final class KalphiteQueenNPC extends AbstractNPC {
    ...
    public void finalizeDeath(Entity killer) {
        ...
        visualize(TRANSFORM_ANIM, Graphic.create(1055));
    ...
    static class KQCombatSwingHandler extends CombatSwingHandler {
        ...
        private static final Graphic MAGIC_GFX_1 = Graphic.create(278);
        ...
        private static final Graphic MAGIC_GFX_2 = Graphic.create(279);
        private static final Graphic MAGIC_END_GFX = Graphic.create(281);
