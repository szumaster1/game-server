...
class BardurDialogue(player: Player? = null): Dialogue(player) {
    ...
    private val fremennikName = player!!.getAttribute("fremennikname", "name")
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            5 -> npcl(FacialExpression.FRIENDLY, "Listen, $fremennikName. I'm sorry about the way I acted while you were exiled.").also { stage++ }
            ...
            11 -> npcl(FacialExpression.FRIENDLY, "Aye, that I can $fremennikName! Yonder lies the lair of the daggermouth kings, the three beasts of legend!").also { stage++ }
            ...
            14 -> npcl(FacialExpression.FRIENDLY, "Ah, you did not come prepared $fremennikName?").also { stage++ }
