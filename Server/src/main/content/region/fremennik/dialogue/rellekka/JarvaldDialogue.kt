...
class JarvaldDialogue(player: Player? = null) : Dialogue(player) {
        ...
        when (stage) {
            ...
            25 -> {
                npc(
                    ...
                    "your ethusiasm seems genuine enough..."
                )
                stage++
            }
            ...
            33 -> when (buttonId) {
                1 -> if (!isQuestComplete(player, "Fremennik Trials") && !player.inventory.contains(995, 1000)) {
                    ...
                    npcl(
                        FacialExpression.FRIENDLY,
                        "I would head straight for the cave and not tarry too long " + player.username + ", the cold winds on this island can cut right through you should you spend too long in them."
                    )
    ...
    override fun getIds(): IntArray {
        return intArrayOf(2435, 2436, 2437, 2438)
    }
}