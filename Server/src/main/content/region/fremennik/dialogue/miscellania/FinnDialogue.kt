...
class FinnDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                1 -> player(FacialExpression.ASKING, "Yes please. What are you selling?").also { stage = 10 }
            ...
            20 -> npc(FacialExpression.HALF_WORRIED, "A lot drier in the winter than it is above ground.").also { stage = END_DIALOGUE }
        }
        return true
    }
