    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (getQuestStage(player!!, "Horror from the Deep")) {
            0 -> when (stage) {
                ...
                4 -> npcl(FacialExpression.HALF_GUILTY, "Oh... it is terrible... horrible... MY boyfriend lives here in this lighthouse, but I haven't seen him the last few days! I think something terrible has happened!").also { stage++ }
                5 -> npcl(FacialExpression.HALF_GUILTY, "Look, you can see for yourself that the light has gone out, and the front door is locked up tight! He would NEVER do that!").also { stage++ }
                6 -> npcl(FacialExpression.HALF_GUILTY, "With the light off this coastline is terribly dangerous to ships! And to lock the front door so that nobody can turn the light back on?").also { stage++ }
                ...
                8 -> npcl(FacialExpression.HALF_GUILTY, "That is terribly irresponsible! He is far too thoughtful for that! He would never leave it unattended! He would also never leave without telling me!").also { stage++ }
                9 -> npcl(FacialExpression.HALF_GUILTY, "Please, I know something terrible has happened to him... I can sense it! Please... please help me adventurer!").also { stage++ }
                ...
                12 -> npcl(FacialExpression.HALF_GUILTY, "Well, we have to do something to get the lighthouse working again! Also, as you may have noticed, the storm that knocked the bridge out").also { stage++ }
                13 -> npcl(FacialExpression.HALF_GUILTY, "has trapped me on this causeway! You seem to have got here okay somehow, so if you could go and visit my cousin and get the spare key I left him,").also { stage++ }
            ...
            in 1..29 -> {
                if (inInventory(player!!, Items.LIGHTHOUSE_KEY_3848) && getAttribute(player!!, HFTDUtils.FIX_BRIDGE, 0) == 2)
                    when (stage) {
                    ...
                    } else if (!inInventory(player!!, Items.LIGHTHOUSE_KEY_3848) && getAttribute(player!!, HFTDUtils.FIX_BRIDGE, 0) == 2)
                    when (stage) {
                    ...
                    } else if (inInventory(player!!, Items.LIGHTHOUSE_KEY_3848) && getAttribute(player!!, HFTDUtils.FIX_BRIDGE, 0) == 0)
                    when (stage) {
                        0 -> playerl(FacialExpression.FRIENDLY, "I've got your key for you!").also { stage++ }
                    ...
                    1 -> npcl(FacialExpression.HALF_GUILTY, "Oh, please find my darling! I just know something horrible has happened!").also { stage = END_DIALOGUE }
                }
            }

            30 -> when (stage) {
                0 -> npcl(FacialExpression.HALF_GUILTY, "This is terrible... What could have happened here? Please, you must fix the light, we cannot let my darling Jossik take the blame for any shipwrecks!").also { stage++ }
            ...
            in 31..39 -> when (stage) {
                ...
                1 -> npcl(FacialExpression.HALF_GUILTY, "You MUST find a way to fix the lighthouse! The ships are in terrible danger as long as the light is not working properly!").also { stage++ }
                2 -> playerl(FacialExpression.FRIENDLY, "Okay, I will see what I can do.").also { stage++ }
                3 -> npcl(FacialExpression.HALF_GUILTY, "I'm sorry adventurer, I do not know anything about lighthouses.").also { stage++ }
                4 -> npcl(FacialExpression.HALF_GUILTY, "I'm sure there must be some kind of user's guide around here somewhere though.").also { stage++ }
            ...
            in 60..69 -> when (stage) {
                ...
                1 -> npcl(FacialExpression.HALF_GUILTY, "That is wonderful news! But why does he not come up out of there?").also { stage++ }
                2 -> playerl(FacialExpression.FRIENDLY, "Um... well, there's a big monster down there with him stopping him leaving.").also { stage++ }
                3 -> npcl(FacialExpression.HALF_GUILTY, "What?!?! You MUST save him! I beseech you, please! Do something!").also { stage++ }
