package content.region.fremennik.quest.horrorfromthedeep.cutscene

import content.region.fremennik.quest.horrorfromthedeep.npc.DagonnothBabyNPC
...
/**
 * First dagannoth cutscene.
 */
class FirstDagannothCutscene(player: Player) : Cutscene(player) {
    override fun setup() {
