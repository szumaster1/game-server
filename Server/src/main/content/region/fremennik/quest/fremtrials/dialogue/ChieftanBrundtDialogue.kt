...
class ChieftanBrundtDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            //Pre-Quest
            0 -> {
                options("What is this place?", "Why will no-one talk to me?", "Do you have any quests?", "Nice hat!");stage++
            }
            1 -> when (buttonId) {
            ...
            15 -> npcl(FacialExpression.ANNOYED, "Don't mock me outerlander; this helm has saved my life more times than I care to recall right now.").also { stage = END_DIALOGUE }
            //Do you have any quests?
            300 -> {
                npc("Quests, you say outlander? Well, I would not call it a", "quest as such, but if you are brave of heart and strong", "of body, perhaps..."); stage++
            }

            301 -> {
                npc("No, you would not be interested. Forget I said", "anything, outerlander."); stage++
            }

            302 -> {
                options("Yes, I am interested.", "No, I'm not interested."); stage++
            }

            303 -> when (buttonId) {
                1 -> {
                    player("Actually, I would be very interested to hear what you", "have to offer."); stage = 310
                }

                2 -> {
                    player("No, I'm not interested."); stage = END_DIALOGUE
                }
            }

            //Yes, I am interested in what you have to say.
            310 -> {
                npc("You would? These are unusual sentiments to hear from", "an outerlander! My suggestion was going to be that if", "you crave adventure and battle,"); stage++
            }

            311 -> {
                npc("and your heart sings for glory, then perhaps you would", "be interested in joining our clan, and becoming a", "Fremennik yourself?");stage++
            }

            312 -> {
                player("What would that involve exactly?");stage++
            }

            313 -> {
                npc("Well, there are two ways to become a member of our", "clan and call yourself a Fremennik: be born a", "Fremennik, or be voted in by our council of elders.");stage++
            }

            314 -> {
                player("Well, I think I've missed the first way, but how can I", "get the council of elders to vote to let me join your", "clan?");stage++
            }

            315 -> {
                npc("Well, that I cannot answer myself. You will need to", "speak to each of them and see what they require of you", "as proof of your dedication.");stage++
            }

            316 -> {
                npc("There are twelve council members around this village;", "you will need to gain a majority vote of at least seven", "councillors in your favor.");stage++
            }

            317 -> {
                npc("So, what say you? Give me the word and I will tell all", "of my tribe of your intentions, be they yes or nay.");stage++
            }

            318 -> {
                options("I want to become a Fremennik!", "I don't want to become a Fremennik.");stage++
            }

            319 -> when (buttonId) {
                1 -> {
                    player("I think I would enjoy the challenge of becoming an", "honorary Fremennik. Where and how do I start?");stage = 320
                }

                2 -> {
                    player("That sounds too complicated to me.");stage = 322
                }
            }

            //I think I would enjoy the challenge of becoming an honorary fremennik
            320 -> {
                npc("As I say outerlander, you must find and speak to the", "twelve members of the council of elders, and see what", "tasks they might set you.");stage++
            }
            ...
            511 -> npcl(FacialExpression.ANNOYED, "Sigli the hunter is the only one who knows of such hunting grounds. Go and request his knowledge.").also { stage = END_DIALOGUE }
            ...
            520 -> npcl(FacialExpression.HAPPY, "Not at all outerlander; now that we have Sigli's map we can increase the amount of hunts we run, and make up any shortfall that way.").also { stage = END_DIALOGUE }
            525 -> npcl(FacialExpression.ANNOYED, "Not unless it's a map of the hunting grounds.").also { stage = END_DIALOGUE }
            ...
            540 -> playerl(FacialExpression.HAPPY, "I only have ${getAttribute(player, "fremtrials:votes", 0)} votes so far.").also { stage++ }
            ...
            602 -> npcl(FacialExpression.HAPPY, "Well met, $gender $fName. it is always good to see your face in glorious Rellekka once more!").also { stage = END_DIALOGUE }
            605 -> npcl(FacialExpression.HAPPY, "Not at the moment, $fName. Rest assured, should your services to the Fremennik be required, I will call upon you").also { stage = END_DIALOGUE }
            610 -> npcl(FacialExpression.HAPPY, "Aye that it is, $gender $fName. Should you desire one of your own, you should go to Skulgrimen's shop and see what they have available!").also { stage = END_DIALOGUE }
            ...
            665 -> npcl(FacialExpression.HAPPY, "Well let me know should you wish to hear our lore and histories. We value them highly.").also { stage = END_DIALOGUE }
            ...
            1203 -> {//!requireQuest(player, "Lunar Diplomacy")
