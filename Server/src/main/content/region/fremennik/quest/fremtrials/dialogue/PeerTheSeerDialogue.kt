...
class PeerTheSeerDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        if (inInventory(player, Items.WARRIORS_CONTRACT_3710, 1)) {
            ...
            return true
                ...
                "PeerStarted",
                false
            ) && !player.inventory.isEmpty || !player.equipment.isEmpty
        ) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            81 -> npcl(
                FacialExpression.HAPPY,
                "What say you outerlander? Do you wish me to do this for you?"
            ).also { stage++ }
