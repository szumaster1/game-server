...
class AskeladdenDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            21 -> when (buttonId) {
                1 -> if (inInventory(player, Items.COINS_995, 5000) && !player.inventory.isFull) {
            ...
            41 -> playerl(FacialExpression.HAPPY, "My Fremennik name is ${getAttribute(player, "fremennikname", "fremmyname")}.").also { stage++ }
