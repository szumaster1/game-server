    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            1 -> npcl(
                ...
                "How did you hear about that? I didn't think anybody knew about that."
            ).also { stage++ }

            2 -> npcl(
                FacialExpression.HAPPY,
                "Well, it is true that in my younger years as a barkeep, I wandered the lands trying various alcoholic delicacies."
            ).also { stage++ }

            3 -> npcl(
                FacialExpression.HAPPY,
                "Do know how many different types of alcohol there are here in Gielinor? Lots!"
            ).also { stage++ }

            4 -> npcl(
                FacialExpression.HAPPY,
                "Well, anyway, I used a fusion of various drinks from all around the world to create the greatest cocktail ever made!"
            ).also { stage++ }

            5 -> npcl(
                FacialExpression.HAPPY,
                "Of course, when my wander lust was gone, and I returned to Rellekka to serve as barkeep here, I gave all that up."
            ).also { stage++ }
            ...
            15 -> npcl(
                ...
                "He is nothing but a pest. He keeps sneaking in and stealing beer."
            ).also { stage++ }

            16 -> npcl(
                FacialExpression.ANGRY,
                "I shudder to think what he will be like when he has passed his trial of manhood, and is allowed in here legitimately."
            ).also { stage++ }

            17 -> npcl(
                FacialExpression.ANGRY,
                "If you can get him to sign a contract promising that he will NEVER EVER EVER darken my doorway here again, you get the drink."
            ).also { stage++ }
            ...
            26 -> npcl(
                FacialExpression.HAPPY,
                "Here you go, on the house! You have made my life SO much easier! Knowing that little monster won't be bugging me in here all the time anymore!"
            ).also { stage++ }
            ...
            35 -> npcl(
                FacialExpression.SAD,
                "Ah... when I gave up my travels across the world many years back, to return to my expected role as longhall barkeep,"
            ).also { stage++ }

            36 -> npcl(
                FacialExpression.SAD,
                "as my mother, and her mother, were before me, I gave up a lot of the freedom I had found in the outside world."
            ).also { stage++ }
            ...
            38 -> npcl(
                FacialExpression.SAD,
                "Sometimes I feel as though we Fremennik live in a prison that we have constructed for ourselves,"
            ).also { stage++ }
            ...
            40 -> npcl(
                FacialExpression.SAD,
                "I'm sorry, I think it is part of the job of Longhall barkeep to get philosophical about things ocassionally."
            ).also { stage++ }
            ...
            42 -> npcl(
                FacialExpression.HAPPY,
                "When you have finished, perhaps you will come back here, and we can share a drink over tales of the outside world?"
            ).also { stage++ }
            ...
            50 -> playerl(
                FacialExpression.THINKING,
                "Scam? Oh... You mean his promise to not come in here anymore?"
            ).also { stage++ }

            51 -> npcl(
                FacialExpression.ANNOYED,
                "Yes. Yes I do. I should have never trusted him not to come in here, even with that written promise. Anyway, do you want a drink or not?"
            ).also { stage++ }

            52 -> options("Yes please", "No thanks").also { stage++ }
            53 -> when (buttonId) {
                1 -> playerl(FacialExpression.HAPPY, "Yes please").also { stage = 66 }
            ...
            62 -> npcl(
                FacialExpression.HAPPY,
                "The Chieftain is stood just over there, his name is Brundt. I suggest you go and introduce yourself."
            ).also { stage++ }

            63 -> npcl(
                FacialExpression.ASKING,
                "You wouldn't want to go making any enemies because you weren't aware of our customs now, would you?"
            ).also { stage++ }
