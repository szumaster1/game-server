...
import content.global.transport.LyreTeleport
...
import content.region.fremennik.quest.viking.npc.KoscheiSession
import core.api.*
...
class FremennikTrialsListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.FISHERMAN, IntType.NPC, "talk-to") { player, _ ->
        ...
        onUseWith(IntType.NPC,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.BEER,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.WORKER
        ) { player, beer, _ ->
            // Opens the Council Worker dialogue with the beer item
            player.dialogueInterpreter.open(CouncilWorkerDialogue(0, true, beer.id), NPC(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.WORKER))
            return@onUseWith true
        }

        // Listener for using fish with the fish altar
        onUseWith(IntType.SCENERY,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.FISH,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.FISH_ALTAR
        ) { player, fish, _ ->
            ...
            if (anyInInventory(player, Items.LYRE_3689, Items.ENCHANTED_LYRE_3690)) {
                ...
                if(inInventory(player, Items.RAW_BASS_363)) {
                    ...
                    sendNPCDialogue(player, NPCs.FOSSEGRIMEN_1273, "That's not a bass, it's a very small shark.").also {
                        ...
                        Pulser.submit(
                            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.SpiritPulse(
                                player,
                                fish.id
                            )
                        )
        ...
        onUseWith(IntType.ITEM,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.LOW_ALC_KEG,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.KEG
        ) { player, _, _ ->
        ...
        onUseWith(IntType.ITEM,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.TINDERBOX,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.CHERRY_BOMB
        ) { player, _, _ ->
            ...
            if (removeItem(player,
                ...
                addItem(player,
                    content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.LIT_BOMB
                )
        ...
        onUseWith(IntType.ITEM,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.KNIFE,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.TREE_BRANCH
        ) { player, _, _ ->
            ...
            // Submits a branch fletching pulse for the player
                Pulser.submit(
                    content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.BranchFletchingPulse(
                        player
                    )
                )
            else
        ...
        onUseWith(IntType.SCENERY,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.STEW_INGREDIENT_IDS,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.LALLIS_STEW
        ...
        onUseWith(IntType.SCENERY,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.GOLDEN_FLEECE, *content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.SPINNING_WHEEL_IDS
        ) { player, _, _ ->
            // Checks if the golden fleece is removed successfully
            if (removeItem(player,
                    content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.GOLDEN_FLEECE
                )) {
                // Adds golden wool to the player's inventory
                addItem(player,
                    content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.GOLDEN_WOOL
                )
        ...
        onUseWith(IntType.ITEM,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.UNSTRUNG_LYRE,
            content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.GOLDEN_WOOL
        ) { player, _, _ ->
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.LONGHALL_BACKDOOR, IntType.SCENERY, "open") { player, node ->
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.LYRE_IDs, IntType.ITEM, "play") { player, lyre ->
            ...
            if (getAttribute(player, "onStage", false) && !getAttribute(player, "lyreConcertPlayed", false)) {
                ...
                Pulser.submit(
                    content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.LyreConcertPulse(
                        player,
                        lyre.id
                    )
                )
            ...
            } else if (content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.LYRE_IDs.isLast(lyre.id)) {
                ...
                if (removeItem(player, lyre.asItem())) {
                    ...
                    addItem(player, content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.LYRE_IDs.getNext(lyre.id))
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.PIPE, IntType.SCENERY, "put-inside") { player, _ ->
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.PORTALIDs, IntType.SCENERY, "use") { player, portal ->
            // Set the player's teleport location based on the portal ID
            player.properties?.teleportLocation = when (portal.id) {
                2273 -> content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom(
                    2639,
                    10012,
                    2645,
                    10018
                ).getCenter() // Teleport to specific coordinates
                2274 -> content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom(
                    2650,
                    10034,
                    2656,
                    10040
                ).getCenter() // Teleport to specific coordinates
                2506 -> content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom(
                    2662,
                    10023,
                    2669,
                    10029
                ).getCenter() // Teleport to specific coordinates
                2507 -> content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom(
                    2626,
                    10023,
                    2633,
                    10029
                ).getCenter() // Teleport to specific coordinates
                2505 -> content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom(
                    2650,
                    10001,
                    2656,
                    10007
                ).getCenter() // Teleport to specific coordinates
                2503 -> content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom(
                    2662,
                    10012,
                    2668,
                    10018
                ...
                2504 -> {
                    ...
                    content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom(
                        2662,
                        10034,
                        2668,
                        10039
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.SWENSEN_LADDER, IntType.SCENERY, "climb") { player, _ ->
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.THORVALD_LADDER, IntType.SCENERY, "climb-down") { player, _ ->
            ...
            Pulser.submit(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.KoscheiPulse(player))
            // Indicate that the event was handled successfully
            return@on true
        }

        // Handle the action when a player interacts with the THORVALD_LADDER_LOWER
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.THORVALD_LADDER_LOWER, IntType.SCENERY, "climb-up") { player, _ ->
            // Close the Koschei session if it exists
            if (player.getExtension<Any?>(KoscheiSession::class.java) != null) {
                KoscheiSession.getSession(player).close()
            }
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.SWAYING_TREE, IntType.SCENERY, "cut-branch") { player, node ->
        ...
        on(content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.Companion.SHOPNPCS, IntType.NPC, "Trade") { player, npc ->
     ...
     */
    fun content.region.fremennik.rellekka.quest.viking.FremennikTrialsListeners.DestRoom.getCenter(): Location {
