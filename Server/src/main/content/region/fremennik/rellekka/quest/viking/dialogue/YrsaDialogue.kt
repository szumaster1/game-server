...
import content.dialogue.rellekka.YrsaDiaryDialogue
 ...
 *
 * Related to [Fremennik Trials quest][content.region.fremennik.quest.viking.FremennikTrials]
 *
...
class YrsaDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            10 -> npcl(FacialExpression.NEUTRAL, "Yes I do outerlander. Only the Chieftain may permit such a thing. Talk to him.").also { stage = END_DIALOGUE }
            ...
            35 -> npcl(FacialExpression.HAPPY, "I'm sorry outerlander, I cannot sell you any clothes. Our customs forbid it.").also { stage = END_DIALOGUE }
            36 -> {
                end()
