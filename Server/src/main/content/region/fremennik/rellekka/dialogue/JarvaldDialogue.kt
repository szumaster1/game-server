...
class JarvaldDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                1 -> player("Where is your chieftain?", "I find it highly discriminatory to refuse to talk to", "someone on the grounds that they are not part of your", "tribe.").also { stage = 10 }
                2 -> player("So what are you doing here?").also { stage = 20 }
                3 -> end()
            }
            10 -> npc("I don't rightly understand your speech outerlander, but", "my loyalty is with Chieftain Brundt.").also { stage++ }
            11 -> npc("He resides in our longhall; it is the large building over", "there, you should speak to him for he speaks for us all.").also { stage = END_DIALOGUE }
            12 -> end()
            ...
            23 -> npc("Well.....", "I gues...", "I might be able to allow you to join us, although it is a", "breach of many of our customs...").also { stage++ }
            24 -> player("Oh, pleeeeeeease?", "I really LOVE killing stuff!").also { stage++ }
            25 -> npc("Well...", "I remain unconvinced that it would be wise to allow an", "outerlander to join us in such dangerous battle, but", "your enthusiasm seems genuine enough...").also { stage++ }
            26 -> npc("I will allow you to escort us, but you must pay me a", "sum of money first.").also { stage++ }
            27 -> player("What?", "That's outrageous, why charge me money?", "And, uh, how much does it cost me?").also { stage++ }
            28 -> npc("Ah, the outerlander have stolen from my people for", "many years, in this way you can help my community", "with a small amount of money...").also { stage++ }
            29 -> npc("Let us say...", "1000 coins.", "Payable in advance, of course.").also { stage++ }
            30 -> npc("For this I will take you to Waterbirth Island on my", "boat, and will bring you back here when you have had", "your fill of the hunt.", "Assuming you are still alive to wish to leave, of course.").also { stage++ }
            31 -> {
            ...
            33 -> when (buttonId) {
                1 -> if (!isQuestComplete(player, "Fremennik Trials") && !player.inventory.contains(995, 1000)) {
                    ...
                    sail(player, TravelDestination.RELLEKKA_TO_WATERBIRTH)
                    npcl(FacialExpression.FRIENDLY, "I would head straight for the cave and not tarry too long " + player.username + ", the cold winds on this island can cut right through you should you spend too long in them.")
            ...
            37 -> npc("Have you had your fill of the hunt and wish to return,", "or are you still feeling the joy of the cull?").also { stage++ }
