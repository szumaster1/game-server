...
class HorrorFromTheDeepListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(content.region.fremennik.rellekka.lighthouse.quest.horror.HorrorUtils.LIGHTHOUSE_FRONT_DOORS, IntType.SCENERY, "walk-through") { player, node ->
        ...
        onUseWith(IntType.SCENERY, Items.SWAMP_TAR_1939, Scenery.LIGHTING_MECHANISM_4588) { player, _, _ ->
            if (removeItem(player, Items.SWAMP_TAR_1939)) {
                ...
                setAttribute(player,
                    content.region.fremennik.rellekka.lighthouse.quest.horror.HorrorUtils.fixLighthouseMechanism, 1)
            }
        ...
        onUseWith(IntType.SCENERY, Items.TINDERBOX_590, Scenery.LIGHTING_MECHANISM_4588) { player, _, _ ->
            ...
            player.incrementAttribute(content.region.fremennik.rellekka.lighthouse.quest.horror.HorrorUtils.fixLighthouseMechanism)
            return@onUseWith true
        }
        ...
        onUseWith(IntType.SCENERY, Items.MOLTEN_GLASS_1775, Scenery.LIGHTING_MECHANISM_4588) { player, item, mechanism ->
            if (getAttribute(player,
                    content.region.fremennik.rellekka.lighthouse.quest.horror.HorrorUtils.fixLighthouseMechanism, 0) == 2 && removeItem(player, item.asItem())) {
