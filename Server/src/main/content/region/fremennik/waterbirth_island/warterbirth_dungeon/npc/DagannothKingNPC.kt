package content.region.fremennik.waterbirth_island.warterbirth_dungeon.npc
...
class DagannothKingNPC(id: Int = 0, location: Location? = null) : AbstractNPC(id, location) {
    ...
    enum class DagType(val id: Int, val style: CombatStyle, val weakStyle: CombatStyle, val immuneStyle: CombatStyle, val maxHit: Int) {
        SUPREME(
