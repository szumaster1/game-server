...
import content.region.misthalin.dialogue.varrock.museum.MuseumUtils.initLearning
import core.api.*
...
class TalkAboutTortoises : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            6 -> npcl(
                FacialExpression.FRIENDLY,
                "The oldest tortoise ever recorded was Mibbiwocket, who was presented to the King Healthorg the Great,"
            ).also { stage++ }

            7 -> npcl(
                FacialExpression.FRIENDLY,
                "by the famous explorer Admiral Bake, shortly after its birth."
            ).also { stage++ }
            ...
            9 -> npcl(
                FacialExpression.FRIENDLY,
                "And this concludes my short lecture on tortoises. I hope you've enjoyed yourselves."
            ).also { stage++ }
...
class TalkAboutDragons : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            7 -> npcl(
                FacialExpression.HALF_GUILTY,
                "They colonise many areas of Gielinor, though most notably, sites of ancient battles and small dank caves."
            ).also { stage++ }
