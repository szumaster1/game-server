...
class TalkAboutMoles : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> npcl(
                FacialExpression.HALF_GUILTY,
                "They vary greatly in habitat and can be found in almost every part of Gielinor. [sic]Some species have even known to be aquatic."
            ).also { stage++ }
            ...
            9 -> npcl(
                FacialExpression.HALF_GUILTY,
                "And this concludes my short lecture on moles. I hope you've enjoyed yourselves."
            ).also { stage++ }
