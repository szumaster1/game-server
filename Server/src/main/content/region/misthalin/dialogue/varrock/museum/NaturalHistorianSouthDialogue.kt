...
class TalkAboutKalphiteQueen : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            0 -> npcl(
                FacialExpression.HALF_GUILTY,
                "The kalphites, otherwise known as the kalphiscarabeinae, are perhaps the largest species of insect on the face of Gielinor."
            ).also { stage++ }
            ...
            16 -> npcl(
                FacialExpression.HALF_GUILTY,
                "and transformed them into the kalphites we know today."
            ).also { stage++ }
