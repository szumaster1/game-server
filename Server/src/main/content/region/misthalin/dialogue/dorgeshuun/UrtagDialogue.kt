...
class UrtagDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            7 -> npcl(FacialExpression.OLD_NORMAL, "Why don't you visit the market?").also { stage++ }
            8 -> npcl(FacialExpression.OLD_NORMAL, "I hear there is quite a craze for surface foods at the moment, so you might be able to sell something there.").also { stage++ }
            9 -> npcl(FacialExpression.OLD_NORMAL, "You might also want to visit the caves to the south of the city.").also { stage++ }
            10 -> npcl(FacialExpression.OLD_NORMAL, "There are many monsters to fight there, and Zanik tells me she has also found ways to cross over their heads!").also { stage = END_DIALOGUE }
        }
        return true
    }
