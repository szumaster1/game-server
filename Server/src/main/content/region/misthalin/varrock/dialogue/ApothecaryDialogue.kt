...
class ApothecaryDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            51 -> if (player.inventory.remove(*content.region.misthalin.varrock.dialogue.ApothecaryDialogue.Companion.POTION_ITEMS)) {
                player.inventory.add(content.region.misthalin.varrock.dialogue.ApothecaryDialogue.Companion.POTION)
                end()
            ...
            30 -> {
                ...
                player.inventory.add(content.region.misthalin.varrock.dialogue.ApothecaryDialogue.Companion.UNKNOWN_POTION)
                stage = 31
            }
            ...
            505 -> {
                npc("Bring them here when you have them. But be careful.",
                    "They are nasty."
                )
                stage = 506
            }
            ...
            638 -> {
                if (player.inventory.remove(content.region.misthalin.varrock.dialogue.ApothecaryDialogue.Companion.CADAVA_BERRIES)) {
            ...
            639 -> {
                if (!player.inventory.add(content.region.misthalin.varrock.dialogue.ApothecaryDialogue.Companion.CADAVA_POTION)) {
                    GroundItemManager.create(GroundItem(content.region.misthalin.varrock.dialogue.ApothecaryDialogue.Companion.CADAVA_POTION, player.location, player))
                }
