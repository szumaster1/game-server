...
class WhatLiesBelow : Quest("What Lies Below", 136, 135, 1) {
    ...
    override fun finish(player: Player) {
        super.finish(player)
        setInterfaceText(player, "8,000 Runecrafting XP", 277, 8 + 2)
        setInterfaceText(player, "2,000 Defence XP", 277, 9 + 2)
        setInterfaceText(player, "Beacon FairyRing", 277, 10 + 2)
        setInterfaceText(player, "Knowledge of Chaos Tunnel", 277, 11 + 2)
     ...
     *
     * @param player The player for whom the message is being generated.
     * @return A string containing the requirements message for the player.
     */
    ...
    /**
     * Checks if the player meets the necessary requirements.
     *
     * @param player The player whose requirements are being checked.
     * @return True if the player meets all requirements, otherwise false.
     */
    ...
    /**
     * Retrieves the configuration for the player and stage.
     *
     * @param player The player for whom the configuration is being retrieved.
     * @param stage The current stage of the player.
     * @return An array of integers representing the configuration.
     */
    ...
    companion object {
        ...
        @JvmField val BOWL: Item = Item(Items.BOWL_1923)
        @JvmField val SIN_KETH_DIARY: Item = Item(Items.SINKETHS_DIARY_11002)
        @JvmField val EMPTY_FOLDER: Item = Item(Items.AN_EMPTY_FOLDER_11003)
        @JvmField val USED_FOLDER: Item = Item(Items.USED_FOLDER_11006)
        @JvmField val FULL_FOLDER: Item = Item(Items.FULL_FOLDER_11007)
        @JvmField val RATS_PAPER: Item = Item(Items.RATS_PAPER_11008)
        @JvmField val RATS_LETTER: Item = Item(Items.RATS_LETTER_11009)
        @JvmField val SUROKS_LETTER: Item = Item(Items.SUROKS_LETTER_11010)
        @JvmField val WAND: Item = Item(Items.WAND_11012)
        @JvmField val INFUSED_WAND: Item = Item(Items.INFUSED_WAND_11013)
        @JvmField val BEACON_RING: Item = Item(Items.BEACON_RING_11014)
    }
}
