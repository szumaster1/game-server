    ...
    override fun create(b: DialogueBuilder) {
        ...
        b.onPredicate { player ->
            getQuestStage(player, "The Dig Site") == 3 && getAttribute(
                player,
                TheDigSite.attrGreenExam1ObtainAnswer, false
            )
        }
            .playerl(FacialExpression.FRIENDLY, "Hello there.")
            .npcl(FacialExpression.FRIENDLY, "How's it going?")
        ...
        b.onPredicate { player ->
            getQuestStage(player, "The Dig Site") == 3 && getAttribute(
                player,
                TheDigSite.attrGreenExam1Talked, false
            )
        }
            .branch { player ->
...
class StudentPurpleDialogueFile : DialogueBuilderFile() {
    ...
    override fun create(b: DialogueBuilder) {
        ...
        b.onPredicate { player ->
            getQuestStage(player, "The Dig Site") == 3 && getAttribute(
                player,
                TheDigSite.attrPurpleExam1ObtainAnswer, false
            )
        }
            .playerl(FacialExpression.FRIENDLY, "Hello there.")
            .npcl(FacialExpression.FRIENDLY, "How's it going?")
        ...
        b.onPredicate { player ->
            getQuestStage(player, "The Dig Site") == 3 && getAttribute(
                player,
                TheDigSite.attrPurpleExam1Talked, false
            )
        }
            .branch { player ->
