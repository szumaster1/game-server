package content.region.misthalin.handlers.draynorvillage.cutscene;
...
public final class DBRCutscenePlugin extends CutscenePlugin {
    ...
    private static final Graphic TELEKENTIC_GRAPHIC = new Graphic(142, 96);
    ...
    private static final Graphic SHOCK_GRAPHIC = new Graphic(432, 0, 0);
    private static final Animation TELEPORT_ANIMATION = new Animation(1816);
    private static final Graphic[] TELE_OTHERS = new Graphic[]{new Graphic(343), new Graphic(342)};
    ...
    private static final Graphic PURPLE_GRAPHIC = new Graphic(301, 100);
    private static final Graphic THUNDER_GRAPHIC = new Graphic(76);
    ...
    private void castShock(Node target) {
        ...
        getWiseOldMan().graphics(new Graphic(433));
    ...
    public static final class BluePhatItem extends ItemPlugin {
        ...
        public boolean canPickUp(Player player, GroundItem item, int type) {
            if (type == 1) {
                ...
                /*
                 * Checked if this is authentic or based ego rebuild.
                 */
