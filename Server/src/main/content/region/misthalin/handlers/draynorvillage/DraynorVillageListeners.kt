...
class DraynorVillageListeners : InteractionListener {
    ...
    companion object {
        ...
        private val randomDialogue = arrayOf("Hey - gerroff me!", "You'll blow my cover! I'm meant to be hidden!", "Don't draw attention to me!", "Will you stop that?", "Watch what you're doing with that hatchet, you nit!", "Ooooch!", "Ow! That really hurt!", "Oi!")
    }
    ...
    override fun defineListeners() {
        ...
        on(Scenery.TREE_10041, IntType.SCENERY, "chop down", "talk to") { player, _ ->
            when(getUsedOption(player)) {
                "chop down" -> sendNPCDialogue(player, NPCs.GUARD_345, randomDialogue.random(), FacialExpression.ANNOYED)
