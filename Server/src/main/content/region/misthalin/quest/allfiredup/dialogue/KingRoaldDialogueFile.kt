package content.region.misthalin.quest.allfiredup.dialogue
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (questStage == 0) {
            when (stage) {
                ...
                1 -> player("Hello, Your Majesty. I am happy to report that the", "situation at the Temple of Paterdomus has been sorted.", "Misthalin's borders should once again be fully protected", "against the threats of Morytania.").also { stage++ }
                ...
                4 -> npc("Of course not; however, if it's rewards you're after, it", "occurs to me that you could be of even more service to", "the kingdom...and this time, there's payment in it for", "you.").also { stage++ }
                ...
                7 -> npc("Well, you see, because of the mounting threats from", "Morytania and the Wilderness, the southern kingdoms", "have banded together to take action.").also { stage++ }
                8 -> npc("We have constructed a network of beacons that stretch", "all the way from the source of the River Salve to the", "northwestern-most edge of the Wilderness.").also { stage++ }
                9 -> npc("Should there be any threat from these uncivilized lands,", "we'll be able to spread the word as fast as the light of", "the flames can travel.").also { stage++ }
                10 -> player("So how could I be of help?").also { stage++ }
                11 -> npc("The task itself should be rather straightforward: I need", "you to help us test the network of beacons to make", "sure everything is in order, in case the worst", "should occur.").also { stage++ }
                ...
                16 -> npc("Talk to the head fire tender, Blaze Sharpeye - he'll", "explain everything. He is stationed just south of the", "Temple of Paterdomus, on the cliffs by the River Salve.").also { stage++ }
