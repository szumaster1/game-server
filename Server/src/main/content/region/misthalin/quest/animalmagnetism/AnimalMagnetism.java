package content.region.misthalin.quest.animalmagnetism;

import content.region.misthalin.quest.animalmagnetism.dialogue.AliceDialogue;
import content.region.misthalin.quest.animalmagnetism.dialogue.AliceHusbandDialogue;
import content.region.misthalin.quest.animalmagnetism.dialogue.AvaDialogue;
import content.region.misthalin.quest.animalmagnetism.dialogue.WitchDialogue;
import content.region.misthalin.quest.animalmagnetism.dialogue.AliceDialogue;
import content.region.misthalin.quest.animalmagnetism.dialogue.AliceHusbandDialogue;
import content.region.misthalin.quest.animalmagnetism.dialogue.AvaDialogue;
import content.region.misthalin.quest.animalmagnetism.dialogue.WitchDialogue;
...
/**
 * Represents the Animal Magnetism quest.
 */
@Initializable
public final class AnimalMagnetism extends Quest {
    ...
    public void finish(Player player) {
        ...
        player.getPacketDispatch().sendString("2500 Woodcutting XP", 277, 10 + 2);
