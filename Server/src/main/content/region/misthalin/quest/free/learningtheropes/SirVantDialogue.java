...
/*
import content.region.misc.handlers.tutorialisland.TutorialStage;
...
@Initializable
public class SirVantDialogue extends dialogue {
    ...
    public boolean open(Object... args) {
        int tut_stage = TutorialStage.getExtension(player).getStage();
    ...
    public boolean handle(int interfaceId, int buttonId) {
        switch (stage) {
            ...
            case 7:
                ...
                TutorialStage.INSTANCE.load(player, 2, false);
                break;
            case 10:
            ...
            case 16:
                ...
                TutorialStage.INSTANCE.load(player, 4, false);
                break;
        }
        return true;
    }
