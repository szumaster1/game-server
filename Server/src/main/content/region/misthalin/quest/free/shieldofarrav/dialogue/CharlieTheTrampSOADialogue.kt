...
@Initializable
class CharlieTheTrampSOADialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            100 -> npc(FacialExpression.SAD, "Thanks anyways!").also { stage = END_DIALOGUE }
            150 -> npc(FacialExpression.ANNOYED, "You startin? I hope your nose falls off!").also { stage = END_DIALOGUE }
            200 -> {
            ...
            203 -> when (buttonId) {
                1 -> player(FacialExpression.FRIENDLY, "No problem.").also { stage = END_DIALOGUE }
            ...
            221 -> npcl(FacialExpression.SAD, "I just need to eat...").also { stage = END_DIALOGUE }
            ...
            270 -> npc(FacialExpression.HAPPY, "Don't worry about it.").also { stage = END_DIALOGUE }
            280 -> if (!ShieldofArrav.isBlackArm(player) && !ShieldofArrav.isPhoenix(player)) {
                ...
                npcl(FacialExpression.SUSPICIOUS, "I was under the impression you were already a member...").also { stage = END_DIALOGUE }
            } else {
            ...
            292 -> when (buttonId) {
                1 -> player(FacialExpression.SUSPICIOUS, "How did you know I was in the Phoenix Gang?").also {
                    stage = 300
                }
            ...
            310 -> npc(FacialExpression.LAUGH, "I'm not just a pretty face!").also { stage = END_DIALOGUE }
            320 -> npcl(FacialExpression.NEUTRAL, "There's plenty of other adventurers about besides yourself. I'm sure if you asked one of them nicely they would help you.").also { stage = END_DIALOGUE }
        }
        return true
    }
