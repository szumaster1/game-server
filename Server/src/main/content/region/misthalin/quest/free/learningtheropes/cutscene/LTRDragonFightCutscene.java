package content.region.misthalin.quest.free.learningtheropes.cutscene;

import content.region.misc.handlers.tutorial.TutorialStage;
import content.region.misthalin.quest.free.learningtheropes.CellarMapZone;
...
/**
 * The Ltr dragon fight cutscene.
 */
@Initializable
public class LTRDragonFightCutscene extends CutscenePlugin {

    private static final NPC[] NPCS = new NPC[]{NPC.create(7943, Location.create(2524, 5015, 0), Direction.SOUTH), NPC.create(7938, Location.create(2524, 5005, 0), Direction.NORTH), NPC.create(7964, Location.create(2522, 5000, 0), Direction.NORTH),};
    ...
    private static final Graphic DRAGON_FIRE_BREATH_GFX = new Graphic(1, 64);
    ...
    /**
     * Instantiates a new Ltr dragon fight cutscene.
     */
        ...
        public boolean pulse() {
            switch (counter++) {
                ...
                case 60:
                    ...
                    TutorialStage.INSTANCE.load(player, 3, false);
