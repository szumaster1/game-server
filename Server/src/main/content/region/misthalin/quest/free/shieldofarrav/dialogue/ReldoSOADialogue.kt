...
class ReldoSOADialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any): Boolean {
        ...
        if (player.getQuestRepository().getQuest("Lost Tribe")
                .getStage(player) == 40 && player.inventory.contains(Items.BROOCH_5008, 1)
        ) {
