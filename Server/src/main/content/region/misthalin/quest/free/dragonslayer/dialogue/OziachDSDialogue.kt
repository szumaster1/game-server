    ...
    override fun open(vararg args: Any): Boolean {
        ...
        when (quest!!.getStage(player)) {
            100 -> {
                ...
                stage =
                    if (player.inventory.containsItem(Item(11286))) { // player.getEquipment().containsItem(new
                        // Item(1540))//TODO:
                        // Anti-drag
                        // shield
                        // dialogue.
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            ...
            100 -> when (stage) {
                ...
                50 -> stage = if (player.inventory.contains(11286, 1)) {
