...
class WormbrainDSDialogue(player: Player? = null) : Dialogue(player) {
        ...
        when (quest!!.getStage(player)) {
            20 -> {
                when (stage) {
                    ...
                    502 -> {
                        npc(FacialExpression.OLD_DEFAULT, "Me not stoopid, it worth at least 10,000 coins!")
                        stage = 503
                    }
                    ...
                    507 -> {
                        npc(FacialExpression.OLD_DEFAULT, "Fank you very much! Now me can bribe da guards,", "hehehe.")
                        stage = 508
                    }
    ...
    fun defaultDialogue(buttonId: Int) {
        when (stage) {
            ...
            10 -> {
                npc(FacialExpression.OLD_DEFAULT, "Me not sure. Me pick some stuff up and take it away.")
                stage = 11
            }
            ...
            12 -> {
                npc(FacialExpression.OLD_DEFAULT, "Umm...no.")
                stage = 13
            }
            ...
            14 -> {
                npc(FacialExpression.OLD_DEFAULT, "Oh, right.")
                stage = 15
            }
