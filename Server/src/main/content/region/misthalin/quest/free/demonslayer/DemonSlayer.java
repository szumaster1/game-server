package content.region.misthalin.quest.free.demonslayer;

import content.region.misthalin.quest.free.demonslayer.cutscene.DemonSlayerCutscene;
import content.region.misthalin.quest.free.demonslayer.cutscene.WallyCutscenePlugin;
import content.region.misthalin.quest.free.demonslayer.dialogue.GypsyArisDialogue;
import content.region.misthalin.quest.free.demonslayer.dialogue.SirPyrsinDialogue;
...
public class DemonSlayer extends Quest {
    ...
    public void finish(Player player) {
        ...
        removeAttribute(player, "demon-slayer:incantation");
        removeAttribute(player, "demon-slayer:poured");
        removeAttribute(player, "demon-slayer:received");
