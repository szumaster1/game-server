package content.region.misthalin.quest.free.sheepshearer.dialogue
...
class FredTheFarmerSHDialogue(val questStage: Int) : DialogueFile() {
    companion object {
        ...
        when (stage) {
            START_DIALOGUE -> if (questStage == 10) {
                if (getAttribute(player!!, SheepShearer.ATTR_IS_PENGUIN_SHEEP_SHEARED, false)) {
                    npc(FacialExpression.ANGRY, "What are you doing on my land?").also {
                        stage = STAGE_PENGUIN_SHEEP_SHEARED
                    }
                } else {
                    npc(FacialExpression.NEUTRAL, "How are you doing getting those balls of wool?").also {
                ...
                npc(
                    ...
                    "a bit of help."
                ).also { stage = STAGE_BEGIN_QUEST }
            }

            STAGE_BEGIN_QUEST -> npc(
                FacialExpression.NEUTRAL,
            ...
            1003 -> when (buttonID) {
                ...
                2 -> player(FacialExpression.HALF_GUILTY, "That doesn't sound a very exciting quest.").also {
                    stage = 1100
                }
            ...
            1100 -> npc(
                ...
                "Well what do you expect if you ask a farmer for a",
                "quest?"
            ...
            1204 -> when (buttonID) {
                1 -> player(FacialExpression.HAPPY, "Yes okay. I can do that.").also { stage = 2000 }
                2 -> player(FacialExpression.HALF_GUILTY, "Erm I'm a bit worried about this Thing.").also {
                    stage = 1300
                }
            }
            ...
            2102 -> when (buttonID) {
                1 -> player(FacialExpression.HAPPY, "I'm something of an expert actually!").also {
                    stage = STAGE_CAN_SPIN_WOOL
                }

                2 -> player(FacialExpression.NEUTRAL, "I don't know how to spin wool, sorry.").also {
            ...
            2304 -> when (buttonID) {
                1 -> player(FacialExpression.NEUTRAL, "I don't know how to spin wool, sorry.").also {
                    stage = STAGE_CANT_SPIN_WOOL
                }

                2 -> player(FacialExpression.HAPPY, "I'm something of an expert actually!").also {
                    stage = STAGE_CAN_SPIN_WOOL
                }
            }
            ...
            2401 -> npc(
                FacialExpression.NEUTRAL,
                "To get to Lumbridge travel east on the road outside."
            ).also { stage++ }
            ...
            3100 -> npc(FacialExpression.NEUTRAL, "How are you doing getting those balls of wool?").also {
                stage = STAGE_DELIVER_BALLS_OF_WOOL
            }
            ...
            3206 -> player(
                FacialExpression.NEUTRAL,
                "It's not a shapeshifter or any other kind of monster!"
            ).also { stage++ }
            ...
            // TODO: There might be more dialogue here
            31200 -> npc(FacialExpression.HALF_GUILTY, "Ah well at least you haven't been eaten.").also {
                stage = END_DIALOGUE
            }
        }
    }
