...
class LostCity : Quest("Lost City", 83, 82, 3, Vars.VARP_QUEST_LOST_CITY_PROGRESS, 0, 1, 6) {
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        when (stage) {
            ...
            10 -> line(
                player,
                "<str>According to one of the adventurers in Lumbridge Swamp<br><br><str>the entrance to Zanaris is somewhere around there.<br><br><blue>Apparently there is a <red>leprechaun<blue> hiding in a <red>tree<blue> nearby<br><br><blue>who can tell me how to enter the <red>Lost City of Zanaris",
                4 + 7
            )

            20 -> line(
                player,
                "<str>According to one of the adventurers in Lumbridge Swamp<br><br><str>the entrance to Zanaris is somewhere around there.<br><br><str>I found the Leprechaun hiding in a nearby tree.<br><br><blue>He told me that the entrance to <red>Zanaris<blue> is in the <red>shed<blue> in<br><br><red>Lumbridge swamp<blue> but only if I am carrying a <red>Dramen Staff<br><br><blue>I can find a <red>Dramen Tree <blue>in a cave on <red>Entrana <blue>somewhere",
                4 + 7
            )
