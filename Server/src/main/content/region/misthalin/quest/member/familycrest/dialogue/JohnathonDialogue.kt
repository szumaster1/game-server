...
class JohnathonDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (qstage < 16) {
            npc("I don't feel so well... maybe we can talk later").also { stage = 1000 }
        } else {
            when (qstage) {
                16 -> player("Greetings. Would you happen to be Johnathon Fitzharmon?").also { stage = 1 }
                17 -> npc("What... what did that spider... DO to me? ", "I... I feel so weak... ", "I can hardly... think at all...").also { stage = 1000 }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            201 -> when (buttonId) {
                1 -> npc("Well... you will have to be a skilled Mage to defeat him, ", "and my powers are not good enough yet. ", "You will need to hit him once with each of the four ", "elemental spells of death before he will be defeated.").also { stage = 1000 }
                2 -> npc("The fiend has made his lair in Edgeville Dungeon. ", "When you come in down the ladder in Edgeville, follow", "the corridor north until you reach a room with skeletons. ", "That passageway to the left will lead you to him.").also { stage = 1000 }
                3 -> npc("Those accursed poison spiders that surround ", "the entrance to Chronozon's lair... ", "I must have taken a nip from one of them ", "as I attempted to make my escape.").also { stage = 1000 }
            ...
            6000 -> when (buttonId) {
                1 -> {
                    ...
                    npc("Yes certainly, though it will cost you 25,000 coins" + if (freeThisTime) " next time." else ".").also {
                        stage = 6001
                    }
                }
