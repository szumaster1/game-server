        ...
        b.onPredicate { _ -> it == Items.ANCIENT_TALISMAN_681 }
            ...
            .endWith { _, player ->
                ...
                if (getQuestStage(player, "The Dig Site") == 6) {
                    setQuestStage(player, "The Dig Site", 7)
                }
            }
            ...
            .endWith { _, player ->
                if (removeItem(player, Items.STONE_TABLET_699)) {
                    if (getQuestStage(player, "The Dig Site") == 11) {
                        finishQuest(player, "The Dig Site")
                    }
                }
            }
