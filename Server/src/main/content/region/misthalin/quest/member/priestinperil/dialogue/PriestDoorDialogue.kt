package content.region.misthalin.quest.member.priestinperil.dialogue
...
class PriestDoorDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> {
                player(FacialExpression.HALF_GUILTY, "Ummmm.....")
                stage = 1
            }

            1 -> {
                player(FacialExpression.HALF_GUILTY, "Roald sent me to check on Drezel.")
                stage = 2
            }
            ...
            3 -> {
                player(FacialExpression.HALF_GUILTY, "Well, as I say, the King sent me to make sure", "everything's okay with you.")
                stage = 4
            }
            ...
            5 -> {
                player(FacialExpression.HALF_GUILTY, "I'm not sure. Ask you what help you need I suppose.")
                stage = 6
            }

            6 -> {
                interpreter.sendDialogue("${RED}Ah, good, well, I don't think... ${BLUE}(Psst... hey... the dog!)${RED} OH! Yes, of", "course! Will you do me a favour adventurer?")
                stage = 7
            }

            7 -> {
                player(FacialExpression.HALF_GUILTY, "Sure. I'm a helpful person!")
                stage = 8
            }
            ...
            9 -> {
                player(FacialExpression.HALF_GUILTY, "Okey-dokey, one dead dog coming up.")
                stage = 10
            }
            ...
            11 -> {
                player(FacialExpression.HALF_GUILTY, "I killed that dog for you.")
                stage = 12
            }
            ...
            13 -> {
                player(FacialExpression.HALF_ASKING, "What's so funny?")
                stage = 14
            }
