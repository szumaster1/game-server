        ...
        when (getQuestStage(player!!, "Rag and Bone Man")) {
            0 -> {
                when (stage) {
                    ...
                    16 -> showTopics(Topic("Anything I can do to help?", 20, true), Topic("Well, good luck with that.", 70), Topic("Where is that mumbling coming from?", 80))
                    ...
                    27 -> showTopics(Topic(FacialExpression.FRIENDLY, "Yes", 28, true), Topic(FacialExpression.FRIENDLY, "No", 60), Topic("Where is that mumbling coming from?", 80))
                    ...
                    63 -> playerl(FacialExpression.FRIENDLY, "Wow, trying a guilt trip much?").also { stage = END_DIALOGUE }
                    ...
                    72 -> npcl(FacialExpression.FRIENDLY, "Well, back to work!").also { stage = END_DIALOGUE }
                    ...
                    83 -> npcl(FacialExpression.FRIENDLY, "Anyway, I have enough problems of my own without dealing with a delusional adventurer.").also { stage = 16 }
                }
            }
            ...
            in 1..3 -> {
                when (stage) {
                    ...
                    1 -> npcl(FacialExpression.FRIENDLY, "Great! Let me take a look at them.").also { stage++ }
                    ...
                    3 -> npcl(FacialExpression.FRIENDLY, "Come and see me when you have the rest.").also { stage = END_DIALOGUE }
                    ...
                    30, 40, 50, 60, 70, 80, 90, 100, 110 -> {
                        if (!getAttribute(player!!, RagAndBoneMan.attributeGoblinBone, false) && stage <= 30) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 31
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeBearBone, false) && stage <= 40) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 41
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeBigFrogBone, false) && stage <= 50) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 51
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeRamBone, false) && stage <= 60) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 61
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeUnicornBone, false) && stage <= 70) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 71
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeMonkeyBone, false) && stage <= 80) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 81
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeGiantRatBone, false) && stage <= 90) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 91
                        } else if (!getAttribute(player!!, RagAndBoneMan.attributeGiantBatBone, false) && stage <= 100) {
                            npcl(NPCs.BONES_3674, "Sack", FacialExpression.OLD_HAPPY, "Mumblemumble"); stage = 101
                        } else {
                    ...
                    115 -> playerl(FacialExpression.FRIENDLY, "Ok, I'll remember.").also { stage = END_DIALOGUE }
                }
            }
        }
        /*
