...
/**
 * Represents the Rag and bone man.
 */
@Initializable
class RagAndBoneMan : Quest("Rag and Bone Man", 100, 99, 2, 714, 0, 1, 4) {
    ...
    override fun finish(player: Player) {
        ...
        removeAttributes(player, attributeGoblinBone, attributeBearBone, attributeBigFrogBone, attributeRamBone, attributeUnicornBone, attributeMonkeyBone, attributeGiantRatBone, attributeGiantBatBone)
    }
