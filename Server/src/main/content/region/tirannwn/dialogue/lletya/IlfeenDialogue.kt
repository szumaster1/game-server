...
/**
 * Represents the Ilfeen dialogue.
 */
@Initializable
class IlfeenDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc(FacialExpression.FRIENDLY, "Bye.").also { stage = END_DIALOGUE }
            ...
            43 -> player(FacialExpression.FRIENDLY, "Goodbye, Ilfeen.").also { stage = END_DIALOGUE }
        }
        return true
    }
