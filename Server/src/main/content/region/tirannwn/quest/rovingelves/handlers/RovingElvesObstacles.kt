    ...
    override fun handle(player: Player, node: Node, option: String): Boolean {
        ...
        when (node.id) {
            ...
            3921 -> if (isNorthOrSouth) {
                if (NORTH_SOUTH == Direction.NORTH) AgilityHandler.forceWalk(
                    player,
                    -1,
                ...
                if (EAST_WEST == Direction.EAST) AgilityHandler.forceWalk(
                    player,
                    -1,
            ...
            3924 -> if (!illegalJumpsY.contains(player.location.y)) {
                if (isNorthOrSouth) {
            ...
            3925 -> if (!illegalJumpsY.contains(node.location.y)) {
                if (!isNorthOrSouth) {
                    AgilityHandler.forceWalk(
                        player,
                        -1,
