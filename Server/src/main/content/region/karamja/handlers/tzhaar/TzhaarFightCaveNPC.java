    ...
    static class CombatAction extends CombatSwingHandler {
        ...
        public void visualize(Entity entity, Entity victim, BattleState state) {
            ...
            switch (state.getStyle()) {
                ...
                case RANGE:
                    if (jad) {
                        entity.visualize(new Animation(9276, Priority.HIGH), Graphic.create(1625));
                    } else {
                ...
                case MAGIC:
                    if (jad) {
                        ...
                        entity.visualize(new Animation(9300, Priority.HIGH), Graphic.create(1626));
                    } else {
                        Projectile.magic(entity, victim, 1623, 41, 36, 50, 15).send();
                        entity.visualize(new Animation(9266, Priority.HIGH), Graphic.create(1622));
                    }
                    break;
            }
        }
        ...
        public void impact(Entity entity, Entity victim, BattleState state) {
            ...
            if (state != null && state.getEstimatedHit() > 0) {
                ...
                if (entity.getId() == 2734 || entity.getId() == 2735) {
                    ...
                    victim.graphics(Graphic.create(157));
                }
            }
        ...
        public void visualizeImpact(Entity entity, Entity victim, BattleState state) {
            if (state != null && state.getStyle() == null) {
                ...
                victim.graphics(Graphic.create(1624));
            } else if (state != null && jad && state.getStyle() == CombatStyle.RANGE) {
                victim.graphics(Graphic.create(451));
            }
