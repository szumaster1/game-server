...
public final class TzhaarCityPlugin extends OptionHandler {
    ...
    public static final class TzhaarDialogue extends Dialogue {
        ...
        public boolean open(Object... args) {
            npc = (NPC) args[0];
            npc(FacialExpression.CHILD_FRIENDLY, "Can I help you JalYt-Ket-" + player.getUsername() + "?");
            return true;
        }
        ...
        public boolean handle(int interfaceId, int buttonId) {
            switch (stage) {
                ...
                case 10:
                    break;
                case 20:
                    npc(FacialExpression.CHILD_FRIENDLY, "Are you not JalYt-Ket?");
                    stage = 21;
                    break;
                case 21:
                ...
                case 22:
                    ...
                    break;
                case 100:
                    npc(FacialExpression.CHILD_FRIENDLY, "That what you are... you tough and strong no?");
                    stage = 101;
                    break;
                case 101:
                    ...
                    break;
                case 102:
                    npc(FacialExpression.CHILD_FRIENDLY, "Then you JalYt-Ket!");
                    stage = 103;
                    break;
                case 103:
                    end();
                    break;
                case 120:
                    npc(FacialExpression.CHILD_FRIENDLY, "Well then, no problems.");
                    stage = 121;
                    break;
                case 121:
                    end();
