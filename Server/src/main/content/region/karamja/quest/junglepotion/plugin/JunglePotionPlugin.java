...
public final class JunglePotionPlugin extends OptionHandler {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        for (JunglePotion.JungleObjective s : JunglePotion.JungleObjective.values()) {
    ...
    public boolean handle(Player player, Node node, String option) {
        ...
        switch (option) {
            case "search":
                search(player, quest, (Scenery) node, JunglePotion.JungleObjective.forId(node.getId()));
                break;
        }
        return true;
    }

    private void search(final Player player, Quest quest, final Scenery object, final JunglePotion.JungleObjective objective) {
    ...
    /**
     * The Jogre cavern dialogue.
     */
    public static final class JogreCavernDialogue extends Dialogue {


        /**
         * Instantiates a new Jogre cavern dialogue.
         */
