    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            ...
            10, 20, 30, 40, 50 -> when (stage) {
                ...
                10 -> if (!player.inventory.containsItem(objective!!.herb.product)) {
                    ...
                    if (player.inventory.remove(objective!!.herb.product)) {
                        ...
                        interpreter.sendItemMessage(objective!!.herb.product, "You give the " + objective!!.getName() + " to Trufitus.")
                        stage = 50
                    }
                }
            ...
            60 -> when (stage) {
                ...
                -1 -> {
                    sendDialogueLines(player, "Trufitus shows you some techniques in Herblore. You gain some", "experience in Herblore.")
                    stage++
                }
            ...
            100 -> when (stage) {
                ...
                3 -> end()
                10 -> {
                    npc("Greetings! I hope things are going well for you now.", "I have no new information since we last spoke.")
                    stage++
                }

                11 -> {
                    npc("Needless to say, that if something does come up I", "will certainly get in touch directly.")
                    stage = 3
                }
            }
        }
