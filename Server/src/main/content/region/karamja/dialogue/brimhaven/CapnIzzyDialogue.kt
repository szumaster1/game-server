    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (it) {
            0 -> when (stage) {
                ...
                2 -> npcl(NPCs.PARROT_4535, FacialExpression.OLD_CALM_TALK2, "Avast ye scurvy swabs!").also { stage++ }
                ...
                5 -> {
                    if (Skillcape.isMaster(player!!, Skills.AGILITY)) {
                        options("What is this place?", "What do I do in the arena?", "I'd like to use the Agility Arena, please.", "Is it true you sell the Skillcape of Agility?", "See you later.").also { stage++ }
                    } else {
                        options("What is this place?", "What do I do in the arena?", "I'd like to use the Agility Arena, please.", "Can you tell me a bit about the Skillcape of Agility, please?", "See you later.").also { stage = 7 }
                    }
                }
                6 -> when (buttonID) {
                ...
                14 -> npcl(FacialExpression.NEUTRAL, "I'd found a huge cave with all these platforms. I reckon it be an ancient civilisation that made it. I had " + "to be mighty careful as there was these traps everywhere! Dangerous it was!").also { stage++ }
                15 -> npcl(FacialExpression.NEUTRAL, "Entrance is only 200 coins!").also { stage = 5 }
                20 -> npcl(FacialExpression.NEUTRAL, "Well, me hearty, it's simple. Ye can cross between two platforms by using the traps or obstacles " + "strung across 'em. Try and make your way to the pillar that is indicated by the flashing arrow.").also { stage++ }
                21 -> npcl(FacialExpression.NEUTRAL, "Ye receive tickets for tagging more than one pillar in a row. So ye won't get a ticket from the " + "first pillar but ye will for every platform ye tag in a row after that.").also { stage++ }
                22 -> npcl(FacialExpression.NEUTRAL, "If ye miss a platform ye will miss out on the next ticket so try and get every platform you can! " + "When ye be done, take the tickets to Jackie over there and she'll exchange them for more stuff!").also { stage++ }
                ...
                31 -> npcl(NPCs.PARROT_4535, FacialExpression.OLD_CALM_TALK2, "Pieces of eight!").also { stage++ }
                ...
                44 -> {
                    when {
                        ...
                        (freeSlots(player!!)) < 2 -> {
                            npcl(FacialExpression.NEUTRAL, "Unfortunately all Skillcapes are only available with a free hood, it's part of a skill promotion deal; " + "buy one get one free, you know. So you'll need to free up some inventory space before I can sell you one.").also { stage = END_DIALOGUE }
                        }
                        else -> {
                ...
                50 -> sendNormalDialogue(NPC(NPCs.CAPN_IZZY_NO_BEARD_437), FacialExpression.NEUTRAL, "Aye, to be sure! The Skillcape of Agility be the symbol", "of the master of dexterity! One who wears it can climb", "like a cat, run like the wind and jump like...err, well", "jump like a jumping thing!").also { stage++ }
                51 -> npcl(FacialExpression.NEUTRAL, "Now, be there anything else ye'd like to know?").also { stage = 5 }
            }
            1 -> when (stage) {
                0 -> npcl(NPCs.PARROT_4535, FacialExpression.OLD_CALM_TALK2, "Clap him in irons!").also { stage++ }
