package content.region.asgarnia.quest.diplomacy;
...
public class GoblinDiplomacy extends Quest {
    ...
    public void drawJournal(Player player, int stage) {
        ...
        switch (stage) {
            ...
            case 100:
                ...
                line(player, "<col=FF0000>QUEST COMPLETE!</col>", 19 + 7);
                break;
        }
    }
    ...
    public int[] getConfig(Player player, int stage) {
        if (stage == 0) {
            return new int[]{Vars.VARP_QUEST_GOBLIN_DIPLOMACY_QUEST_PROGRESS, 0};
        }
        if (stage == 10) {
            return new int[]{Vars.VARP_QUEST_GOBLIN_DIPLOMACY_QUEST_PROGRESS, 1};
        } else if (stage == 20) {
            return new int[]{Vars.VARP_QUEST_GOBLIN_DIPLOMACY_QUEST_PROGRESS, 4};
        } else if (stage == 30) {
            return new int[]{Vars.VARP_QUEST_GOBLIN_DIPLOMACY_QUEST_PROGRESS, 5};
        } else if (stage == 100) {
            return new int[]{Vars.VARP_QUEST_GOBLIN_DIPLOMACY_QUEST_PROGRESS, 6};
        }
        return new int[]{Vars.VARP_QUEST_GOBLIN_DIPLOMACY_QUEST_PROGRESS, 0};
    }
