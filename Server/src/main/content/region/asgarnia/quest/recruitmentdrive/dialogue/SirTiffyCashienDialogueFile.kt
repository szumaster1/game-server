    ...
    override fun create(b: DialogueBuilder) {
        ...
        b.onQuestStages("Recruitment Drive", 1)
            ...
            .let { path ->
                ...
                return@let originalPath.builder()
                    .options()
                    .let { optionBuilder ->
                        ...
                        .let { branch ->
                            branch.onValue(0)
                                .npcl(FacialExpression.FRIENDLY, "To start the test you can't have anything in the inventory and equipment.")
                                .end()
                            return@let branch
                        }
                        .onValue(1)
        ...
        b.onQuestStages("Recruitment Drive", 3)
            ...
            .endWith { _, player ->
                finishQuest(player, "Recruitment Drive")
            }
    }
}
