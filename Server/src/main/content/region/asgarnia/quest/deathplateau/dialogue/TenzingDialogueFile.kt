...
/**
 * Represents the Tenzing dialogue file.
 */
        ...
        when (getQuestStage(player!!, "Death Plateau")) {
            20 -> {
                when (stage) {
                    ...
                    12 -> showTopics(Topic(FacialExpression.FRIENDLY, "OK, I'll get those for you.", 20), Topic(FacialExpression.FRIENDLY, "I'll find the secret way for myself.", 30))
                    ...
                    21 -> sendItemDialogue(player!!, Items.CLIMBING_BOOTS_3105, "Tenzing has given you his climbing boots.").also {
                        ...
                        setQuestStage(player!!, "Death Plateau", 21)
                        stage = END_DIALOGUE
                    }
            ...
            in 21..23 -> {
                when (stage) {
                    ...
                    3 -> npcl(FacialExpression.FRIENDLY, "Well, when he has, bring the boots to me with ten loaves of bread and ten cooked trout. I have to prepare for the winter, after all.").also { stage = END_DIALOGUE }
            ...
            24 -> {
                when (stage) {
                    ...
                    2 -> playerl(FacialExpression.FRIENDLY, "I don't have the:" +
                            ...
                            (if (!inInventory(player!!, Items.TROUT_333, 10)) " Ten cooked trout." else "")).also {
                        stage = END_DIALOGUE
                    }
                    3 -> {
                    ...
                    4 -> {
                        if (!inInventory(player!!, Items.BREAD_2309, 10) && !inInventory(player!!, Items.TROUT_333, 10)) {
                            end()
                        } else {
                            removeItem(player!!, Item(Items.BREAD_2309, 10))
                            removeItem(player!!, Item(Items.TROUT_333, 10))
                            sendDoubleItemDialogue(player!!, Items.TROUT_333, Items.BREAD_2309, "You give Tenzing the loaves of bread and the cooked trout.")
                    ...
                    8 -> sendItemDialogue(player!!, Items.SECRET_WAY_MAP_3104, "Tenzing has given you a map of the secret way!").also {
                    ...
                    11 -> npcl(FacialExpression.FRIENDLY, "You are wise for one so young.").also {
                        setQuestStage(player!!, "Death Plateau", 25)
                        stage = END_DIALOGUE
                    }
                }
            }
