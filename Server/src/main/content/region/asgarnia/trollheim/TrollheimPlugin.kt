package content.region.asgarnia.trollheim
                ...
                when (id) {
                    ...
                    3790 -> {
                        if (player.location.x > 2877) {
                            ForceMovement.run(player, player.location.transform(xOffset, yOffset, 0), `object`.location.transform(xOffset, yOffset, 0), Animation.create(CLIMB_DOWN), Animation.create(CLIMB_DOWN), Direction.EAST, 13).endAnimation = Animation.RESET
                        } else {
                            ForceMovement.run(player, player.location.transform(xOffset, yOffset, 0), `object`.location.transform(xOffset, yOffset, 0), Animation.create(CLIMB_UP), Animation.create(CLIMB_UP), Direction.WEST, 13).endAnimation = Animation.RESET
                        }
                        if (player.location.x < 2877 || player.location.equals(2878, 3622, 0)) {
                            ForceMovement.run(player, player.location.transform(xOffset, yOffset, 0), `object`.location.transform(xOffset, yOffset, 0), Animation.create(CLIMB_DOWN), Animation.create(CLIMB_DOWN), Direction.WEST, 13).endAnimation = Animation.RESET
                        } else {
                            ForceMovement.run(player, player.location.transform(xOffset, yOffset, 0), `object`.location.transform(xOffset, yOffset, 0), Animation.create(CLIMB_UP), Animation.create(CLIMB_UP), Direction.EAST, 13).endAnimation = Animation.RESET
                        }
                    }
                    ...
                    9303 -> {
                        ...
                        if (player.location.x > loc.x) {
                            ForceMovement.run(player, player.location, `object`.location.transform(-2, 0, 0), Animation.create(CLIMB_DOWN), Animation.create(CLIMB_DOWN), Direction.EAST, 13).endAnimation = Animation.RESET
                        } else {
                            ForceMovement.run(player, player.location, `object`.location.transform(2, 0, 0), Animation.create(CLIMB_UP), Animation.create(CLIMB_UP), Direction.EAST, 13).endAnimation = Animation.RESET
                        }
                    }
