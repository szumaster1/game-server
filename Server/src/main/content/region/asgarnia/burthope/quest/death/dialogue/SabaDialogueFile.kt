...
/**
 * Represents the Saba dialogue file.
 */
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (getQuestStage(player!!, "Death Plateau")) {
            ...
            20 -> when (stage) {
                ...
                3 -> npcl(FacialExpression.ANNOYED, "I dunno but he must live around here somewhere!").also { stage = END_DIALOGUE }
            }
            in 21..26 -> when (stage) {
                0 -> playerl(FacialExpression.FRIENDLY, "Hello.").also { stage++ }
                ...
                3 -> npcl(FacialExpression.FRIENDLY, "Grr!").also { stage = END_DIALOGUE }
            }
        }
    }
}
