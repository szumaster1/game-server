...
/**
 * Represents the Harold dialogue file.
 */
        ...
        when (getQuestStage(player!!, "Death Plateau")) {
            ...
            11 -> { // Asking again.
                when (stage) {
                    ...
                    2 -> playerl(FacialExpression.FRIENDLY, "You're the guard that was on duty last night?").also { stage++ }
                    3 -> npcl(FacialExpression.FRIENDLY, "I said I didn't want to talk about it!").also { stage = END_DIALOGUE }
                }
            }
                ...
                when (stage) {
                    ...
                    4 -> {
                        if (!removeItem(player!!, Items.ASGARNIAN_ALE_1905)) {
                            ...
                            runTask(npc!!, 5) {
                                npcl(FacialExpression.FRIENDLY, "Arrh. That hit the spot!").also {
                                    stage = END_DIALOGUE
                                }
                            }
                        }
            ...
            13 -> { // After getting him an Asgarnian Ale.
                when (stage) {
                    ...
                    22 -> npc(FacialExpression.FRIENDLY, "I really fancy one of those Blurberry Specials. I never", "get over to the Gnome Stronghold so I haven't had one", "for ages!").also { stage++ }
                    23 -> {
                        if (removeItem(player!!, Item(Items.BLURBERRY_SPECIAL_2064, 1)) || removeItem(player!!, Item(Items.BLURBERRY_SPECIAL_9520, 1)) || removeItem(player!!, Item(Items.PREMADE_BLURB_SP_2028, 1))) {
                    ...
                    24 -> {
                        ...
                        setQuestStage(player!!, "Death Plateau", 14)
                        npc!!.isWalks = false
                        animate(npc!!, Animations.HUMAN_EATTING_829)
                        runTask(npc!!, 4) {
                            npc!!.sendChat("Wow!")
                    ...
                    32 -> npcl(FacialExpression.FRIENDLY, "Don't forget that once I start my roll you can't back out of the bet! If you do you lose your stake!").also { stage++ }
                    33 -> {
                        end()
                        npc!!.isWalks = false
                    ...
                    34 -> {
                        ...
                        if (getAttribute(player!!, "deathplateau:winstate", false)) {
                            ...
                            if (wager > haroldAmount) {
                                ...
                                sendItemDialogue(player!!, Items.COINS_6964, "Harold has given you your winnings!").also { stage = END_DIALOGUE }
                            }
                        } else {
                            // Lose
                            end()
                            setAttribute(player!!, ATTRIBUTE_HAROLD_MONEY, haroldAmount + wager)
                            sendItemDialogue(player!!, Items.COINS_6964, "You give Harold his winnings.").also { stage = END_DIALOGUE }
                        }
                    }

                    35 -> npcl(FacialExpression.FRIENDLY, "Here's what I have.").also { stage++ }
                    36 -> sendItemDialogue(player!!, Items.COINS_6964, "Harold has given you some of your winnings!").also {
                    ...
                    38 -> {
                        ...
                        setQuestStage(player!!, "Death Plateau", 15)
            ...
            15 -> { // If you lose your IOU
                when (stage) {
                    ...
                    10 -> npcl(FacialExpression.FRIENDLY, "I honestly don't know! I've looked everywhere. I've searched the castle and my room!").also { stage++ }
                    11 -> playerl(FacialExpression.ASKING, "Have you tried looking between here and the castle?").also { stage++ }
                    12 -> npcl(FacialExpression.HALF_GUILTY, "Yeah, I tried that.").also { stage++ }
                    13 -> npcl(FacialExpression.HALF_GUILTY, "I need another beer.").also { stage = END_DIALOGUE }
