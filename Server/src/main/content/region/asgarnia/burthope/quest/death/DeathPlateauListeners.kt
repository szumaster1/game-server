...
import content.region.asgarnia.quest.death.scroll.CombinationScrollDialogue
import core.api.*
...
class DeathPlateauListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        onUseWith(IntType.SCENERY,
            content.region.asgarnia.burthope.quest.death.DeathPlateauListeners.Companion.stoneBalls, *content.region.asgarnia.burthope.quest.death.DeathPlateauListeners.Companion.stoneMechanisms
        ) { player, used, with ->
