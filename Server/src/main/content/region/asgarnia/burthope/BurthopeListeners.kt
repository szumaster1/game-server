...
class BurthopeListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.THIEVING_GUILD_PASSAGE, IntType.SCENERY, "enter") { player, node ->
            if (node.id == 7257) {
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.STAIRS_1, IntType.SCENERY, "climb-down") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.STAIRS_2, IntType.SCENERY, "climb-up") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.BENEDICT, IntType.NPC, "bank") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.BENEDICT, IntType.NPC, "collect") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.MARTIN, IntType.NPC, "trade"){ player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.SERGEANTS, IntType.NPC, "talk-to") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.SOLDIERS_1, IntType.NPC, "talk-to") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.SOLDIERS_2, IntType.NPC, "talk-to") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.ARCHERS, IntType.NPC, "talk-to") { player, _ ->
        ...
        on(content.region.asgarnia.burthope.BurthopeListeners.Companion.GUARDS, IntType.NPC, "talk-to") { player, _ ->
