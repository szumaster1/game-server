...
class LucyPartyRoomDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> npc(FacialExpression.HALF_GUILTY, "Would you like to buy a beer?").also { stage++ }
            2 -> player(FacialExpression.HALF_GUILTY, "How much do they cost?").also { stage++ }
            3 -> npc(FacialExpression.HALF_GUILTY, "Just 2 gold pieces.").also { stage++ }
            ...
            5 -> when (interfaceId) {
                228 -> when (buttonId) {
                    ...
                    2 -> player(FacialExpression.HALF_GUILTY, "No thanks, I can't afford that.").also { stage = 69 }
                }
            }
            10 -> npc(FacialExpression.HALF_GUILTY, "Coming right up sir!").also { stage++ }
            11 -> {
            ...
            69 -> npc(FacialExpression.HALF_GUILTY, "I see. Well, come and see me if you change your mind. YOu", "know where I am!").also { stage = END_DIALOGUE }
        }
        return true
    }
