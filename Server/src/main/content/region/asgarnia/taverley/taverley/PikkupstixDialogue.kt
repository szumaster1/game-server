    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            0 -> when (stage) {
                ...
                6 -> {
                    interpreter.sendDialogues(ids[0], FacialExpression.FURIOUS, "Confound you, lapine menace!")
                    stage = 7
                }
                ...
                19 -> {
                    interpreter.sendDialogues(ids[0], FacialExpression.FURIOUS, "Gah! That better not be my wardrobe!")
                    stage = 20
                }
                ...
                32 -> {
                    interpreter.sendDialogues(ids[0], FacialExpression.FURIOUS, "Very well, young fool. You go see how well you do", "against it.")
                    stage = 33
                }
            ...
            60 -> when (stage) {
                ...
                9 -> {
                    npc("You really need to renew your Summoning skill points", "at the obelisk, " + player.username + ".")
                    stage = 10
                }
            ...
            100 -> when (stage) {
                ...
                401 -> {
                    sendDialogueOptions(player, "Choose an option:", "So, what's Summoning all about, then?", "Can I buy some Summoning supplies?", "Please tell me about skillcapes.")
                    stage = 1
                }
