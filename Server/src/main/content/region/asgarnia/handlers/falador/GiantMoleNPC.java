...
public final class GiantMoleNPC extends AbstractNPC {
    ...
    private static final Graphic DIG_GRAPHIC = new Graphic(572);

    private static final Animation DIG_UP_ANIMATION = new Animation(3315, Priority.VERY_HIGH);

    private static final Graphic DIG_UP_GRAPHIC = new Graphic(573);

    private static final Graphic DUST_GRAPHIC = new Graphic(571);
