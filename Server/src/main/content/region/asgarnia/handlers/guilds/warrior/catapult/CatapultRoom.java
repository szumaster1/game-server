package content.region.asgarnia.handlers.guilds.warrior.catapult;
...
public final class CatapultRoom extends MapZone implements Plugin<Object> {
    ...
    private enum CatapultAttack {
        /**
         * Spiky ball catapult attack.
         */
        SPIKY_BALL(679, 15617, Animation.create(4169), Animation.create(4173)),
        /**
         * Flung anvil catapult attack.
         */
        FLUNG_ANVIL(680, 15619, Animation.create(4168), Animation.create(4172)),
        /**
         * Slashing blades catapult attack.
         */
        SLASHING_BLADES(681, 15620, Animation.create(4170), Animation.create(4174)),
        /**
         * Magic missile catapult attack.
         */
        MAGIC_MISSILE(682, 15618, Animation.create(4171), Animation.create(4175));
        ...
        CatapultAttack(int graphicId, int objectId, Animation success, Animation fail) {
    ...
    private static final Pulse pulse = new Pulse(10) {
        @Override
    ...
    /**
     * Instantiates a new Catapult room.
     */
    public CatapultRoom() {
