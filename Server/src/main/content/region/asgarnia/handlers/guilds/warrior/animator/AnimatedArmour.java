package content.region.asgarnia.handlers.guilds.warrior.animator;
...
public final class AnimatedArmour extends NPC {
    ...
    private final AnimationRoom.ArmourSet set;

    private boolean running;


    /**
     * Instantiates a new Animated armour.
     *
     * @param player   the player
     * @param location the location
     * @param set      the set
     */
    AnimatedArmour(Player player, Location location, AnimationRoom.ArmourSet set) {
