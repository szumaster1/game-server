package content.region.asgarnia.handlers.guilds.warrior.cyclopes;
...
public final class CyclopesRoom extends MapZone implements Plugin<Object> {
    ...
    private static final int[] DEFENDERS = {8844, 8845, 8846, 8847, 8848, 8849, 8850, 14663};
    ...
    /**
     * Instantiates a new Cyclopes room.
     */
    public CyclopesRoom() {
    ...
    public Plugin<Object> newInstance(Object arg) throws Throwable {
        ...
        PULSE.stop();
        ClassScanner.definePlugin(new KamfreenaCyclopsRoomDialogue());
    ...
    private static class KamfreenaCyclopsRoomDialogue extends Dialogue {
        ...
        /**
         * Instantiates a new Kamfreena cyclops room dialogue.
         */
        public KamfreenaCyclopsRoomDialogue() {
            super();
        }
         ...
         */
        public KamfreenaCyclopsRoomDialogue(Player player) {
            super(player);
        }

        @Override
        public Dialogue newInstance(Player player) {
            return new KamfreenaCyclopsRoomDialogue(player);
        }
