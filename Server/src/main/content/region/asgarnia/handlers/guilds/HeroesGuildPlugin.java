...
/**
 * The Heroes guild plugin.
 */
@Initializable
public final class HeroesGuildPlugin extends OptionHandler {
    ...
    public static final class JewelleryRechargePlugin extends UseWithHandler {
        ...
        /**
         * Instantiates a new Jewellery recharge plugin.
         */
