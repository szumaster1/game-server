package content.region.asgarnia.falador.partyroom
...
class PartyRoomOptions : OptionHandler() {
    ...
    override fun newInstance(arg: Any?): Plugin<Any> {
        ...
        definePlugin(content.region.asgarnia.falador.partyroom.BalloonManager())
        return this
    }
    ...
    private fun deposit(player: Player) {
        if (!viewers.containsKey(player.name)) {
            viewers[player.name] = content.region.asgarnia.falador.partyroom.ChestViewer(player).view()
        } else {
    ...
    class DepositInterfaceHandler : ComponentPlugin() {
        ...
        override fun handle(player: Player, component: Component, opcode: Int, button: Int, slot: Int, itemId: Int): Boolean {
            var itemId = itemId
            val viewer = player.getExtension<content.region.asgarnia.falador.partyroom.ChestViewer>(content.region.asgarnia.falador.partyroom.ChestViewer::class.java)
    ...
    companion object {
        ...
        @JvmStatic
        val viewers: MutableMap<String, content.region.asgarnia.falador.partyroom.ChestViewer> = HashMap()
        val balloonManager = content.region.asgarnia.falador.partyroom.BalloonManager()
        var isDancing = false
