...
public class RevenantCombatHandler extends MultiSwingHandler {
     ...
     * The magic graphics.
     */
    private static final Graphic MAGIC_GRAPHIC = Graphic.create(1276);

    /**
     * The range graphics.
     */
    private static final Graphic RANGE_GRAPHIC = Graphic.create(1278);
     ...
     */
    public static Projectile createProjectile(Graphic graphic) {
