...
class RevenantNPC @JvmOverloads constructor(id: Int = -1, location: Location? = null, val routes: Array<Array<Location>>? = null) : AbstractNPC(id, location) {
    ...
    val type: RevenantType? = RevenantType.forId(id)
    ...
    override fun configure() {
        ...
        configureBonuses()
        super.configure()
        this.swingHandler = RevenantCombatHandler(properties.attackAnimation, properties.magicAnimation, properties.rangeAnimation)
    ...
    override fun construct(id: Int, location: Location, vararg objects: Any): AbstractNPC {
        return RevenantNPC(id, location, null)
    }
    ...
    override fun continueAttack(target: Entity, style: CombatStyle, message: Boolean): Boolean {
    ...
    companion object {
        ...
        private val PVP_DROPS = intArrayOf(13896, 13884, 13890, 13902, 13887, 13899, 13893, 13905, 13864, 13858, 13861, 13867, 13876, 13879, 13870, 13873, 13883, 13908, 13911, 13914, 13917, 13920, 13923, 13926, 13929, 13932, 13935, 13938, 13941, 13944, 13947, 13950, 13953, 13958, 13961, 13964, 13967, 13970, 13973, 13976, 13979, 13982, 13985, 13988)
    }
}
