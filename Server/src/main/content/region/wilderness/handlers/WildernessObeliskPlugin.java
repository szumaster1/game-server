...
public final class WildernessObeliskPlugin extends OptionHandler {
                ...
                if (getDelay() == 1) {
                    for (int x = center.getX() - 1; x <= center.getX() + 1; x++) {
                        for (int y = center.getY() - 1; y <= center.getY() + 1; y++) {
                            ...
                            RegionManager.getRegionChunk(l).flag(new GraphicUpdateFlag(Graphic.create(342), l));
                        }
                    }
                    return true;
                }
    ...
    public enum Obelisk {
         ...
         * The Level 13.
         */
        LEVEL_13(new Location(3156, 3620, 0)),
        /**
         * The Level 19.
         */
        LEVEL_19(new Location(3219, 3656, 0)),
        /**
         * The Level 27.
         */
        LEVEL_27(new Location(3035, 3732, 0)),
        /**
         * The Level 35.
         */
        LEVEL_35(new Location(3106, 3794, 0)),
        /**
         * The Level 44.
         */
        LEVEL_44(new Location(2980, 3866, 0)),
        /**
         * The Level 50.
         */
        LEVEL_50(new Location(3307, 3916, 0));
