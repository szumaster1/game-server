...
class KingBlackDragonNPC : AbstractNPC {
    ...
    internal class KBDCombatSwingHandler : CombatSwingHandler(CombatStyle.RANGE) {
        ...
        override fun canSwing(entity: Entity, victim: Entity): InteractionType? {
            ...
            if (victim.centerLocation.withinMaxnormDistance(entity.centerLocation, getCombatDistance(entity, victim, 9)) && super.canSwing(entity, victim) == InteractionType.STILL_INTERACT) {
