...
public final class CorporealBeastNPC extends NPCBehavior {
    ...
    /**
     * Instantiates a new Corporeal beast npc.
     */
    public CorporealBeastNPC() {
        super(NPCs.CORPOREAL_BEAST_8133);
    }
     ...
     */
    static
    class CombatHandler extends MultiSwingHandler {


        /**
         * Instantiates a new Combat handler.
         */
