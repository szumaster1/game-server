...
public final class KingBlackDragonNPC extends AbstractNPC {
    ...
    private final CombatSwingHandler combatHandler = new KBDCombatSwingHandler();


    /**
     * Instantiates a new King black dragon npc.
     */
    ...
    /**
     * The Kbd combat swing handler.
     */
    static
    class KBDCombatSwingHandler extends CombatSwingHandler {
        ...
        /**
         * Instantiates a new Kbd combat swing handler.
         */
