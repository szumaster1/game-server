...
class RogueCastleDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            4 -> npcl(FacialExpression.FRIENDLY, "Assuming it hasn't been occupied by any of the muggers, I've got a place in the not-so-nice parts of town, right behind the archery store. Come and see me there. Anyway, I've got to run now before my so-called companions realise what you and your thick head have done.").also { stage = END_DIALOGUE }
        }
    }
}
