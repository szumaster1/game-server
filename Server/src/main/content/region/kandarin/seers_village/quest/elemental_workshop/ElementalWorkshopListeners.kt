...
import content.region.kandarin.seers_village.quest.elemental_workshop.util.EWUtils.BELLOWS_STATE
import content.region.kandarin.seers_village.quest.elemental_workshop.util.EWUtils.FURNACE_STATE
import content.region.kandarin.seers_village.quest.elemental_workshop.util.EWUtils.LEFT_WATER_CONTROL_STATE
import content.region.kandarin.seers_village.quest.elemental_workshop.util.EWUtils.RIGHT_WATER_CONTROL_STATE
import content.region.kandarin.seers_village.quest.elemental_workshop.util.EWUtils.WATER_WHEEL_STATE
import content.region.kandarin.seers_village.quest.elemental_workshop.util.EWUtils.currentStage
import core.api.*
