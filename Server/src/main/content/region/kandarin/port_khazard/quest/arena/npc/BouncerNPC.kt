package content.region.kandarin.port_khazard.quest.arena.npc

import content.region.kandarin.quest.arena.dialogue.GeneralDialogueFile
import core.api.*
    ...
    override fun finalizeDeath(killer: Entity?) {
        if (killer is Player) {
            ...
            if (getQuestStage(killer, quest) >= 89) {
                setQuestStage(killer, "Fight Arena", 91)
            }
