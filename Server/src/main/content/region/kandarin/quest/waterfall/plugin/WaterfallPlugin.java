...
public final class WaterfallPlugin extends OptionHandler {
    ...
    public boolean handle(final Player player, Node node, String option) {
        ...
        switch (id) {
            ...
            case 2020:
                ...
                break;
            case 305:
                player.getDialogueInterpreter().open(305, node);
                break;
            case 1990:
            ...
            case 1991:
                if (player.getLocation().getY() >= 9576) {
                    ...
                    player.getDialogueInterpreter().sendDialogues(306, FacialExpression.OLD_DEFAULT, "Hello? Ah yes, the door is still locked.", "If you want to get in here, you'll need to find the key", "that I hid in some crates in the eastern room.");
                }
                break;
            case 1989:
    ...
    /**
     * The Waterfall use with handler.
     */
    public class WaterfallUseWithHandler extends UseWithHandler {
        ...
        /**
         * Instantiates a new Waterfall use with handler.
         */
