...
/**
 * Represents the Maiden holy grail dialogue file.
 */
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (forced) {
            when (stage) {
                ...
                1 -> {
                    npcl(FacialExpression.NEUTRAL, "Welcome to the Grail castle. You should come inside, it's cold out here.").also { stage++ }
                }
            ...
            when (stage) {
                0 -> npcl(FacialExpression.NEUTRAL, "Welcome to the Grail castle.").also { stage = END_DIALOGUE }
            }
        }
    }
