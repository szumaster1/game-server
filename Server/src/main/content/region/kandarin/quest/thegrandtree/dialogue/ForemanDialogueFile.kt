...
class ForemanDialogueFile : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            10 -> options("Yes, they're getting on great.", "Always arguing as usual!", "Sadly his wife is no longer with us!").also { stage++ }
            11 -> when (buttonID) {
            ...
            12 -> npcl("Really? That's odd, considering she died last year. Die imposter!").also {
                attackPlayer()
                stage = END_DIALOGUE
            }
            ...
            41 -> npcl("True but if the gnomes are really going to take over " + GameWorld.settings!!.name + " they'll need at least that.").also { stage++ }
