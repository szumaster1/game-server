package content.region.kandarin.quest.observatory.dialogue

import content.region.kandarin.quest.observatory.ObservatoryListeners
import content.region.kandarin.quest.observatory.ObservatoryListeners.Companion.FAIL_ATTRIBUTE
import core.api.*
...
class ProfessorDialogueFile : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when(stage) {
            0 -> when {
                getQuestStage(player!!, "Observatory Quest") in 2..3 -> player("Hi again!").also { stage = 40 }
                getQuestStage(player!!, "Observatory Quest") in 4..5 -> npcl("The traveller returns!").also { stage = 48 }
                getQuestStage(player!!, "Observatory Quest") in 7..8 -> npcl("How are you getting on finding me some molten glass?").also { stage = 61 }
                getQuestStage(player!!, "Observatory Quest") in 9..10 -> npcl("Did you bring me the mould?").also { stage = 72 }
                getQuestStage(player!!, "Observatory Quest") == 11 -> npc("Is the lens finished?").also { stage = 82 }
                getQuestStage(player!!, "Observatory Quest") == 13 -> npc("Hello, friend.").also { stage = 92 }
                getQuestStage(player!!, "Observatory Quest") == 14 -> npc("Hello, friend.").also { stage = 94 }
                else -> player("Hi, I was...").also { stage++ }
            }
            1 -> npcl(FacialExpression.FRIENDLY, "Welcome to the magnificent wonder of the Observatory, where wonder is all around you, where the stars can be clutched from the heavens!").also { stage++ }
            2 -> player("Wow, nice intro.").also { stage++ }
            3 -> npcl(FacialExpression.HAPPY, "Why, thanks! How might I help you?").also { stage++ }
            ...
            8 -> npcl(FacialExpression.HALF_ASKING, "Lost? It must have been those pesky goblins that led you astray. Head north-east to find the city of Ardougne.").also { stage++ }
            9 -> player("I'm sure I'll find the way. Thanks for all","your help.").also { stage++ }
            10 -> npcl(FacialExpression.HAPPY, "No problem at all. Come and visit again!").also { stage = 7 }
            11 -> npcl(FacialExpression.HALF_GUILTY, "Of course. We have a superb telescope up in the Observatory, on the hill.").also { stage++ }
            12 -> npcl(FacialExpression.HALF_GUILTY, "A truly marvellous invention, the likes of which you'll never behold again.").also { stage++ }
            13 -> sendNPCDialogue(player!!, NPCs.OBSERVATORY_ASSISTANT_6118, "Well, it would be if it worked.").also { stage++ }
            14 -> npcl(FacialExpression.HALF_GUILTY, "Don't interrupt!").also { stage++ }
            15 -> playerl(FacialExpression.HALF_GUILTY, "What? It doesn't work?").also { stage++ }
            16 -> npcl(FacialExpression.HALF_GUILTY, "Oh, no, no, no. Don't listen to him, he's joking. Aren't you, my FAITHFUL assistant?").also { stage++ }
            ...
            18 -> npcl(FacialExpression.HALF_GUILTY, "Arghhh! Get back to work and stop sticking your nose in!").also { stage++ }
            19 -> playerl(FacialExpression.HALF_GUILTY, "So, it's broken. How come?").also { stage++ }
            20 -> npcl(FacialExpression.HALF_GUILTY, "Oh, I suppose there's no use keeping it secret. Did you see those houses outside?").also { stage++ }
            21 -> playerl(FacialExpression.HALF_GUILTY, "Up on the hill? Yes, I've seen them.").also { stage++ }
            22 -> npcl(FacialExpression.HALF_GUILTY, "It's a horde of goblins. Since they moved here they have caused nothing but trouble. Last week, my telescope was tampered with.").also { stage++ }
            23 -> npcl(FacialExpression.HALF_GUILTY, "Now, parts need replacing before it can be used again. They've even been messing around in the dungeons under this area. Something needs to be done.").also { stage++ }
            24 -> sendNPCDialogue(player!!, NPCs.OBSERVATORY_ASSISTANT_6118, "Strikes me that this visitor could help us.").also { stage++ }
            25 -> npcl(FacialExpression.HALF_GUILTY, "Stop being so rude. ... Although, he has a point. What do you say?").also { stage++ }
            26 -> playerl(FacialExpression.HALF_GUILTY, "What, me?").also { stage++ }
            ...
            29 -> npcl(FacialExpression.HALF_GUILTY, "Oh dear. I really do need some help. If you see anyone who can help then please send them my way.").also { stage = END_DIALOGUE }
            30 -> npcl(FacialExpression.HALF_GUILTY, "Oh, thanks so much. I shall need some materials for the telescope, so it can be used again. Let's start with three planks of wood for the telescope base.").also { stage++ }
            31 -> npcl(FacialExpression.HALF_GUILTY, "My assistant will help with obtaining these, won't you?").also { stage++ }
            ...
            33 -> npcl(FacialExpression.HALF_GUILTY, "Go talk to him if you need some advice.").also { stage++ }
            34 -> playerl(FacialExpression.HALF_GUILTY, "Okay, I'll be right back.").also { stage++ }
            35 -> {
                end()
                setQuestStage(player!!, "Observatory Quest", 2)
            }
            ...
            41 -> npcl(FacialExpression.ASKING, "Do you have the planks yet?").also { stage++ }
            42 -> if(amountInInventory(player!!, Items.PLANK_960) < 3){
                player(FacialExpression.HALF_GUILTY, "Sorry, not yet. Three planks was it?").also { stage++ }
            } else {
                player(FacialExpression.NOD_YES,"Yes, I've got them. Here they are.").also {
            ...
            43 -> npc(FacialExpression.FRIENDLY,"It was indeed.").also { stage = END_DIALOGUE }
            44 -> npcl(FacialExpression.FRIENDLY,"Well done. This will make a big difference.").also { stage++ }
            45 -> npcl("Now, the bronze for the tube. Oh, assistant!").also { stage++ }
            46 -> npcl(FacialExpression.FRIENDLY,"Okay, okay, ask me if you need any help, ${player!!.username}.").also { stage++ }
            47 -> {
                end()
                setQuestStage(player!!, "Observatory Quest", 4)
            }

            /*
                Gathering Bronze bar.
             */
            ...
            50 -> npcl(FacialExpression.ANNOYED,"What did I tell you about speaking when spoken to?").also { stage++ }
            51 -> npcl(FacialExpression.HAPPY,"So, ${player!!.username}, you have the bronze bar?").also { stage++ }
            ...
            54 -> npcl(FacialExpression.HAPPY,"Great. Now all I need is the lens made.").also { stage++ }
            55 -> npcl(FacialExpression.HAPPY,"Please get me some molten glass.").also { stage++ }
            56 -> npcl(FacialExpression.NEUTRAL, "Oi! Lazy bones!").also { stage++ }
            57 -> player(FacialExpression.SCARED, "What? I'm not lazy.").also { stage++ }
            58 -> npcl(FacialExpression.NEUTRAL,"Not you! I'm talking to my assistant.").also { stage++ }
            ...
            60 -> npcl(FacialExpression.NEUTRAL, "Thank you. Wait a minute, who are you calling 'old'?").also {
                end()
                setQuestStage(player!!, "Observatory Quest", 6)
            }
            ...
            67 -> npcl(FacialExpression.SAD, "Great, just what I need. ${player!!.username}, I don't suppose you could find it?").also { stage++ }
            68 -> playerl("I'll have a look - where should I start?").also { stage++ }
            69 -> npcl(FacialExpression.HAPPY,"No idea. You could ask my USELESS assistant if you want.").also { stage++ }
            70 -> sendNPCDialogue(player!!, NPCs.OBSERVATORY_ASSISTANT_6118, "What have I done to deserve this?").also { stage++ }
            71 -> {
                end()
                setQuestStage(player!!, "Observatory Quest", 8)
            }
            ...
            74 -> npc(FacialExpression.HALF_THINKING, "Well, from the smell I'd guess cooking some vile","concoction.").also { stage++ }
            ...
            77 -> player(FacialExpression.SCARED, "Explosion?").also { stage++ }
            ...
            81 -> {
                ...
                runTask(player!!, 0) {
                    ...
                    sendItemDialogue(player!!, Items.MOLTEN_GLASS_1775, "The professor gives you back the molten glass.")
                    addItemOrDrop(player!!, Items.MOLTEN_GLASS_1775)
                    setQuestStage(player!!, "Observatory Quest", 11)
                }
            }
            ...
            91 -> {
                ...
                setQuestStage(player!!, "Observatory Quest", 12)
            }
        ...
        when(stage) {
            ...
            18 -> {
                when(getAttribute(player!!, ObservatoryListeners.CONSTELLATION_ATTRIBUTE, -1)){
                    ...
                    4 -> npcl(FacialExpression.HALF_GUILTY, "That's Scorpio, the scorpion.").also { stage = 22 }
                    6 -> npcl(FacialExpression.HALF_GUILTY, "That's Libra, the scales.").also { stage = 23 }
                    7 -> npcl(FacialExpression.HALF_GUILTY, "That's Virgo, the virtuous.").also { stage = 24 }
                    8 -> npcl(FacialExpression.HALF_GUILTY, "That's Leo, the lion.").also { stage = 25 }
                    10 -> npcl(FacialExpression.HALF_GUILTY, "That's Cancer, the crab.").also { stage = 26 }
                    11 -> npcl(FacialExpression.HALF_GUILTY, "That's Gemini, the twins.").also { stage = 27 }
                    12 -> npcl(FacialExpression.HALF_GUILTY, "That's Taurus, the bull.").also { stage = 28 }
                    14 -> npcl(FacialExpression.HALF_GUILTY, "That's Aries, the ram.").also { stage = 29 }
                    15 -> npcl(FacialExpression.HALF_GUILTY, "That's Pisces, the fish.").also { stage = 30 }
                }
            }
            19 -> npcl("It seems suitable, then, to award you with water runes!").also { stage = 100 }
            20 -> npcl("Capricorn will surely reward your insight with an increase to your Strength.").also { stage = 100 }
            ...
            26 -> npcl("An armoured creature - I think I shall reward you with an amulet of protection.").also { stage = 100 }
            27 -> npcl("With the double nature of Gemini, I can't offer you anything more suitable than a two-handed weapon.").also { stage = 100 }
            28 -> npcl("This Strength potion should be a suitable reward.").also { stage = 100 }
            29 -> npcl("A fierce fighter. I'm sure he'll look down on you and improve your Attack for such insight.").also { stage = 100 }
