package content.region.kandarin.quest.regicide
...
class RegicideListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        /*
            Used limestone on furnace to produce quicklime.
         */

        onUseWith(IntType.SCENERY, Items.LIMESTONE_3211, *FURNACES) { player, used, _ ->
            // Add damage if used without gloves when introducing a quest.
        ...
        /*
            Interaction to produce the pot of quicklime.
         */
