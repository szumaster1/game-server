...
class FireWarriorOfLesarkusDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> showTopics(Topic(FacialExpression.ANGRY, "A mighty hero!", 2), Topic(FacialExpression.FRIENDLY, "A humble pilgrim.", 4),)
            ...
            5 -> npcl(FacialExpression.ANGRY, "Temple is closed!").also { stage = END_DIALOGUE }
        }
        return false
    }
