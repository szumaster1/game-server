...
class LucienDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        ...
        b.onQuestStages("Temple of Ikov", 1, 2, 3, 4, 5, 6, 7)
            ...
            .branch { player ->
                return@branch if (inInventory(player, Items.PENDANT_OF_LUCIEN_86)) {
                    1
                } else {
                    0
                }
        ...
        b.onQuestStages("Temple of Ikov", 0)
                ...
                returnJoin.builder()
                    ...
                    .let { optionBuilder ->
                        ...
                        optionBuilder.option("That sounds like a laugh!")
                            ...
                            .endWith { _, player ->
                                if (getQuestStage(player, "Temple of Ikov") == 0) {
                                    setQuestStage(player, "Temple of Ikov", 1)
                                }
                            }
