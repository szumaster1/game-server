package content.region.kandarin.quest.templeofikov.npc
...
class GuardianOfArmadylNPC: NPCBehavior(*guardianOfArmadylIds) {
    ...
    companion object {
        private val guardianOfArmadylIds = intArrayOf(
            NPCs.GUARDIAN_OF_ARMADYL_274, NPCs.GUARDIAN_OF_ARMADYL_275
        )
    }
    ...
    override fun onDropTableRolled(self: NPC, killer: Entity, drops: ArrayList<Item>) {
        ...
        if (killer is Player && isQuestComplete(killer, "Temple of Ikov")) {
