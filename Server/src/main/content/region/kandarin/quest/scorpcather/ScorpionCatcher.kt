...
class ScorpionCatcher : Quest("Scorpion Catcher", 108, 107, 1, Vars.VARP_QUEST_SCORPION_CATCHER_PROGRESS, 0, 1, 6) {
    ...
    companion object {
        ...
        val ATTRIBUTE_TAVERLY = "scorpion_catcher:caught_taverly"
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        if (stage >= 10 && getAttribute(player, ATTRIBUTE_SECRET, false)) {
            ...
            line++
            line(player, "The first !!Kharid Scorpion?? is in a secret room near some", line++, getAttribute(player, ATTRIBUTE_TAVERLY, false) || stage == 100)
            line(player, "!!nasty spiders?? with two !!coffins?? nearby", line++, getAttribute(player, ATTRIBUTE_TAVERLY, false) || stage == 100)
            line++
        ...
        if (stage >= 10 && getAttribute(player, ATTRIBUTE_TAVERLY, false) && getAttribute(player, ATTRIBUTE_BARBARIAN, false) && getAttribute(player, ATTRIBUTE_MONK, false)) {
