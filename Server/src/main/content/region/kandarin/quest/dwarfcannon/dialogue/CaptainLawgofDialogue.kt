    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (quest!!.getStage(player)) {
            ...
            10 -> when (stage) {
                ...
                4 -> end()
                5 -> {
                    npc(FacialExpression.OLD_NORMAL, "That's okay, we've got plenty, here you go.")
                    stage++
                }
                ...
                103 -> {
                    npc(FacialExpression.OLD_NORMAL, "Report back to me once you've fixed the railings.")
                    stage++
                }
                ...
                106 -> {
                    npc(FacialExpression.OLD_NORMAL, "What? I'll have you jailed for desertion!")
                    stage++
                }
                ...
                109 -> {
                    npc(FacialExpression.OLD_NORMAL, "They should have reported in by now ...")
                    stage++
                }
            ...
            20 -> when (stage) {
                0 -> {
                    if (player.inventory.containsItem(DwarfCannon.DWARF_REMAINS)) {
                        npc(FacialExpression.OLD_NORMAL, "Have you been to the watch tower yet?")
                        stage = 4
                    }
                    npc(FacialExpression.OLD_NORMAL, "Hello, any news from the watchman?")
                    stage++
                }
                ...
                2 -> {
                    npc(FacialExpression.OLD_NORMAL, "Well, as quick as you can then.")
                    stage++
                }
            ...
            30 -> when (stage) {
                0 -> {
                    npc(FacialExpression.OLD_NORMAL, "Trooper, have you managed to find the goblins' base?")
                    stage++
                }
            ...
            40 -> when (stage) {
                ...
                2 -> {
                    npc(FacialExpression.OLD_NORMAL, "In that case could I ask one more favour of you...")
                    stage++
                }
                ...
                4 -> {
                    npc(FacialExpression.OLD_NORMAL, "us, please?")
                    stage++
                }
                ...
                6 -> {
                    npc(FacialExpression.OLD_NORMAL, "Thank you, take this toolkit, you'll need it...")
                    stage++
                }

                7 -> {
                    npc(FacialExpression.OLD_NORMAL, "Report back to me if you manage to fix it.")
                    stage++
                }
            ...
            50 -> when (stage) {
                ...
                2 -> end()
                3 -> {
                    npc(FacialExpression.OLD_NORMAL, "That was silly... never mind, here you go.")
                    stage++
                }
            ...
            60 -> when (stage) {
                -1 -> end()
                0 -> {
                    npc(FacialExpression.OLD_NORMAL, "Hello there trooper, how's things?")
                    stage++
                }
                ...
                2 -> {
                    if (!player.inventory.contains(1, 1)) {
                        npc(FacialExpression.OLD_NORMAL, "Bring me back the toolkit please.")
                        stage = -1
                    }
                    npc(FacialExpression.OLD_NORMAL, "That's fantastic, well done!")
                    stage++
                }
            ...
            80 -> when (stage) {
                0 -> {
                    npc(FacialExpression.OLD_NORMAL, "Hello trooper, any word from the Cannon Engineer?")
                    stage++
                }
                ...
                2 -> if (!player.inventory.containsItem(DwarfCannon.MOULD) || !player.inventory.containsItem(DwarfCannon.NULODION_NOTES)) {
                ...
                3 -> {
                    npc(FacialExpression.OLD_NORMAL, "If you could go back and get another, I'd appreciate it.")
                    stage++
                }
                ...
                8 -> {
                    npc(FacialExpression.OLD_NORMAL, "Hah! You'd be lucky, those things are worth a fortune.")
                    stage++
                }
            ...
            100 -> when (stage) {
                0 -> {
                    npc(FacialExpression.OLD_NORMAL, "Well hello there, how you doing?")
                    stage++
                }
