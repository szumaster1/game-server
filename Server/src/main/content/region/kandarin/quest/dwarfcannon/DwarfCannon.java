...
import content.region.kandarin.quest.dwarfcannon.dialogue.CaptainLawgofDialogue;
import content.region.kandarin.quest.dwarfcannon.dialogue.LollkDialogue;
import content.region.kandarin.quest.dwarfcannon.dialogue.NulodionDialogue;
import content.region.kandarin.quest.dwarfcannon.npc.CaptainLawgofNPC;
import content.region.kandarin.quest.dwarfcannon.plugin.DwarfCannonPlugin;
    ...
    public void drawJournal(Player player, int stage) {
        ...
        switch (stage) {
            ...
            case 80:
                ...
                break;
            case 100:
                line(player, "<str>I have spoken to Captain Lawgof, he recruited me into the<n><str>Black Guard and asked me to help the dwarves.<n><n><str>I've helped the dwarves keep out the Goblins, and found<n><str>the remains of their friend.<n><str>I fixed the cannon and got a mould for Captain Lawgof.<n><col=FF0000>QUEST COMPLETE!</col><n><blue>I can now <red>buy a multicannon <blue>from <red>Nulodion <blue>as a reward.<n>", 11);
                break;
        }
    }
