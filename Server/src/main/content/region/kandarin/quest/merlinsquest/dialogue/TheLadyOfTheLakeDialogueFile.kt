...
class TheLadyOfTheLakeDialogueFile : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            111 -> npc("You're " + player!!.username + ". And I see from the sign you", "wear that you have earned the trust of Sir Kay.").also { stage++ }
            112 -> player("It was nothing.. really...").also { stage++ }
            113 -> npc("You shall be rewarded handsomely!").also { stage++ }
            114 -> {
                interpreter!!.sendItemMessage(Items.EXCALIBUR_35, "The Lady of the Lake reaches out and touches the", "blade Excalibur which seems to vibrate with new power.").also {
            ...
            116 -> npc("I made the blade more powerful, and also gave it a", "rather healthy effect when you use the special.").also { stage++ }
            ...
            1 -> showTopics(
                ...
                IfTopic(FacialExpression.NEUTRAL, "I seek the sword Excalibur.", 50, missingSword)
            )
            ...
            // Asking for excalibur back
            50 -> npc("... But you have already proved thyself to be worthy", "of wielding it once already. I shall return it to you", "if you can prove yourself to still be worthy.").also { stage++ }
            ...
            54 -> if (player!!.inventory.contains(Items.COINS_995, 500)) {
            ...
            56 -> if (player!!.inventory.freeSlots() == 0) {
