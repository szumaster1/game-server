...
import content.region.kandarin.quest.merlinsquest.cutscene.CrateCutscene
...
//                if (player!!.questRepository.getQuest(MerlinUtils.QUEST_MERLIN_CRYSTAL).getStage(player) == 30) {
//                    player!!.questRepository.getQuest(MerlinUtils.QUEST_MERLIN_CRYSTAL).setStage(player, 40)
//                }
                player!!.unlock()
