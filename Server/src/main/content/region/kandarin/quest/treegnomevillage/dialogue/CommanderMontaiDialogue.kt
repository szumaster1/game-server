        ...
        if (questStage == 10) {
            when (stage) {
                ...
                8 -> when (buttonID) {
                    ...
                    2 -> playerl(FacialExpression.FRIENDLY, "Sorry, I no longer want to be involved.").also {
                        stage = 9
                    }
                }
            ...
            if (inInventory(player!!, Items.ORB_OF_PROTECTION_587)) {
                when (stage) {
                    ...
                    1 -> npcl(FacialExpression.OLD_NORMAL, "Incredible, for a human you really are something.").also { stage++ }
