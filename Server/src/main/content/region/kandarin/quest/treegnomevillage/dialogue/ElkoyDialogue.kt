        ...
        when {
            inInventory(player!!, Items.ORBS_OF_PROTECTION_588) && followLocation == "exit" -> {
                when (stage) {
                    ...
                    1 -> npcl(FacialExpression.OLD_NORMAL, "Take it to King Bolren, I'm sure he'll be pleased to see you.").also { stage++ }
            ...
            inInventory(player!!, Items.ORBS_OF_PROTECTION_588) || questStage == 100 -> {
                when (stage) {
                    0 -> playerl("Hello Elkoy.").also { stage++ }
                    1 -> npcl(FacialExpression.OLD_NORMAL, "You truly are a hero.").also { stage++ }
            ...
            questStage == 0 -> {
                when (stage) {
                    ...
                    3 -> npcl(FacialExpression.OLD_NORMAL, "There's not many of us left. Once you could find tree gnomes anywhere in the world, now we hide in small groups to avoid capture.").also { stage++ }
            ...
            questStage in 1..39 -> {
                when (stage) {
                    0 -> npcl(FacialExpression.OLD_NORMAL, "Oh my! The orb, they have the orb. We're doomed.").also { stage++ }
