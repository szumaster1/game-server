package content.region.kandarin.quest.treegnomevillage.dialogue

import content.region.kandarin.quest.treegnomevillage.TreeGnomeVillage
import core.api.*
        ...
        when {
            questStage < 10 -> {
                when (stage) {
                    ...
                    3 -> playerl(FacialExpression.FRIENDLY, "Maybe.").also { stage++ }
                    ...
                    6 -> when (buttonID) {
                        1 -> playerl(FacialExpression.FRIENDLY, "I'll leave you to it then.").also { stage = 7 }
                        2 -> playerl(FacialExpression.FRIENDLY, "Can I help at all?").also { stage = 8 }
                    }
                    ...
                    9 -> npcl(FacialExpression.OLD_NORMAL, "The truth is my people are in grave danger. We have always been protected by the Spirit Tree. No creature of dark can harm us while its three orbs are in place.").also { stage++ }
                    10 -> npcl(FacialExpression.OLD_NORMAL, "We are not a violent race, but we fight when we must. Many gnomes have fallen battling the dark forces of Khazard to the North.").also { stage++ }
                    11 -> npcl(FacialExpression.OLD_NORMAL, "We became desperate, so we took one orb of protection to the battlefield. It was a foolish move.").also { stage++ }
                    12 -> npcl(FacialExpression.OLD_NORMAL, "Khazard troops seized the orb. Now we are completely defenceless.").also { stage++ }
                    13 -> playerl(FacialExpression.FRIENDLY, "How can I help?").also { stage++ }
                    ...
                    16 -> when (buttonID) {
                        1 -> playerl(FacialExpression.FRIENDLY, "I would be glad to help.").also { stage = 18 }
                        2 -> playerl(FacialExpression.FRIENDLY, "I'm sorry but I won't be involved.").also {
                            stage = 17
                        }
                    }
                    ...
                    20 -> npcl(FacialExpression.OLD_NORMAL, "My assistant shall guide you out. Good luck friend, try your best to return the orb.").also { stage++ }
                    21 -> {
                        ...
                        setQuestStage(player!!, "Tree Gnome Village", 10)
                        stage = END_DIALOGUE
                    }
                }
            }
            ...
            questStage < 31 -> {
                when (stage) {
                    ...
                    2 -> playerl(FacialExpression.FRIENDLY, "Ok, I'll try my best.").also { stage = END_DIALOGUE }
                }
            }
            ...
            questStage == 31 -> {
                if (inInventory(player!!, Items.ORB_OF_PROTECTION_587)) {
                    when (stage) {
                        0 -> playerl(FacialExpression.FRIENDLY, "I have the orb.").also { stage++ }
                        1 -> npcl(FacialExpression.OLD_NORMAL, "Oh my... The misery, the horror!").also { stage++ }
                        2 -> playerl(FacialExpression.FRIENDLY, "King Bolren, are you OK?").also { stage++ }
                        3 -> npcl(FacialExpression.OLD_NORMAL, "Thank you traveller, but it's too late. We're all doomed.").also { stage++ }
                        4 -> playerl(FacialExpression.FRIENDLY, "What happened?").also { stage++ }
                        5 -> npcl(FacialExpression.OLD_NORMAL, "They came in the night. I don't know how many, but enough.").also { stage++ }
                        6 -> playerl(FacialExpression.FRIENDLY, "Who?").also { stage++ }
                        7 -> npcl(FacialExpression.OLD_NORMAL, "Khazard troops. They slaughtered anyone who got in their way. Women, children, my wife.").also { stage++ }
                        8 -> playerl(FacialExpression.FRIENDLY, "I'm sorry.").also { stage++ }
                        9 -> npcl(FacialExpression.OLD_NORMAL, "They took the other orbs, now we are defenceless.").also { stage++ }
                        10 -> playerl(FacialExpression.FRIENDLY, "Where did they take them?").also { stage++ }
                        ...
                        13 -> when (buttonID) {
                            1 -> playerl(FacialExpression.FRIENDLY, "I will find the warlord and bring back the orbs.").also { stage = 15 }
                            2 -> playerl(FacialExpression.FRIENDLY, "I'm sorry but I can't help.").also { stage = 14 }
                        }
                        ...
                        16 -> npcl(FacialExpression.OLD_NORMAL, "I will safeguard this orb and pray for your safe return. My assistant will guide you out.").also { stage++ }
                        17 -> {
                            if (removeItem(player!!, Items.ORB_OF_PROTECTION_587)) {
                                teleport(player!!, TreeGnomeVillage.mazeEntrance)
                                setQuestStage(player!!, "Tree Gnome Village", 40)
                    ...
                    when (stage) {
                        0 -> playerl(FacialExpression.FRIENDLY, "Hello Bolren.").also { stage++ }
            ...
            questStage == 40 -> {
                if (inInventory(player!!, Items.ORBS_OF_PROTECTION_588)) {
                    when (stage) {
                        0 -> playerl(FacialExpression.FRIENDLY, "Bolren, I have returned.").also { stage++ }
                        1 -> npcl(FacialExpression.OLD_NORMAL, "You made it back! Do you have the orbs?").also { stage++ }
                        2 -> playerl(FacialExpression.FRIENDLY, "I have them here.").also { stage++ }
                        3 -> npcl(FacialExpression.OLD_NORMAL, "Hooray, you're amazing. I didn't think it was possible but you've saved us.").also { stage++ }
                        ...
                        5 -> playerl(FacialExpression.FRIENDLY, "What does the ceremony involve?").also { stage++ }
                        ...
                        8 -> {
                            ...
                            if (removeItem(player!!, Items.ORBS_OF_PROTECTION_588)) {
                                setQuestStage(player!!, "Tree Gnome Village", 99)
                            }
                            stage = 0
                        }
                    }
            ...
            questStage == 99 -> {
                when (stage) {
                    ...
                    1 -> playerl(FacialExpression.FRIENDLY, "I'm pleased I could help.").also { stage++ }
                    ...
                    4 -> playerl(FacialExpression.FRIENDLY, "Thank you King Bolren.").also { stage++ }
                    5 -> npcl(FacialExpression.OLD_NORMAL, "The tree has many other powers, some of which I cannot reveal. As a friend of the gnome people, I can now allow you to use the tree's magic to teleport to other trees grown from related seeds.").also {
                        finishQuest(player!!, "Tree Gnome Village")
                        stage = END_DIALOGUE
                    }
                }
            }
