package content.region.kandarin.quest.clocktower
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        when (stage) {
            ...
            in 1..10 -> {
                ...
                line(player, if (getAttribute(player!!, BLUE_COG_ATTR, false)) "I placed the !!Blue Cog?? on it's !!spindle??." else "I haven't placed the !!Blue Cog?? on it's !!spindle?? yet.", line++, getAttribute(player, BLUE_COG_ATTR, false))
                line(player, if (getAttribute(player, BLACK_COG_ATTR, false)) "I placed the !!Black Cog?? on it's !!spindle??." else "I haven't placed the !!Black Cog?? on it's !!spindle?? yet.", line++, getAttribute(player, BLACK_COG_ATTR, false))
                line(player, if (getAttribute(player, WHITE_COG_ATTR, false)) "I placed the !!White Cog?? on it's !!spindle??." else "I haven't placed the !!White Cog?? on it's !!spindle?? yet.", line++, getAttribute(player, WHITE_COG_ATTR, false))
                line(player, if (getAttribute(player, RED_COG_ATTR, false)) "I placed the !!Red Cog?? on it's !!spindle??." else "I haven't placed the !!Red Cog?? on it's !!spindle?? yet.", line++, getAttribute(player, RED_COG_ATTR, false))
            }
            100 -> {
                line(player, "I spoke to Brother Kojo at the Clock Tower South of", line++, true)
