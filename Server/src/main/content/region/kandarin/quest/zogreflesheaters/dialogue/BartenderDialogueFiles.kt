...
class BartenderDialogueFiles : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            7 -> npc(FacialExpression.SCARED, "Noooo! I'm shocked...").also { stage++ }
            ...
            11 -> npc("He was talking to some shifty looking wizard the other", "day. I don't know his name, but I'd recognise him if", "I saw him.").also { setVarbit(player!!, Vars.VARBIT_QUEST_ZORGE_FLESH_EATERS_PROGRESS, 4); stage = END_DIALOGUE }
        }
    }
}
