...
class GrishDialogueFiles : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            2 -> npc(FacialExpression.OLD_DEFAULT, "Das a good drinker for da drinkies dat un is...is a small-un", "for Grish so yous creature keeps it yes. Yous creature keeps da", "fimble drinkers for da smaller drinkies.").also { stage = END_DIALOGUE }
        }
    }
}
...
class GrishBlackPrismDialogueFile : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            2 -> npc(FacialExpression.OLD_DEFAULT, "Whas you's shuvvin wizzy stuff in Grish face...is a", "pretty one but dat's more stuff for da wizzy's dan Grish.").also { stage = END_DIALOGUE }
        }
    }
}
...
class GrishTornPageDialogueFile : DialogueFile() {
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            2 -> npc(FacialExpression.OLD_DEFAULT, "Dat's der wizzy stuff, not Ogery stuffsies like what Grish got. Das", "not even big enough for empty da big blower on! No use", "for Grish dat creatures...you's keeps it.").also { stage = END_DIALOGUE }
        }
    }
}
        ...
        when (stage) {
            ...
            2 -> if(getAttribute(player!!, ZogreQuestUtils.RECEIVED_KEY_FROM_GRISH, false)) {
                ...
                when (buttonID) {
                    ...
                    3 -> player("I have some other questions for you.").also { stage = END_DIALOGUE } // Later.
                    4 -> player("Sorry, I have to go.").also { stage = END_DIALOGUE }
                }
            } else {
                when (buttonID) {
            ...
            4 -> playerl("The person responsible is a wizard named 'Sithik Ints' and he's going to be in serious trouble. He told me that the spell which raised the zogres from the ground will last forever.").also { stage++ }
            5 -> playerl("I'm sorry to say, but you'll have to move the site of your ceremonial dancing somewhere else.").also { stage++ }
            6 -> npcl(FacialExpression.OLD_DEFAULT, "Dat is da bad fing creature...we's needs new Jiggig for da fallin' down jig.").also { stage++ }
            ...
            11 -> npcl(FacialExpression.OLD_DEFAULT, "Yeah creature, yous gotta get da ogrish old fings for da making new jiggig and proper in da special way.").also { stage = END_DIALOGUE }
            12 -> npcl(FacialExpression.OLD_DEFAULT, "Uhggh, whas you's sayin' creature? Yous speakies too stupid for Grish...").also { stage++ }
            13 -> playerl("I know how to make large arrows...you know, 'big stabbers', to kill the zogres...they're bigger and apparently do a lot of damage, only thing is, the normal ogre bow I need to fire it is quite slow.").also { stage++ }
            14 -> npc(FacialExpression.OLD_DEFAULT, "Why you's not say so creature...me's shows you how to","make da bigger stabber chucker...","~ ${BLUE}Grish gets a couple of items out of his back pack.</col>~").also { stage++ }
            ...
            19 -> npc(FacialExpression.OLD_DEFAULT,"De're creature...now yous is makin' da bigga stabber","chucker...").also { stage++ }
            ...
            22 -> npc(FacialExpression.OLD_DEFAULT,"Dat is da goodly fing yous creature, now's we's can","make da new Jiggig place away from zogries! Yous","been da big helpy fing yous creature, Grish wishin' yous","good stuff for da next fings for creature.").also { stage++ }
            23 -> npc(FacialExpression.OLD_DEFAULT,"$DARK_BLUE~ Grish seems very pleased about the return of the</col>","$DARK_BLUE artefacts. ~</col>").also {
            ...
            24 -> player("Thanks, that's very nice of you!").also {
                ...
                finishQuest(player!!, "Zogre Flesh Eaters")
            }
            25 -> npcl(FacialExpression.OLD_DEFAULT, "All da zogries stayin' in da olde Jiggig, we's gonna do da new Jiggig someways else. Yous creature da good-un for geddin' da oldie fings...").also { stage = END_DIALOGUE }
