        ...
        when (getQuestStage(player!!, "Fight Arena")) {
            ...
            0 -> when (stage) {
                ...
                9 -> {
                    ...
                    setQuestStage(player!!, "Fight Arena", 10)
                    npcl(
                        FacialExpression.SAD,
            ...
            in 1..10 -> when (stage) {
                0 -> npcl(FacialExpression.SAD, "Brave traveller, please... bring back my family.").also {
                    stage = END_DIALOGUE
                }
            }
            ...
            in 31..98 -> when (stage) {
                0 -> npcl(
                    ...
                    "Oh no, they won't stand a chance. Please go back and help."
                ).also { stage = END_DIALOGUE }
            }
            ...
            99 -> when (stage) {
                0 -> npcl(
                    ...
                    "You're alive, I thought Khazard's men had taken you."
                ).also { stage++ }
                ...
                3 -> {
                    ...
                    finishQuest(player, "Fight Arena")
                }
            }
