...
public enum BarcrawlType {
    ...
    BarcrawlType(int npc, Item coins, String name, String[][] dialogue) {
    ...
    BarcrawlType(int npc, int coins, final String name, String[] first, String[] second) {
        this.npc = new int[]{npc};
        this.name = name;
    ...
    BarcrawlType(int[] npc, int coins, String name, String[] first, String[] second) {
        this.npc = npc;
        this.name = name;
        this.coins = new Item(995, coins);
        this.dialogue = new String[][]{first, second};
    ...
    BarcrawlType(int npc, int coins, String name, String[] first) {
        this.npc = new int[]{npc};
        this.name = name;
        this.coins = new Item(995, coins);
    ...
    /**
     * For id barcrawl type.
     *
     * @param id the id
     * @return the barcrawl type
     */
