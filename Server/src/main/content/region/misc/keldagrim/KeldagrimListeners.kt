...
class KeldagrimListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(content.region.misc.keldagrim.KeldagrimListeners.Companion.DOORWAY_1, IntType.SCENERY, "enter") { player, _ ->
        ...
        on(content.region.misc.keldagrim.KeldagrimListeners.Companion.DOORWAY_2, IntType.SCENERY, "enter") { player, _ ->
        ...
        on(content.region.misc.keldagrim.KeldagrimListeners.Companion.REINALD, IntType.NPC, "change-armguards") { player, _ ->
        ...
        onUseWith(IntType.NPC,
            content.region.misc.keldagrim.KeldagrimListeners.Companion.FUSION_HAMMER,
            content.region.misc.keldagrim.KeldagrimListeners.Companion.FOREMAN
        ) { player, _, npc ->
        ...
        on(content.region.misc.keldagrim.KeldagrimListeners.Companion.ENTRANCE, IntType.SCENERY, "go-through") { player, node ->
        ...
        on(content.region.misc.keldagrim.KeldagrimListeners.Companion.TUNNEL, IntType.SCENERY, "enter") { player, _ ->
    ...
    override fun defineDestinationOverrides() {
        setDest(IntType.NPC, intArrayOf(content.region.misc.keldagrim.KeldagrimListeners.Companion.INN_KEEPER), "talk-to") { _, _ ->
