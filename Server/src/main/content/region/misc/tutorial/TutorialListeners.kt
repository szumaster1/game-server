package content.region.misc.tutorial
...
class TutorialListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(GUIDE_HOUSE_DOOR, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 4)
        ...
        on(FIRST_GATE, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 17)
        ...
        on(COOKS_DOOR, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 18)
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
            return@on true
        }
        ...
        on(COOKS_EXIT, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 23)
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
            return@on true
        }
        ...
        on(QUEST_ENTER, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 27)
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
            return@on true
        }
        ...
        on(QUEST_LADDER, IntType.SCENERY, "climb-down") { player, node ->
            ...
            if (getAttribute(player, "tutorial:stage", 0) == 29) {
                ...
                content.region.misc.tutorial.TutorialStage.load(player, 30)
            }
        ...
        on(COMBAT_GATES, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 44)
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
        }
        ...
        on(RAT_GATES, IntType.SCENERY, "open") { player, node ->
            ...
            if (stage == 50) {
                ...
                content.region.misc.tutorial.TutorialStage.load(player, 51)
            }
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
            return@on true
        }
        ...
        on(COMBAT_EXIT, IntType.SCENERY, "climb-up") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 56)
            ClimbActionHandler.climbLadder(player, node.asScenery(), "climb-up")
        }
        ...
        on(BANK_EXIT, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 58)
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
        }
        ...
        on(FINANCE_EXIT, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 60)
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
        }
        ...
        on(CHURCH_EXIT, IntType.SCENERY, "open") { player, node ->
            ...
            content.region.misc.tutorial.TutorialStage.load(player, 67)
            DoorActionHandler.handleAutowalkDoor(player, node as Scenery)
        }
