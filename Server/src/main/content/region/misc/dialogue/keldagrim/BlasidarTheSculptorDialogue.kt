...
class BlasidarTheSculptorDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        npc = args[0] as NPC
        npc(FacialExpression.OLD_NORMAL, "The new statue looks beautiful, don't you agree?").also { stage = 0 }
        return true
    }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            28 -> npc(FacialExpression.OLD_NORMAL, "How rude is that? I don't think the Black Guard will be", "very pleased with you!").also { stage = END_DIALOGUE }
