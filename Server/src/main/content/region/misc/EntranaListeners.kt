...
class EntranaListeners : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(content.region.misc.EntranaListeners.Companion.ENTRANA_BOOKCASE, IntType.SCENERY, "Search") { player, _ ->
            if (!inInventory(player, content.region.misc.EntranaListeners.Companion.GLASSBLOWING_BOOK)) {
                addItem(player, content.region.misc.EntranaListeners.Companion.GLASSBLOWING_BOOK)
        ...
        on(Scenery.LADDER_2408, IntType.SCENERY, "climb-down") { player, _ ->
            openDialogue(player,
                content.region.misc.EntranaListeners.Companion.CAVE_MONK, findNPC(content.region.misc.EntranaListeners.Companion.CAVE_MONK)!!.asNpc())
            return@on true
        }
        ...
        on(content.region.misc.EntranaListeners.Companion.MAGIC_DOOR, IntType.SCENERY, "open") { player, _ ->
