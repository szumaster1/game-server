package content.region.misc.quest.zep
...
class EnlightenedJourney : Quest("Enlightened Journey", 55, 54, 1, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_PROGRESS, 0, 1, 200) {
    ...
    override fun finish(player: Player) {
        ...
        setVarbit(player, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_PROGRESS, 200, true)
        setVarbit(player, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_ENTRANA_BALLOON, 2, true)
        setVarbit(player, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_TAVERLEY_BALLOON, 1, true)
        setVarbit(player, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_CASTLE_WARS_BALLOON, 1, true)
        setVarbit(player, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_GRAND_TREE_BALLOON, 1, true)
        setVarbit(player, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_CRAFTING_GUILD_BALLOON, 1, true)
        setVarbit(player, Vars.VARBIT_QUEST_ENLIGHTENED_JOURNEY_VARROCK_BALLOON, 1, true)

      //setAttribute(player, "/save:${BalloonListener.UNLOCKED_DESTINATION}:${BalloonListener.UNLOCKED_BASE}", true)
      //setAttribute(player, "/save:${BalloonListener.UNLOCKED_DESTINATION}:${BalloonListener.UNLOCKED_BASE_2}", true)
    }
