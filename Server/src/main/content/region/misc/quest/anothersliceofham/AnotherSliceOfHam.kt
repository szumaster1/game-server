/*package content.region.miscquest.slice
...
class AnotherSliceOfHam :
    ...
    override fun drawJournal(player: Player?, stage: Int) {
        ...
        if (stage == 0) {
            ...
            line(
                player,
                if (hasLevelStat(player, Skills.ATTACK, 15)) "---Level 15 Attack/--" else "!!30 defence??",
                line++
            )
            line(
                player,
                ...
                ) "---Level 25 Prayer/--" else "!!Level 40 mining (higher mining being an advantage)??",
                line++
            )
