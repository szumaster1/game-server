...
class MalakDialogue(player: Player? = null) : Dialogue(player) {
    ...
    /*
     *  Info: Vampyre noble who governs the village of Canifis for House Drakan.
     *  He can be found in the Hair of the Dog Inn, surveying the area from the doorway.
     *  The werewolves hate and fear him, and he is said to corrupt the very earth he walks upon.
     *  Location: 3497,3478
     */
