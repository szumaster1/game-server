...
class VanstromKlauseQuestDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (getQuestStage(player!!, "In Search of the Myreque")) {
            ...
            1 -> when (stage) {
                START_DIALOGUE -> playerl(FacialExpression.FRIENDLY, "Not very well. I need some help.").also { stage = 2 }
            ...
            2 -> when (stage) {
                START_DIALOGUE -> playerl(FacialExpression.FRIENDLY, "What am I supposed to do again?").also { stage = 2 }
