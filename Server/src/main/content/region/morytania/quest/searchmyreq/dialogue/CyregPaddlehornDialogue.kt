package content.region.morytania.quest.searchmyreq.dialogue
...
//1 -> npcl(FacialExpression.FRIENDLY, "").also { stage++ }
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, "In Search of the Myreque")) {
            1 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.FRIENDLY, "Their base is well hidden, and I'm sorry but I can't reveal the directions. Sorry, but I guess you're all out of luck.").also { stage = 2 }
