...
import content.region.morytania.quest.fenkenstrain.CreatureOfFenkenstrain
import core.api.*
...
class DrFenkenstrainDialogueFile : DialogueBuilderFile() {
    ...
    companion object {
        ...
        private fun hasPart(b: DialogueBuilder, item: Item, attributeToSet: String, successMsg: String): DialogueBuilder {
            return b.branch { player ->
                return@branch if (!getAttribute(player, attributeToSet, false) && inInventory(player, item.id, item.amount)) {
                    1
                } else {
                    0
                }
    ...
    override fun create(b: DialogueBuilder) {
        ...
        b.onQuestStages("Creature of Fenkenstrain", 0)
        ...
        b.onQuestStages("Creature of Fenkenstrain", 1)
            .npcl("Have you come to apply for the job?")
            ...
            .npcl("Mmmm, I see.")
            .branch { player ->
                if (getAttribute(player, "creature-of-fenkenstrain:first-question", -1) == 3 && getAttribute(player,"creature-of-fenkenstrain:second-question", -1) == 3) {
                    1
                } else {
                    0
                }
            ...
            .endWith { _, player ->
                if (getQuestStage(player, "Creature of Fenkenstrain") == 1) {
                    setQuestStage(player, "Creature of Fenkenstrain", 2)
                }
            }

        b.onQuestStages("Creature of Fenkenstrain", 2)
            .options().let { optionBuilder ->
                val continuePath = b.placeholder()
            ...
            .endWith { _, player ->
                if (getQuestStage(player, "Creature of Fenkenstrain") == 2) {
                    setQuestStage(player, "Creature of Fenkenstrain", 3)
                }
            }

        b.onQuestStages("Creature of Fenkenstrain", 3)
            ...
            .branch { player ->
                return@branch if (getAttribute(player, CreatureOfFenkenstrain.attributeNeedle, false) && getAttribute(player, CreatureOfFenkenstrain.attributeThread, false)) {
                    1
                } else {
                    0
                }
            ...
            .betweenStage { _, player, _, _ ->
                setVarp(player, Vars.VARP_QUEST_CREATURE_OF_FENKENSTRAIN_PROGRESS, 3, true)
            }
            .line(
            ...
            .endWith { _, player ->
                if (getQuestStage(player, "Creature of Fenkenstrain") == 3) {
                    setQuestStage(player, "Creature of Fenkenstrain", 4)
                }
            }


        b.onQuestStages("Creature of Fenkenstrain", 4)
        ...
        b.onQuestStages("Creature of Fenkenstrain", 5)
            ...
            .endWith { _, player ->
                if (getQuestStage(player, "Creature of Fenkenstrain") == 5) {
                    setQuestStage(player, "Creature of Fenkenstrain", 6)
                }
        ...
        b.onQuestStages("Creature of Fenkenstrain", 7)
            .npcl("So have you destroyed it?!!?")
        ...
        b.onQuestStages("Creature of Fenkenstrain", 8, 100)
