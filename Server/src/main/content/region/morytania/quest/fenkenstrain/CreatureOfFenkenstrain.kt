 ...
 *
 * @constructor Creature of fenkenstrain
 */
@Initializable
class CreatureOfFenkenstrain : Quest("Creature of Fenkenstrain", 41, 40, 2, Vars.VARP_QUEST_CREATURE_OF_FENKENSTRAIN_PROGRESS, 0, 1, 9) {
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        var started = getQuestStage(player, "Creature of Fenkenstrain") > 0
    ...
    override fun reset(player: Player) {
        setVarp(player, Vars.VARP_QUEST_CREATURE_OF_FENKENSTRAIN_PROGRESS, 0, true)
    ...
    override fun updateVarps(player: Player) {
        ...
        if (getQuestStage(player, "Creature of Fenkenstrain") == 4) {
            setVarp(player, Vars.VARP_QUEST_CREATURE_OF_FENKENSTRAIN_PROGRESS, 3, true)
        }
        if (getQuestStage(player, "Creature of Fenkenstrain") >= 8) {
            setVarp(player, Vars.VARP_QUEST_CREATURE_OF_FENKENSTRAIN_PROGRESS, 8, true)
        }
    }
