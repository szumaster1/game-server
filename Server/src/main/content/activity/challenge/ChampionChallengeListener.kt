...
import content.global.activity.challenge.npc.EarthWarriorChampionNPC.Companion.spawnEarthWarriorChampion
import content.global.activity.challenge.npc.GhoulChampionNPC.Companion.spawnGhoulChampion
import content.global.activity.challenge.npc.GiantChampionNPC.Companion.spawnGiantChampion
import content.global.activity.challenge.npc.GoblinChampionNPC.Companion.spawnGoblinChampion
import content.global.activity.challenge.npc.HobgoblinChampionNPC.Companion.spawnHobgoblinChampion
import content.global.activity.challenge.npc.ImpChampionNPC.Companion.spawnImpChampion
import content.global.activity.challenge.npc.JogreChampionNPC.Companion.spawnJogreChampion
import content.global.activity.challenge.npc.LesserDemonChampionNPC.Companion.spawnLesserDemonChampion
...
class ChampionChallengeListener : InteractionListener, MapArea {
    ...
    override fun defineListeners() {
        ...
        on(content.activity.challenge.ChampionScrollsDropHandler.Companion.SCROLLS, IntType.ITEM, "read") { player, node ->
        ...
        onUseWith(IntType.NPC,
            content.activity.challenge.ChampionScrollsDropHandler.Companion.SCROLLS, NPCs.LARXUS_3050) { player, _, _ ->
            openDialogue(player, content.activity.challenge.LarxusDialogueFile(true))
