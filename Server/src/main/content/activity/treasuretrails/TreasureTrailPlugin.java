...
import content.activity.treasuretrails.clue.CoordinateCluePlugin;
import content.activity.treasuretrails.clue.EmoteCluePlugin;
import content.activity.treasuretrails.clue.MapCluePlugin;
import content.activity.treasuretrails.npc.SaradominWizardNPC;
import content.activity.treasuretrails.npc.ZamorakWizardNPC;
import content.activity.treasuretrails.scroll.CoordinateClueScroll;
import content.activity.treasuretrails.clue.ClueScrollPlugin;
import content.activity.treasuretrails.clue.CoordinateCluePlugin;
import content.activity.treasuretrails.clue.EmoteCluePlugin;
import content.activity.treasuretrails.clue.MapCluePlugin;
