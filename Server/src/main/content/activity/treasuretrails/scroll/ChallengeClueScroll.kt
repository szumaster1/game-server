package content.activity.treasuretrails.scroll
...
abstract class ChallengeClueScroll(
    name: String?,
    clueId: Int,
    level: content.activity.treasuretrails.ClueLevel?,
    val question: String?,
    val npc: Int?,
    val answer: Int?,
    vararg borders: ZoneBorders
) : content.activity.treasuretrails.clue.ClueScrollPlugin(name, clueId, level, 345, *borders) {
