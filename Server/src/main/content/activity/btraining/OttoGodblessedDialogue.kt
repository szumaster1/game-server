package content.activity.btraining
...
class OttoGodblessedDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when(buttonId){
                1 -> playerl(FacialExpression.HALF_GUILTY, "I really don't think I am related to any barbarian.").also { stage++ }
            ...
            14 -> when(buttonId) {
                1 -> player("Please, supply me details of your cunning", "with harpoons.").also { stage = 115 }
                ...
                2 -> {
                    ...
                    // Talking to Otto Godblessed about Fishing training.
                        ...
                        player("Are there any ways to use a fishing rod", "which I might learn?").also { stage = 100 }
                    }
                }
            ...
            22 -> {
                // If the player doesn't have the Barbarian skills book.
            ...
            110 -> if(!removeItem(player, Item(Items.ATTACK_MIX2_11429, 1))){
                npc("Do you have my potion?").also { stage++ }
            } else {
                npc(FacialExpression.HAPPY,"I see you have my potion. I will say no more than that","I am eternally grateful.").also { stage = 113 }
            }
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.OTTO_GODBLESSED_2725)
    }
