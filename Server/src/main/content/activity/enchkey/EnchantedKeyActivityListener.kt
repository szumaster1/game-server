package content.activity.enchkey
...
class EnchantedKeyActivityListener : InteractionListener {
    ...
    override fun defineListeners() {
        onDig(EnchantedKeyHelper.rellekkaTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 0) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
        ...
        onDig(EnchantedKeyHelper.ardougneTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 1) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
        ...
        onDig(EnchantedKeyHelper.benchTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 2) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
        ...
        onDig(EnchantedKeyHelper.gnomeTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 3) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
        ...
        onDig(EnchantedKeyHelper.altarTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 4) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
                addItemOrDrop(player, Items.MITHRIL_ORE_448, 10)
                addItemOrDrop(player, Items.IRON_ORE_441, 15)
        ...
        onDig(EnchantedKeyHelper.faladorTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 5) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
        ...
        onDig(EnchantedKeyHelper.mudskipperTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 6) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
                addItemOrDrop(player, Items.IRON_ORE_441, 15)
        ...
        onDig(EnchantedKeyHelper.swampTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 7) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
        ...
        onDig(EnchantedKeyHelper.alkharidTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 8) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
                addItemOrDrop(player, Items.PURE_ESSENCE_7937, 40)
                addItemOrDrop(player, Items.MITHRIL_ORE_448, 10)
        ...
        onDig(EnchantedKeyHelper.examTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 9) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
                addItemOrDrop(player, Items.PURE_ESSENCE_7937, 40)
                addItemOrDrop(player, Items.IRON_ORE_441, 15)
        ...
        onDig(EnchantedKeyHelper.geTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 10) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
                addItemOrDrop(player, Items.PURE_ESSENCE_7937, 39)
                ...
                if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR, 0) == 11) {
                    ...
                    removeAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_ATTR)
                }
        ...
        onDig(EnchantedKeyHelper.gnomeballfieldTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 0) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.shantaypassTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 1) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.brimhavenTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 2) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.wildernessTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 3) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.taibwowannaiTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 4) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.feldiphillsTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 5) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.agilitypyramidTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 6) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.banditcampTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 7) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.daemonheimTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 8) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
                addItemOrDrop(player, Items.COINS_995, 950)
        ...
        onDig(EnchantedKeyHelper.deathplateauTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 9) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
        ...
        onDig(EnchantedKeyHelper.scorpionPitTreasure) { player ->
            if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 10) {
                player.incrementAttribute(EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
                ...
                if (getAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR, 0) == 11) {
                    sendMessage(player, "Congratulations! You have completed the Enchanted key mini-quest II!")
                    removeItem(player, Items.ENCHANTED_KEY_6754)
                    removeAttribute(player, EnchantedKeyHelper.ENCHANTED_KEY_2_ATTR)
                }
