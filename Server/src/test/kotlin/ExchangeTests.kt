...
class ExchangeTests {
    ...
    fun testBuyFirstSellAfterFavorsSell() {
        ...
        Assertions.assertEquals(
            null,
            buyOffer.withdraw[1],
            "Buyer got coins back on sell bias"
    ...
    fun testSellFirstBuyAfterFavorsBuy() {
        ...
        Assertions.assertNotEquals(
            null,
            buyOffer.withdraw[1],
            "Buyer did not get coins back on buy bias"
    ...
    fun offerWithNotEnoughNotedItemsShouldFail() {
        TestUtils.getMockPlayer("combinedNotedAndUnnotedFailure").use { p ->
            ...
            Assertions.assertEquals(
                StockMarketInterfaceListener.OfferConfirmResult.NotEnoughItemsOrCoins,
                mkt.confirmOffer(p, offer, 0)
            )
            Assertions.assertEquals(10, p.inventory.getAmount(4151))
