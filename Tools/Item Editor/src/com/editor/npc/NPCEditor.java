...
public class NPCEditor extends JFrame {
    ...
    private void initComponents() {
        ...
        JTextField npcSize = new JTextField();
        ...
        JMenuItem reloadButton = new JMenuItem();
        JMenuItem saveButton = new JMenuItem();
        JMenuItem addModelButton = new JMenuItem();
        JMenuItem exportButton = new JMenuItem();
        ...
        npcSize.setText("" + this.defs.getSize());
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addComponent(this.visibleOnMap).addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING, false).addGroup(Alignment.LEADING, jPanel1Layout.createSequentialGroup().addComponent(jLabel1).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(this.name, -2, 100, -2)).addGroup(Alignment.LEADING, jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addComponent(jLabel4).addComponent(jLabel5)).addGap(18, 18, 18).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addComponent(npcSize, -2, 100, -2).addComponent(this.combatLevel, -2, 100, -2))).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addComponent(jLabel10).addComponent(jLabel11).addComponent(jLabel12)).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING, false).addComponent(this.npcHeight, -1, 100, 32767).addComponent(this.npcWidth).addComponent(this.walkMask)))).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addComponent(jLabel13).addComponent(jLabel14)).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING, false).addComponent(this.respawnDirection, -1, 100, 32767).addComponent(this.renderEmote)))).addContainerGap(455, 32767)));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel1).addComponent(this.name, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel4).addComponent(this.combatLevel, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel5).addComponent(npcSize, -2, 20, -2)).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.visibleOnMap).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel10).addComponent(this.npcHeight, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel11).addComponent(this.npcWidth, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel12).addComponent(this.walkMask, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel13).addComponent(this.respawnDirection, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel1Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel14).addComponent(this.renderEmote, -2, -1, -2)).addContainerGap(134, 32767)));
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING, false).addComponent(jLabel3).addComponent(this.modelIds, -1, 275, 32767).addComponent(jLabel6).addComponent(this.jTextField2)).addContainerGap(379, 32767)));
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addComponent(jLabel3).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.modelIds, -2, -1, -2).addGap(18, 18, 18).addComponent(jLabel6).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.jTextField2, -2, -1, -2).addContainerGap(259, 32767)));
        ...
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING, false).addComponent(jLabel7).addComponent(this.optionsField, -1, 275, 32767).addComponent(jLabel8).addComponent(this.modelColorField).addComponent(jLabel9).addComponent(this.textureColorField)).addContainerGap(379, 32767)));
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addComponent(jLabel7).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.optionsField, -2, -1, -2).addGap(18, 18, 18).addComponent(jLabel8).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.modelColorField, -2, -1, -2).addGap(18, 18, 18).addComponent(jLabel9).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.textureColorField, -2, -1, -2).addContainerGap(201, 32767)));
        ...
        jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addContainerGap().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addComponent(this.unknownArray2, -2, 175, -2).addComponent(jLabel15).addComponent(this.unknownArray1, -2, 175, -2).addComponent(jLabel16).addComponent(jLabel17)).addGap(18, 18, 18).addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel20).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt1, -2, 100, -2).addPreferredGap(ComponentPlacement.RELATED, 33, 32767).addComponent(jLabel32).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt13, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel21).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt2, -2, 100, -2).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(jLabel33).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt14, -2, 100, -2)).addGroup(Alignment.TRAILING, jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addComponent(this.unknownBoolean5).addComponent(this.unknownBoolean6).addComponent(this.unknownBoolean7)).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel31).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt12, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel30).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt11, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel29).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt10, -2, 100, -2)))))).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addComponent(this.unknownArray3, -2, 175, -2).addComponent(jLabel18)).addGap(18, 18, 18).addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel23).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt4, -2, 100, -2).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(jLabel35).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt16, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel22).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt3, -2, 100, -2).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(jLabel34).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt15, -2, 100, -2)))).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addComponent(this.unknownBoolean4).addComponent(this.unknownBoolean3)).addGap(0, 0, 32767)).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addComponent(this.unknownArray4, -2, 175, -2).addComponent(jLabel19)).addGap(18, 18, 18).addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel25).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt6, -2, 100, -2).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(jLabel37).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt18, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel24).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt5, -2, 100, -2).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(jLabel36).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt17, -2, 100, -2)))).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.TRAILING, false).addGroup(Alignment.LEADING, jPanel4Layout.createSequentialGroup().addComponent(this.unknownArray5, -2, 175, -2).addGap(18, 18, 18).addComponent(jLabel26).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt7, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addComponent(this.unknownBoolean1).addPreferredGap(ComponentPlacement.RELATED, -1, 32767)).addGroup(Alignment.TRAILING, jPanel4Layout.createSequentialGroup().addComponent(this.unknownBoolean2).addGap(80, 80, 80))).addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel28).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt9, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel27).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt8, -2, 100, -2))))).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING, jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel38).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt19, -2, 100, -2)).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel39).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt20, -2, 100, -2))).addGroup(Alignment.TRAILING, jPanel4Layout.createSequentialGroup().addComponent(jLabel40).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownInt21, -2, 100, -2))))).addGap(88, 88, 88)));
        jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel4Layout.createSequentialGroup().addContainerGap().addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING, false).addGroup(jPanel4Layout.createSequentialGroup().addComponent(jLabel15).addGap(4, 4, 4).addComponent(this.unknownArray1, -2, -1, -2).addPreferredGap(ComponentPlacement.RELATED).addComponent(jLabel16).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownArray2, -2, -1, -2)).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.TRAILING).addGroup(jPanel4Layout.createSequentialGroup().addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownBoolean5).addComponent(jLabel29).addComponent(this.unknownInt10, -2, -1, -2)).addGap(22, 22, 22)).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownBoolean6).addComponent(jLabel30).addComponent(this.unknownInt11, -2, -1, -2))).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownBoolean7).addComponent(jLabel31).addComponent(this.unknownInt12, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel20).addComponent(this.unknownInt1, -2, -1, -2).addComponent(jLabel32).addComponent(this.unknownInt13, -2, -1, -2)))).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel17).addComponent(jLabel21).addComponent(this.unknownInt2, -2, -1, -2).addComponent(jLabel33).addComponent(this.unknownInt14, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownArray3, -2, -1, -2).addComponent(jLabel22).addComponent(this.unknownInt3, -2, -1, -2).addComponent(jLabel34).addComponent(this.unknownInt15, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel18).addComponent(jLabel23).addComponent(this.unknownInt4, -2, -1, -2).addComponent(jLabel35).addComponent(this.unknownInt16, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownArray4, -2, -1, -2).addComponent(jLabel24).addComponent(this.unknownInt5, -2, -1, -2).addComponent(jLabel36).addComponent(this.unknownInt17, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.LEADING).addComponent(this.unknownInt6, -2, 20, -2).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel19).addComponent(jLabel25).addComponent(jLabel37).addComponent(this.unknownInt18, -2, -1, -2))).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownArray5, -2, -1, -2).addComponent(jLabel26).addComponent(this.unknownInt7, -2, -1, -2).addComponent(jLabel38).addComponent(this.unknownInt19, -2, -1, -2)).addPreferredGap(ComponentPlacement.UNRELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownBoolean1).addComponent(jLabel27).addComponent(this.unknownInt8, -2, -1, -2).addComponent(jLabel39).addComponent(this.unknownInt20, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel4Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.unknownBoolean2).addComponent(jLabel28).addComponent(this.unknownInt9, -2, -1, -2).addComponent(jLabel40).addComponent(this.unknownInt21, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownBoolean3).addPreferredGap(ComponentPlacement.RELATED).addComponent(this.unknownBoolean4).addContainerGap(-1, 32767)));
        ...
        jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel5Layout.createSequentialGroup().addContainerGap().addComponent(jScrollPane1, -2, 325, -2).addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel5Layout.createSequentialGroup().addGap(72, 72, 72).addComponent(jLabel41).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(jLabel42).addGap(81, 81, 81)).addGroup(jPanel5Layout.createSequentialGroup().addGap(18, 18, 18).addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING).addComponent(jLabel44).addComponent(jLabel43)).addContainerGap(43, 32767)).addGroup(jPanel5Layout.createSequentialGroup().addGap(53, 53, 53).addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING, false).addComponent(this.csk4, Alignment.TRAILING).addComponent(this.csk5, Alignment.TRAILING).addComponent(this.csk6, Alignment.TRAILING).addComponent(this.csk1, -1, 80, 32767).addComponent(this.csk2).addComponent(this.csk3)).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING, false).addComponent(this.csv1, -2, 80, -2).addComponent(this.csv2, -1, 81, 32767).addComponent(this.csv3).addComponent(this.csv4).addComponent(this.csv5).addComponent(this.csv6)).addGap(0, 0, 32767)))));
        jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel5Layout.createSequentialGroup().addContainerGap().addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING).addGroup(jPanel5Layout.createSequentialGroup().addComponent(jScrollPane1, -1, 346, 32767).addContainerGap()).addGroup(jPanel5Layout.createSequentialGroup().addGroup(jPanel5Layout.createParallelGroup(Alignment.BASELINE).addComponent(jLabel41).addComponent(jLabel42)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel5Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.csk1, -2, -1, -2).addComponent(this.csv1, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel5Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.csk2, -2, -1, -2).addComponent(this.csv2, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel5Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.csk3, -2, -1, -2).addComponent(this.csv3, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel5Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.csk4, -2, -1, -2).addComponent(this.csv4, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel5Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.csk5, -2, -1, -2).addComponent(this.csv5, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED).addGroup(jPanel5Layout.createParallelGroup(Alignment.BASELINE).addComponent(this.csk6, -2, -1, -2).addComponent(this.csv6, -2, -1, -2)).addPreferredGap(ComponentPlacement.RELATED, -1, 32767).addComponent(jLabel43).addPreferredGap(ComponentPlacement.RELATED).addComponent(jLabel44).addGap(45, 45, 45)))));
        jTabbedPane1.addTab("Clientscripts", jPanel5);
        jLabel2.setText("Currently Viewing Definitions of NPC: " + this.defs.getId() + " - " + this.defs.getName());
        jMenu1.setText("File");
        reloadButton.setText("Reload");
        reloadButton.addActionListener(evt -> NPCEditor.this.reloadButtonActionPerformed(evt));
        jMenu1.add(reloadButton);
        saveButton.setText("Save");
        saveButton.addActionListener(evt -> NPCEditor.this.saveButtonActionPerformed(evt));
        jMenu1.add(saveButton);
        addModelButton.setText("Add Model");
        addModelButton.addActionListener(evt -> NPCEditor.this.addModelButtonActionPerformed(evt));
        jMenu1.add(addModelButton);
        exportButton.setText("Export to .txt");
        exportButton.addActionListener(evt -> NPCEditor.this.exportButtonActionPerformed(evt));
        jMenu1.add(exportButton);
        exitButton.setText("Exit");
        exitButton.addActionListener(evt -> NPCEditor.this.exitButtonActionPerformed(evt));
        jMenu1.add(exitButton);
        jMenuBar1.add(jMenu1);
        this.setJMenuBar(jMenuBar1);
        GroupLayout layout = new GroupLayout(this.getContentPane());
        this.getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(Alignment.LEADING).addComponent(jTabbedPane1).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(jLabel2).addContainerGap(-1, 32767)));
        layout.setVerticalGroup(layout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING, layout.createSequentialGroup().addGap(0, 16, 32767).addComponent(jLabel2).addPreferredGap(ComponentPlacement.UNRELATED).addComponent(jTabbedPane1, -2, 396, -2)));
        this.pack();
    }

    private void reloadButtonActionPerformed(ActionEvent ignoredEvt) {
        this.reload();
    }

    private void saveButtonActionPerformed(ActionEvent ignoredEvt) {
        this.save();
    }

    private void addModelButtonActionPerformed(ActionEvent ignoredEvt) {
        this.addModel();
    }

    private void exportButtonActionPerformed(ActionEvent ignoredEvt) {
        this.export();
    }

    private void exitButtonActionPerformed(ActionEvent ignoredEvt) {
        this.dispose();
    }

    public static void main(String[] args) {
        EventQueue.invokeLater(() -> (new NPCEditor()).setVisible(true));
    }
        ...
        try {
            ...
            if (!this.textureColorField.getText().equals("")) {
                ...
                for (i$ = 0; i$ < len$; ++i$) {
                    t = i[i$];
                    editedColor = t.split("=");
                    this.defs.changeTextureColor(Integer.valueOf(editedColor[0]), Integer.valueOf(editedColor[1]));
                }
            }
        ...
        if (result == 0) {
            ...
            if (Integer.parseInt(returnVal1) != -1) {
                ...
                if (var9 == 0) {
                    ...
                    try {
                        ...
                        var10002 = this.ns;
                        Main.log("NPCEditor", var10001.append(Utils.packCustomModel(NPCSelection.STORE, Utils.getBytesFromFile(new File(file1.getPath())), Integer.parseInt(returnVal1))).toString());
            ...
            if (returnVal11 == 0) {
                ...
                try {
                    var10001 = (new StringBuilder()).append("The model ID of the recently packed model is: ");
                    var10002 = this.ns;
                    Main.log("NPCEditor", var10001.append(Utils.packCustomModel(NPCSelection.STORE, Utils.getBytesFromFile(new File(file21.getPath())))).toString());
    ...
    private void export() {
        ...
        try {
            writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(System.getProperty("user.home") + "/Dumps/npcs/" + this.defs.id + ".txt"), StandardCharsets.UTF_8));
            ...
            if (this.defs.clientScriptData != null) {
                ...
                for (int key : this.defs.clientScriptData.keySet()) {
