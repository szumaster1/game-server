...
enum class QuestRequirements(val questName: String, vararg val requirements: Requirement) {
    ...
    ROCKING_OUT("Rocking Out", SkillReq(Skills.AGILITY, 60), SkillReq(Skills.CRAFTING, 66), SkillReq(Skills.SMITHING, 69), SkillReq(Skills.THIEVING, 63), QuestReq(BRAIN_ROBBERY))
}
