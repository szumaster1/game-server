...
class XteaParser {
    companion object {
        ...
        fun getRegionXTEA(regionId: Int): IntArray? {
            ...
            // This one grabs the keys from the SQL
            // return DEFAULT_REGION_KEYS;
            // This one only uses the default keys at the top,
            // { 14881828, -6662814, 58238456, 146761213 }. Unsure why they chose these numbers.
        }
    }
    ...
    fun load() {
        var count = 0
        reader = FileReader(Configuration.CONFIG_PATH + "xteas.json")
