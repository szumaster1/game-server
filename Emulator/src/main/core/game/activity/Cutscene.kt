...
abstract class Cutscene(val player: Player) {
    ...
    /**
     * Fade the player's view to black. This process can be
     * safely assumed to take about 8 ticks to complete.
     */
    fun fadeToBlack() {
    ...
    /**
     * Fade the player's view from black back to normal.
     * This process can be safely assumed to take about 6 ticks to complete.
     */
    fun fadeFromBlack() {
    ...
    /**
     * Retrieves all NPCs from the added-to-cutscene NPCs
     * with a matching ID.
     *
     * @param id the ID to grab for.
    ...
    fun end(fade: Boolean = true, endActions: (() -> Unit)? = null) {
        ...
        GameWorld.Pulser.submit(object : Pulse() {
            ...
            override fun stop() {
                ...
                player.properties.safeRespawn = Configuration.HOME_LOCATION
    ...
    /**
     * Ends this cutscene, fading the screen to black,
