...
public abstract class ActivityPlugin extends MapZone implements Plugin<Player> {
     ...
     */
    protected Location safeRespawn = Configuration.HOME_LOCATION;
    ...
    public boolean leave(Entity e, boolean logout) {
        if (e instanceof Player) {
            e.getProperties().setSpawnLocation(Configuration.HOME_LOCATION);
        }
        Location l;
        ...
        e.getProperties().safeRespawn = Configuration.HOME_LOCATION;
