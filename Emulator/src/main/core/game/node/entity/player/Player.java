...
import core.net.packet.outgoing.BuildDynamicScene;
import core.net.packet.outgoing.SkillLevel;
import core.net.packet.outgoing.UpdateSceneGraph;
...
public class Player extends Entity {
     ...
     * The Version.
     */
    public int version = Configuration.CURRENT_SAVEFILE_VERSION;
    ...
    public Player(PlayerDetails details) {
        super(details.getUsername(), Configuration.START_LOCATION);
        super.active = false;
    ...
    public void init() {
        ...
        if (!artificial) {
            getProperties().setSpawnLocation(Configuration.HOME_LOCATION);
