...
import core.integrations.mysql.Database
...
class Configuration {
    companion object {
        ...
        @JvmField
        var RESPAWN_POINT: Location? = Location(2973, 3340, 0)
        ...
        @JvmField
        var EXPONENT =
            BigInteger("")
