...
class MageOfZamorakDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        if (!varrockMage) {
            ...
            when (getStage()) {
                0 -> end()
                1 -> when (stage) {
                    0 -> options("I'd like to buy some runes!", "Where do you get your runes from?", "All hail Zamorak!", "Nothing, thanks.").also { stage++ }
                    1 -> when (buttonId) {
                        1 -> player("I'd like to buy some runes!").also { stage = 10 }
                        2 -> player("Where do you get your runes from?", "No offence, but people around here don't exactly like", "'your type'.").also { stage = 20 }
                        3 -> player("All hail Zamorak!", "He's the man!", "If he can't do it, maybe some other guy can!").also { stage = 30 }
                        4 -> player("I didn't really want anything, thanks.", "I just like talking to random people I meet around the", "world.").also { stage = 40 }
                    }
                    10 -> npc("I do not conduct business in this pathetic city.", "Speak to me in the wilderness if you desire to purchase", "runes from me.").also { stage = END_DIALOGUE }
                    20 -> npc("My 'type' Explain.").also { stage++ }
                    21 -> player("You know...", "Scary bearded men in dark clothing with unhealthy", "obsessions with destruction and stuff.").also { stage++ }
                    22 -> npc("Hmmm.", "Well, you may be right, the foolish Saradominists that", "own this pathetic city don't appreciate loyal Zamorakians,", "it is true.").also { stage++ }
                    23 -> player("So you can't be getting your runes anywhere around", "here...").also { stage++ }
                    24 -> npc("That is correct stranger.", "My mysteries of manufacturing Runes is a closely", "guarded secret of the Zamorakian brotherhood.").also { stage++ }
                    25 -> player("Oh, you mean the whole teleporting to the Rune", "essence mine, mining some essence, then using the", "talismans to locate the Rune Temples, then binding", "runes there?").also { stage++ }
                    ...
                    205 -> npc("substance is a heavily stockpiled resource at the Wizards", "Tower.").also { stage++ }
                    206 -> npc("This changes everything.").also { stage++ }
                    207 -> player("How do you mean?").also { stage++ }
                    208 -> npc("For many years there has been a struggle for power", "on this world.", "You may dispute the morality of each side as you wish,", "but the stalemate that exists between my Lord Zamorak").also { stage++ }
                    209 -> npc("and that pathetic meddling fool Saradomin has meant", "that our struggle have become more secretive.", "We exist in a 'cold war' if you will, each side fearful of", "letting the other gain too much power, and each side").also { stage++ }
                    210 -> npc("equally fearful of entering into open warfare for fear of", "bringing our struggles to the attention of... other", "beings.").also { stage++ }
                    211 -> player("You mean Guthix?").also { stage++ }
                    212 -> npc("Indeed.", "Amongst others.", "But you now tell me that the Saradominist Wizards", "have the capability to mass produce runes, I can only").also { stage++ }
                    213 -> npc("conclude that they have been doing so secretly for some", "time now.").also { stage++ }
                    214 -> npc("I implore you adventurer, you may or may not agree", "with my aims, but you cannot allow such a one-sided", "shift in the balance of power to occur.").also { stage++ }
                    215 -> npc("Will you help me and my fellow Zamorakians to access", "this 'essence' mine?", "In return I will share with you the research we have", "gathered.").also { stage++ }
                    216 -> player("Okay, I'll help you.", "What can I do?").also { stage++ }
                    217 -> npc("All I need from you is the spell that will teleport me to", "this essence mine.", "That should be sufficient for the armies of Zamorak to", "once more begin stockpiling magic for war.").also { stage++ }
                    ...
                    220 -> player("Oh, well, people who do know the spell teleport me there", "directly.", "Apparently they wouldn't teach it to me to try and keep", "the location secret.").also { stage++ }
                    221 -> npc("Hmmm.", "Yes, yes I see.", "Very well then, you may still assist us in finding this", "mysterious essence mine.").also { stage++ }
                    ...
                    30 -> end()
                    40 -> npc("...I see.", "Well, in the future, do not waste my time, or you will", "feel the wrath of Zamorak upon you.").also { stage++ }
                    41 -> end()
                }
                ...
                2 -> when (stage) {
                    ...
                    229 -> npc("Good.", "If you encounter any difficulties speak to me again.").also { stage = END_DIALOGUE }
                ...
                3 -> when (stage) {
                    ...
                    1 -> npc("I offer you three things as a reward for your efforts on", "behalf of my Lord Zamorak;").also { stage++ }
                    2 -> npc("The first is knowledge.", "I offer you my collected research on the abyss.", "I also offer you 1000 points of experience in", "RuneCrafting for your trouble.").also { stage++ }
                    3 -> npc("Your second gift is convenience.", "Here you may take this pouch I discovered amidst my", "research.", "You will find it to have certain... interesting properties.").also { stage++ }
                ...
                4 -> when (stage) {
                    0 -> when (buttonId) {
                        1 -> player("Uh...", "I really don't see how this talk about an 'abyss' relates", "to RuneCrafting in the slightest...").also { stage = 10 }
                        2 -> player("So...", "This 'abyss' place...", "Is it dangerous?").also { stage = 20 }
                        3 -> player("Well, I reckon I'm prepared to go there now.", "Beam me there, or whatever it is that you do!").also { stage = 30 }
                    }
                    10 -> npc("My primary research responsibility was not towards the", "manufacture of runes, this is true.").also { stage = END_DIALOGUE }
                    20 -> npc("Well, the creatures there ARE particularly offensive...").also { stage = END_DIALOGUE }
                    30 -> npc("No, not from here.", "The use of my Lord Zamorak magic in this land will", "draw too much attention to myself.").also { stage = 8 }
                    6 -> player("RuneCrafting!").also { stage++ }
                    7 -> npc("And so I have done.", "Read my research notes, they may enlighten you", "somewhat.").also { stage++ }
                    8 -> end()
                }
            }
        }
    ...
    override fun getIds(): IntArray {
        return intArrayOf(2257, NPCs.MAGE_OF_ZAMORAK_2258, NPCs.MAGE_OF_ZAMORAK_2259, NPCs.MAGE_OF_ZAMORAK_2260, NPCs.MAGE_OF_ZAMORAK_2261)
    }
