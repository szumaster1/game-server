...
class ClanWarsActivityPlugin : ActivityPlugin("Clan wars", true, false, true) {
    ...
    private fun handleWall() {
        ...
        for (x in 5..53) {
            offset = (offset + 1) % 3
            SceneryBuilder.add(Scenery(28174 + offset, base.transform(x, 64, 0)))
        }
        Pulser.submit(object : Pulse(200) {
    ...
    companion object {
        private val ATTACK_OPTION = Option("Attack", 0).setHandler(object : OptionHandler() {
