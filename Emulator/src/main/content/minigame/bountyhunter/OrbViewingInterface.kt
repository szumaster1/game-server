...
class OrbViewingInterface : ComponentPlugin() {
        ...
        definePlugin(object : OptionHandler() {
            ...
            override fun handle(player: Player, node: Node, option: String): Boolean {
                ...
                when (node.id) {
                    ...
                    Scenery.HIGH_LEVEL_ORB_28211 -> setAttribute(player, "viewing_orb", BOUNTY_HUNTER[node.id - 28209])
                }
    ...
    companion object {
         ...
         * (Order: South-west, South-east, North-west, North-east, Center)
         */

        private val FIGHT_PITS = arrayOf(
        ...
        private val BOUNTY_HUNTER = arrayOf(
            arrayOf( // Low level crater.
        ...
        private fun stopViewing(player: Player, close: Boolean) {
            ...
            player.properties.teleportLocation = getAttribute(player, "view-location", Configuration.HOME_LOCATION)
        }
    }
}
