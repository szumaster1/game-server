...
class SorceressDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            0 -> options("None of your business!", "I'm here to kill you!", "Can I have some sq'irks please?", "I'm just passing by.").also { stage++ }
            1 -> when (buttonId) {
                1 -> player(FacialExpression.FURIOUS, "None of your business!").also { stage++ }
            ...
            10 -> player("<col=0000FF>You find yourself compelled to answer truthfully:</col>", "Osman.").also { stage++ }
            11 -> npc("In that case I'm sorry, you can't. I have had a falling", "out with him recently and would rather not oblige him.").also { stage = END_DIALOGUE }
        }
        return true
    }
