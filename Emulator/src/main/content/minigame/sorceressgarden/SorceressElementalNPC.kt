...
class SorceressElementalNPC : AbstractNPC {
    internal enum class ElementalDefinition(private val npcId: Int, private val locations: Array<Location>) {
        ...
        AUTUMN_ELEMENTAL_5536(
            ...
            locations = arrayOf(Location(2903, 5451, 0), Location(2903, 5455, 0), Location(2905, 5455, 0), Location(2905, 5451, 0))
        ),
        ...
        SPRING_ELEMENTAL_5540(
            ...
            locations = arrayOf(Location(2924, 5463, 0), Location(2928, 5463, 0), Location(2928, 5461, 0), Location(2924, 5461, 0))
        ),
        SPRING_ELEMENTAL_5541(
            npcId = NPCs.SPRING_ELEMENTAL_5541,
            locations = arrayOf(Location(2924, 5461, 0), Location(2926, 5461, 0), Location(2926, 5458, 0), Location(2924, 5458, 0))
        ),
        SPRING_ELEMENTAL_5542(
            npcId = NPCs.SPRING_ELEMENTAL_5542,
            locations = arrayOf(Location(2928, 5458, 0), Location(2928, 5460, 0), Location(2934, 5460, 0), Location(2934, 5458, 0))
        ),
        ...
        SUMMER_ELEMENTAL_5550(
            ...
            locations = arrayOf(Location(2918, 5483, 0), Location(2918, 5485, 0), Location(2915, 5485, 0), Location(2915, 5483, 0), Location(2912, 5483, 0), Location(2912, 5485, 0), Location(2915, 5485, 0), Location(2915, 5483, 0))
        ),
        SUMMER_ELEMENTAL_5551(
            npcId = NPCs.SUMMER_ELEMENTAL_5551,
            locations = arrayOf(Location(2921, 5486, 0), Location(2923, 5486, 0), Location(2923, 5490, 0), Location(2923, 5486, 0))
        ),
        SUMMER_ELEMENTAL_5552(
            npcId = NPCs.SUMMER_ELEMENTAL_5552,
            locations = arrayOf(Location(2921, 5491, 0), Location(2923, 5491, 0), Location(2923, 5495, 0), Location(2921, 5495, 0))
        ),
        WINTER_ELEMENTAL_5553(
            npcId = NPCs.WINTER_ELEMENTAL_5553,
            locations = arrayOf(Location(2899, 5466, 0), Location(2899, 5468, 0), Location(2897, 5468, 0), Location(2897, 5466, 0), Location(2897, 5468, 0), Location(2899, 5468, 0))
        ),
        ...
        WINTER_ELEMENTAL_5555(
            ...
            locations = arrayOf(Location(2897, 5471, 0), Location(2899, 5471, 0), Location(2899, 5478, 0), Location(2897, 5478, 0))
        ),
        WINTER_ELEMENTAL_5556(
            npcId = NPCs.WINTER_ELEMENTAL_5556,
            locations = arrayOf(Location(2896, 5483, 0), Location(2900, 5483, 0), Location(2900, 5480, 0), Location(2897, 5480, 0), Location(2897, 5481, 0), Location(2896, 5481, 0), Location(2896, 5482, 0))
        ),
        WINTER_ELEMENTAL_5557(
            npcId = NPCs.WINTER_ELEMENTAL_5557,
            locations = arrayOf(Location(2896, 5483, 0), Location(2896, 5481, 0), Location(2891, 5481, 0), Location(2891, 5483, 0))
        ),
    ...
    override fun getIds(): IntArray {
        return intArrayOf(NPCs.AUTUMN_ELEMENTAL_5533, NPCs.AUTUMN_ELEMENTAL_5534, NPCs.AUTUMN_ELEMENTAL_5535, NPCs.AUTUMN_ELEMENTAL_5536, NPCs.AUTUMN_ELEMENTAL_5537, NPCs.AUTUMN_ELEMENTAL_5538, NPCs.SPRING_ELEMENTAL_5539, NPCs.SPRING_ELEMENTAL_5540, NPCs.SPRING_ELEMENTAL_5541, NPCs.SPRING_ELEMENTAL_5542, NPCs.SPRING_ELEMENTAL_5543, NPCs.SPRING_ELEMENTAL_5544, NPCs.SPRING_ELEMENTAL_5545, NPCs.SPRING_ELEMENTAL_5546, NPCs.SUMMER_ELEMENTAL_5547, NPCs.SUMMER_ELEMENTAL_5548, NPCs.SUMMER_ELEMENTAL_5549, NPCs.SUMMER_ELEMENTAL_5550, NPCs.SUMMER_ELEMENTAL_5551, NPCs.SUMMER_ELEMENTAL_5552, NPCs.WINTER_ELEMENTAL_5553, NPCs.WINTER_ELEMENTAL_5554, NPCs.WINTER_ELEMENTAL_5555, NPCs.WINTER_ELEMENTAL_5556, NPCs.WINTER_ELEMENTAL_5557, NPCs.WINTER_ELEMENTAL_5558)
    }
    ...
    override fun tick() {
        ...
        for (player in players) {
            if (player == null || !player.isActive || player.locks.isInteractionLocked || DeathTask.isDead(player) || !canTeleport(player) || !isProjectileClipped(this, player, false)) {
                continue
            }
