    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when ((0..3).random()) {
            ...
            1 -> when (stage) {
                ...
                3 -> npcl(FacialExpression.HALF_GUILTY, "That attempt at humour merely made me more depressed. Leave me alone.").also { stage = END_DIALOGUE }
            }
            2 -> when (stage) {
                ...
                6 -> player("I'll leave you to your sighing. It looks like you have plenty to do.").also { stage = END_DIALOGUE }
            }
            3 -> when (stage) {
