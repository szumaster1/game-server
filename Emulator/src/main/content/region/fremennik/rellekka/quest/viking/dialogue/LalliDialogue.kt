...
class LalliDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            11 -> player("I see... okay, well, bye!").also {
                setAttribute(player, "/save:fremtrials:lalli-talkedto", true); stage = END_DIALOGUE
            }

            //Honest, you're clever
            20 -> npc(FacialExpression.OLD_SNEAKY, "Me no believe you tell truth. Go away.").also { stage = END_DIALOGUE }

            //Can I give you a present
            30 -> npc(FacialExpression.OLD_SNEAKY, "Me think about that.").also { stage = END_DIALOGUE }
            ...
            56 -> interpreter.sendDialogue("You have a cunning plan to trick this troll. You need your pet rock,", "a cabbage, a potato and an onion.").also { removeAttribute(player, "fremtrials:fremtrials:lalli-talkedto"); stage = END_DIALOGUE }
            58 -> playerl(FacialExpression.NEUTRAL, "Not just yet...").also { stage = END_DIALOGUE }
            ...
            63 -> npcl(FacialExpression.OLD_SNEAKY, "Let me think about that, me like to think.").also {
                ...
                removeAttributes(player, "lalliStewOnionAdded", "lalliStewPotatoAdded", "lalliStewCabbageAdded", "lalliStewRockAdded")
                stage = END_DIALOGUE
            }
            ...
            68 -> npcl(FacialExpression.OLD_NORMAL, "Me would give you golden fleece if me think you have enough room in your inventory.").also { stage = END_DIALOGUE }
            ...
            76 -> playerl(FacialExpression.HAPPY, "Oh it's great, thank you again for the fleece Lalli, I hope you're enjoying your soup").also { stage = END_DIALOGUE }
            ...
            106 -> when (buttonId) {
                ...
                2 -> npcl(FacialExpression.OLD_HAPPY, "You no pay, then you go! You no get any golden apples!").also { stage = END_DIALOGUE }
            }
            107 -> npcl(FacialExpression.OLD_HAPPY, "Ha! Stupid human think he buy golden apples, but he actually get stupid wool! Hahaha!").also { stage = END_DIALOGUE }
            115 -> playerl(FacialExpression.THINKING, "I don't even have that much cash on me...").also { stage++ }
            116 -> npcl(FacialExpression.OLD_NORMAL, "Well stupid bad trade human don't get no wool then! Or any golden apples!").also { stage = END_DIALOGUE }
        }
        return true
    }
