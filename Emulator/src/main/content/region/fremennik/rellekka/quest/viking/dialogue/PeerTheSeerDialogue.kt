...
class PeerTheSeerDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            153 -> npcl(FacialExpression.HAPPY, "Greetings to you, brother ${getAttribute(player, "fremennikname", "fremmyname")}! What brings you to see me again?").also { stage++ }
            ...
            155 -> when (buttonId) {
                ...
                2 -> playerl(FacialExpression.HAPPY, "Nothing really, I just stopped by to say hello").also {
                    stage = 160
                }
            }
            ...
            157 -> npcl(FacialExpression.HAPPY, "Here is your prediction: ${PREDICTIONS[prediction]}").also {
                stage = 1000
            }
            ...
            201 -> when (buttonId) {
                ...
                3 -> playerl(FacialExpression.HAPPY, "Nothing really, I just stopped by to say hello").also {
                    stage = 160
                }
            }

            202 -> npcl(FacialExpression.HAPPY, "Of course, ${getAttribute(player, "fremennikname", "fremmyname")}. I am always happy to aid those who have earned the right to wear Fremennik sea boots.").also {
