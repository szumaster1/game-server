package content.region.fremennik.diary.dialogue
...
class YrsaDiaryDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            10 -> player("I've completed all of the medium tasks in my Fremennik", "Achievement Diary.").also { stage++ }
            11 -> {
            ...
            17 -> npc(FacialExpression.NEUTRAL, "Some of the Fremennik diary tasks are simple, some will", "require certain skill levels, and some might require", "quests to be started or completed.").also { stage = 13 }
            ...
            20 -> npc("To claim your Fremennik diary rewards", "speak to Council Workman south of the Rellekka,", "Advisor Ghrim on Miscellania, or myself.").also { stage = 13 }
