package content.region.fremennik.quest.royal
...
class BurntDiaryPages : InteractionListener {
    ...
    companion object {
        ...
        private val PAGE_THREE = arrayOf(
            PageSet(
                Page(
                    BookLine("Property of Armod", 55),
                    BookLine("Brundtson", 56),
