...
class FerdDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc(FacialExpression.OLD_DEFAULT, "Stops them falling down.").also { stage++ }
            4 -> player(FacialExpression.ASKING, "Oh, I see.").also { stage++ }
            5 -> npc(FacialExpression.OLD_NOT_INTERESTED, "Aye.", "If you want to chatter, you'd better talk to ", "Thorodin over there. I'm working.").also { stage++ }
