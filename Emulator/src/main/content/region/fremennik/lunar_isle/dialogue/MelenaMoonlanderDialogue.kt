...
/**
 * Represents the Melena Moonlander dialogue.
 */
@Initializable
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> when (buttonId) {
                ...
                3 -> player(FacialExpression.FRIENDLY, "I'm good thanks, bye.").also { stage = END_DIALOGUE }
            }
            ...
            26 -> player(FacialExpression.SAD, "Sorry.").also { stage = END_DIALOGUE }
        }
        return true
    }
