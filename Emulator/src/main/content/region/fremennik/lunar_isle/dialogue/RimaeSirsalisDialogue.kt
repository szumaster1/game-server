...
/**
 * Represents the Rimae Sirsalis dialogue.
 */
@Initializable
class RimaeSirsalisDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                4 -> player(FacialExpression.FRIENDLY, "I'm good thanks, bye.").also { stage = END_DIALOGUE }
            }
            5 -> npcl(FacialExpression.FRIENDLY, "Most certainly! The hides are great for making clothes and the teeth are particularly useful for broaches, necklaces and the like. But I won't accept them from anyone.").also { stage = END_DIALOGUE }
            ...
            22 -> playerl(FacialExpression.FRIENDLY, "I think I will just have to take your word on that.").also { stage = END_DIALOGUE }
        }
        return true
    }
