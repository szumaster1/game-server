...
class SigmundDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            20 -> {
                npc(FacialExpression.HALF_GUILTY, "I'm the Duke's advisor.")
                stage = 21
            }

            21 -> {
                player(FacialExpression.HALF_GUILTY, "Can you give me any advice then?")
                stage = 22
            }
            ...
            11 -> {
                player(FacialExpression.HALF_GUILTY, "Okay, I might just do that.")
                stage = 12
            }
