package content.region.misthalin.lumbridge.quest.losttribe
 ...
 */
@Initializable
class LostTribe : Quest(QuestName.THE_LOST_TRIBE, 84, 83, 1) {
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        if (stage == 0) {
            ...
            line(player, QuestName.RUNE_MYSTERIES, line++, isQuestComplete(player, QuestName.RUNE_MYSTERIES))
            line(player, QuestName.GOBLIN_DIPLOMACY, line++, isQuestComplete(player, QuestName.GOBLIN_DIPLOMACY))
