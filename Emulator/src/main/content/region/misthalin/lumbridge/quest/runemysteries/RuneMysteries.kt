...
class RuneMysteries: Quest("Rune Mysteries", 27, 26, 1, Vars.VARP_QUEST_RUNE_MYSTERIES_PROGRESS, 0, 1, 6) {
    ...
    override fun finish(player: Player) {
        ...
        player.packetDispatch.sendString("Runecrafting skill", 277, 9 + 2)
        player.packetDispatch.sendString("Air talisman", 277, 10 + 2)
        player.packetDispatch.sendString("You have completed the Rune Mysteries Quest!", 277, 2 + 2)
        player.packetDispatch.sendItemZoomOnInterface(1438, 240, 277, 3 + 2)
    }
