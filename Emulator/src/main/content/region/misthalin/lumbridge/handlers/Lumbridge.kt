...
import content.region.misthalin.lumbridge.basement.CulinaromancerChest
 ...
 */
class Lumbridge : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(Scenery.CHEST_12309, IntType.SCENERY, "buy-items", "buy-food") { player, _ ->
            CulinaromancerChest.openShop(player, food = getUsedOption(player).lowercase() == "buy-food")
            return@on true
        }
