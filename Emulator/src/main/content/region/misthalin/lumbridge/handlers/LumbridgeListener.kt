...
import content.region.misthalin.lumbridge.basement.CulinoChestListener
...
class LumbridgeListener : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(Scenery.CHEST_12309, IntType.SCENERY, "buy-items", "buy-food") { player, _ ->
            CulinoChestListener.openShop(player, food = getUsedOption(player).lowercase() == "buy-food")
            return@on true
        }
