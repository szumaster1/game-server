...
public final class GrandExchangeCutscene extends CutscenePlugin {
    ...
    public GrandExchangeCutscene() {
        this(null);
    }

    public GrandExchangeCutscene(final Player player) {
        super("ge tutorial");
        this.player = player;
    }
    ...
    @Override
    public void open() {
        setAttribute(player, "ge-stage", 0);
        setAttribute(player, "ge-cutscene", this);
    ...
    public ActivityPlugin newInstance(Player p) throws Throwable {
        return new GrandExchangeCutscene(p);
    }
    ...
    /**
     * Represents Brugsen Bursen dialogue.
     */
        ...
        public boolean handle(Player player, Component component, int opcode, int button, int slot, int itemId) {
            switch (component.getId()) {
                case 106:
                    switch (button) {
                        case 145:// next
                            if (player.getAttribute("ge-stage", 0) == 0) {
                                ...
                                setAttribute(player, "ge-stage", 1);
                            } else if (player.getAttribute("ge-stage", 0) == 4) {
                                setAttribute(player, "ge-stage", 5);
                                player.getInterfaceManager().close();
                                player.getDialogueInterpreter().sendDialogues(6522, null, "Selling items is a very much similar process, just that", "you are picking an item you already have.");
                            } else {
                                ...
                                setAttribute(player, "ge-stage", 2);
                    ...
                    break;
                case 108:
                    setAttribute(player, "ge-stage", 4);
                    player.getInterfaceManager().open(MAIN_INTERFACE);
                    for (int i = 0; i < 130; i++) {
                        player.getPacketDispatch().sendInterfaceConfig(106, i, false);
                    }
                ...
                case 110:
                    switch (button) {
                        case 92:
                            setAttribute(player, "ge-stage", 3);
