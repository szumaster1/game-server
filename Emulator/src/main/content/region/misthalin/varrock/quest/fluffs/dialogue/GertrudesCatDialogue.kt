...
class GertrudesCatDialogue(player: Player? = null) : Dialogue(player) {
    ...
    private val BEND_DOWN = Animation.create(Animations.MULTI_USE_BEND_OVER_827)
        ...
        when (stage) {
            ...
            0 -> when (buttonId) {
                1 -> if (quest < 60) {
                    ...
                    player("Oh, it looks like Fluffs has returned.", "I'd better leave her alone.").also { stage =
                        END_DIALOGUE
                    }
                }
                ...
                3 -> {
                    ...
                    GameWorld.Pulser.submit(object : Pulse(7, player) {
                        override fun pulse(): Boolean {
                            end()
                            return true
                        }
