...
class RomeoDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            1 -> when (buttonId) {
                1 -> {
                    player(FacialExpression.HALF_GUILTY, "No sorry. I haven't seen her.")
                    stage = 200
                }
                ...
                2 -> {
                    player(
                        ...
                        "Perhaps I can help find her for you? What does she",
                        "look like?"
                    )
                    stage = 10
                }
            ...
            10 -> {
                npc(
                    FacialExpression.HALF_GUILTY,
                    "Oh would you? That would be great! She has this sort",
                    "of hair..."
                )
                stage = 11
            }
            ...
            11 -> {
                player(FacialExpression.HALF_GUILTY, "Hair...check..")
                stage = 12
            }

            12 -> {
                npc(FacialExpression.HALF_GUILTY, "...and she these...great lips...")
                stage = 13
            }

            13 -> {
                player(FacialExpression.HALF_GUILTY, "Lips...right.")
                stage = 14
            }
            ...
            14 -> {
                npc(
                    FacialExpression.HALF_GUILTY,
                    "Oh and she has these lovley shoulders as well.."
                )
                stage = 15
            }
            ...
            20 -> when (buttonId) {
                1 -> {
                    player(FacialExpression.HALF_GUILTY, "Yes, ok, I'll let her know.")
                    stage = 100
                }
            ...
            100 -> {
                ...
                npc(
                    FacialExpression.HALF_GUILTY,
                    "Oh great! And tell her that I want to kiss her a give."
                )
                stage = 101
            }

            101 -> {
                player(FacialExpression.HALF_GUILTY, "You mean you want to give her a kiss!")
                stage = 102
            }

            102 -> {
                npc(FacialExpression.HALF_GUILTY, "Oh you're good...you are good!")
                stage = 103
            }
            ...
            104 -> {
                npc(FacialExpression.HALF_GUILTY, "Ok, thanks.")
                stage = 106
            }
            ...
            106 -> end()
            200 -> {
                npc(FacialExpression.HALF_GUILTY, "If you do see her please tell me!")
                stage = 201
            }
            ...
            230 -> {
                npc(
                    FacialExpression.HALF_GUILTY,
                    "Please, oh please! Tell me where you have seen my juliet."
                )
                stage = 231
            }

            231 -> {
                player(FacialExpression.HALF_GUILTY, "I found her alone on a balcony!")
                stage = 255
            }
            ...
            301 -> {
                player(
                    FacialExpression.HALF_GUILTY,
                    "Yes, and she gave me a message to give you..."
                )
                stage = 302
            }

            302 -> {
                npc(FacialExpression.HALF_GUILTY, "Ohh great! A message...wow!")
                stage = 303
            }
            ...
            304 -> {
                npc(
                    FacialExpression.HALF_GUILTY,
                    "A message...oh, I can't wait to read what my dear Juliet",
                    "has to say...."
                )
                stage = 305
            }
            ...
            305 -> {
                player(FacialExpression.HALF_GUILTY, "I know...it's exiting isn't it...?")
                stage = 306
            }

            306 -> {
                npc(FacialExpression.HALF_GUILTY, "Yes...yes...")
                stage = 307
            }
            ...
            308 -> {
                npc(FacialExpression.OLD_SNEAKY, "You've lost the message haven't you?")
                stage = 309
            }

            309 -> {
                player(FacialExpression.HALF_GUILTY, "Yep, haven't got a clue where it is.")
                stage = 310
            }
            ...
            415 -> {
                npc(
                    "'Our only hope is that Father Lawrence, our long time",
                    "confidant, can help us in some way.'"
                )
                stage = 416
            }
            ...
            419 -> {
                npc(
                    "...our love is over...the great romance, the life of my",
                    "love..."
                )
                stage = 420
            }
            ...
            562 -> {
                npc(
                    "I just wish I could remember what he looks like! I live",
                    "in fear of every man I see!"
                )
                stage = 563
            }
            ...
            240 -> {
                npc(
                    "Oh...is he the one who mixes up all them magical potion-",
                    "ey things?"
                )
                stage = 241
            }
            ...
            329 -> {
                npc(
                    "All I can say is I'll be glad when Juliet's finally in that",
                    "crypt!"
                )
                stage = 330
            }
            ...
            75 -> {
                player(
                    "Oh, ok...come on! I think I saw the entrance when I",
                    "visited there last..."
                )
                stage = 76
            }
            ...
            456 -> {
                npc(
                    "Her cousin and I are getting on well though. Thanks",
                    "for your help."
                )
                stage = 457
            }
            ...
            742 -> {
                ...
                val speed = 55
                val other = 1
                pos = CameraContext(player, CameraType.POSITION, x + 3, y + 4, height, other, speed)
                rot = CameraContext(player, CameraType.ROTATION, x - 1, y - 2, height, other, speed)
                ...
                Pulser.submit(object : Pulse(5) {
                    override fun pulse(): Boolean {
                        ...
                        val speed = 100
                        val other = 1
                        pos = CameraContext(player, CameraType.POSITION, x - 5, y - 4, height, other, speed)
                        rot = CameraContext(player, CameraType.ROTATION, x + 2, y, height, other, speed)
                        PacketRepository.send(CameraViewPacket::class.java, pos)
                        PacketRepository.send(CameraViewPacket::class.java, rot)
                        interpreter.sendDialogues(player,FacialExpression.HALF_GUILTY,"You go over to her...and I'll go and wait over here..."
                        )
                        stage = 743
                        return true
                    }
            ...
            744 -> {
                ...
                val speed = 100
                val other = 1
                val pos = CameraContext(player, CameraType.POSITION, x, y - 1, height, other, speed)
                val rot = CameraContext(player, CameraType.ROTATION, x + 20, y + 50, height, other, speed)
                PacketRepository.send(CameraViewPacket::class.java, pos)
                PacketRepository.send(CameraViewPacket::class.java, rot)
                close()
            ...
            747 -> {
                interpreter.sendDialogues(phill!!,FacialExpression.HALF_GUILTY, "Hi Romeo...I'm Phillipa!")
                stage = 748
            }
            ...
            749 -> {
                interpreter.sendDialogues(phill!!,FacialExpression.HALF_GUILTY,"It's a shame about Juliet...but perhaps we can meet up",
                    "later?"
                )
                stage = 750
            }
        ...
        when (quest.getStage(player)) {
            0 -> {
                npc(
                    ...
                    "Have you seen my Juliet?"
                )
                stage = 0
            }

            10 -> {
                npc(FacialExpression.HALF_GUILTY, "Go and speak with Juliet!")
                stage = 457
            }
            ...
            30 -> {
                player(FacialExpression.HALF_GUILTY, "Hey again Romeo!")
                stage = 800
            }
