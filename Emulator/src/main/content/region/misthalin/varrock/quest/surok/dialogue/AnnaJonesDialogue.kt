...
class AnnaJonesDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        when (getQuestStage(player, QuestName.WHAT_LIES_BELOW)) {
            ...
            40 -> if (args.size >= 2) {
                ...
                if (args.size >= 2) {
                    npc("Excuse me. I am working on that statue at the moment", "Please don't touch it.").also { stage = 12 }
                } else {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            30 -> when (stage) {
                0 -> if (!inInventory(player, Items.BRONZE_PICKAXE_1265, 1)) {
                ...
                1 -> npc("My employer, Surok Magis, sent word to me that you", "may come to use the tunnel. You will need something to", "help you get in there. The pickaxe will help.").also { stage++ }
                2 -> player("Uh, thanks.").also { stage++ }
                3 -> npc("Okay, then. The tunnel awaits...").also { stage++ }
                4 -> options("What tunnel?", "Sorry, who are you?", "Who does this statue represent?", "What are you doing here?", "Okay, I'd better go.").also { stage++ }
                5 -> when (buttonId) {
                ...
                6 -> npc("Why, the Chaos Tunnel of course! I imagine Surok will", "have told you of it.").also { stage = END_DIALOGUE }
                7 -> npc("My name is Louisiana Jones, although most people", "call me Anna. I'm an archaeologist.").also { stage = END_DIALOGUE }
                8 -> npc("That, my dear, is the statue of the great god Saradomin", "himself. Stand and admire in awe for you are in the", "presence of greatness!").also { stage = END_DIALOGUE }
                9 -> npc("Well story and rumour has it that Dagon'hai built a", "tunnel under this statue of Saradomin that would allow", "them to visit the Chaos Altar without having to go", "through the Wilderness.").also { stage = END_DIALOGUE }
            }
            ...
            40 -> when (stage) {
                ...
                0 -> options("Who are you?", "What are you doing here?", "Who does this statue represent?", "Okay, I'd better go.").also { stage++ }
                1 -> when (buttonId) {
                ...
                2 -> npc("Well, now. Do you always go around asking about people", "like that? It's very rude, you know.").also { stage++ }
                3 -> player("Sorry! I didn't mean to pry!").also { stage++ }
                4 -> npc("That's alright. My name is Louisiana Jones, although", "most people call me Anna. I'm an archaeologist.").also { stage++ }
                5 -> player("Oh. Do you work for the Varrock Museum?").also { stage++ }
                6 -> npc("Hah! No. I used to, but now I prefer to work", "freelance for independent employers.").also { stage++ }
                ...
                15 -> npc("When I decide to start working again. Right now, I'm", "enjoying sitting on this bench.").also { stage = END_DIALOGUE }
            }
        }
        return true
    }
