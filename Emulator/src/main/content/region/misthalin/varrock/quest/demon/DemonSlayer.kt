...
class DemonSlayer : Quest("Demon Slayer", 16, 15, 3, Vars.VARP_QUEST_DEMON_SLAYER_PROGRESS, 0, 1, 3) {
    ...
    override fun newInstance(`object`: Any?): Quest {
        PluginManager.definePlugins(DemonSlayerPlugin(), DemonSlayerDrainPlugin(), DemonSlayerCutscene(), WallyCutscenePlugin(), GypsyArisDialogue(), SirPyrsinDialogue(), TraibornDialogue(), CaptainRovinDialogue())
        return this
    }
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        when (getStage(player)) {
            ...
            10 -> {
                ...
                line(player, "I should ask !!Sir Prysin?? in !!Varrock Palace?? where it is.", line++, true)
            }
            ...
            30 -> {
                ...
                line(player, "Now I should go to the stone circle south of the city and", line++, true)
                line(player, "destroy !!Delrith?? using !!Silverlight??!", line++, true)
            }
            ...
            100 -> {
                ...
                line++
                line(player, "<col=FF0000>QUEST COMPLETE!", line++, true)
            }
        }
    }
