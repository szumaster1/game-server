package content.region.misthalin.varrock.quest.soulbane.dialogue
...
class LaunaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            17 -> npc(FacialExpression.ANGRY, "How could you say such a thing? Get away from me!").also { stage = END_DIALOGUE }
