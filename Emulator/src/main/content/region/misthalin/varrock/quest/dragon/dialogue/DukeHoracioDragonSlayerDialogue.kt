    ...
    override fun handle(componentID: Int, buttonID: Int) {
        if (questStage in 20..99 && !hasShield(player!!)) {
            when (stage) {
                ...
                7 -> npc("Back in my father's day, Crandor was an important", "city-state. Politically, it was important as Falador or", "Varrock and its ships traded with every port.").also { stage++ }
                8 -> npc("But, one day when I was little, all contact was lost. The", "trading ships and diplomatic envoys just stopped", "coming.").also { stage++ }
                9 -> npc("I remember my father being very scared. He posted", "lookouts on the roof to warn if the dragon was", "approaching. All the city rulers worried that", "Elvarg would devastate the whole continent.").also { stage++ }
