package content.region.misthalin.varrock.digsite.quest.itexam.dialogue
...
class PanningGuideDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        b.onPredicate { getAttribute(player!!, TheDigSite.attributePanningGuideTea, false) }
            ...
            .npcl(
                FacialExpression.FRIENDLY,
                "Let me explain how panning works. First, you need a panning tray. Use the tray in the panning points in the water and then search your tray."
            )
            ...
            .let { optionBuilder ->
                optionBuilder.option_playerl("Can you tell me more about the tools an archaeologist uses?")
                    .npcl(
                        FacialExpression.FRIENDLY,
                        "Of course! Let's see now... Rock picks are for splitting rocks or scraping away soil; you can get one from a cupboard in the Exam Centre."
                    )
                    .playerl(FacialExpression.FRIENDLY, "What about sample jars?")
                    .npcl(
                        FacialExpression.FRIENDLY,
                        "I think you'll find them scattered about pretty much everywhere, but I know you can get one from a cupboard somewhere in the Exam Centre, just like the rock pick!"
                    )
                    .playerl(FacialExpression.FRIENDLY, "Okay, what about a specimen brush?")
                    .npcl(
                        FacialExpression.FRIENDLY,
                        "We have a bit of a shortage of those at the moment. You could try borrowing one from a workman on the site... but I don't think they'd give it willingly."
                    )
                    .playerl(
                        FacialExpression.FRIENDLY,
                        "Sounds like I'll need to be sneaky to get one of those, then... Okay - trowel?"
                    )
                    .npcl(
                        FacialExpression.FRIENDLY,
                        "Ahh... that you must earn by passing your exams! The examiner holds those."
                    )
                    .playerl(FacialExpression.FRIENDLY, "Anything else?")
                    .npcl(
                        FacialExpression.FRIENDLY,
                        "If you need something identified or are not sure about something, give it to the archaeological expert in the Exam Centre."
                    )
        ...
        b.onPredicate { _ -> true }
            ...
            .npcl(
                FacialExpression.FRIENDLY,
                "Hello, I am the panning guide. I teach students how to pan in these waters. They're not permitted to do so until after they've had training and, of course, they must be invited to pan here too."
            )
            ...
            .let { branch ->
                branch.onValue(0)
                    ...
                    .npcl(
                        FacialExpression.FRIENDLY,
                        "If you could bring me one of those, I would be more than willing to let you pan here. I usually get some from the main campus building, but I'm busy at the moment."
                    )
                    .end()
                branch.onValue(1)
