package content.region.misthalin.varrock.digsite.dialogue

import content.region.misthalin.varrock.digsite.quest.itexam.TheDigSite
import core.api.*
...
class ExaminerDialogueFile : DialogueBuilderFile() {
    ...
    override fun create(b: DialogueBuilder) {
        ...
        b.onQuestStages("The Dig Site", 100)
        ...
        b.onQuestStages("The Dig Site", 6,7,8,9,10,11,12)
                .npcl(FacialExpression.FRIENDLY, "Well, what are you doing here? Get digging!")

        b.onQuestStages("The Dig Site", 5)
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Samples may be mixed together safely.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrPurpleExam3ObtainAnswer, false) }
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Brush quickly using a wet brush.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrGreenExam3ObtainAnswer, false) }
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Bones must not be taken from the site.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrBrownExam3ObtainAnswer, false) }
...
//                                addItemOrDrop(player, Items.SPECIMEN_BRUSH_670)
                            ...
                            .endWith { _, player ->
                                if(getQuestStage(player, "The Dig Site") == 5) {
        ...
        b.onQuestStages("The Dig Site", 4)
                .playerl(FacialExpression.FRIENDLY, "Hello.")
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Samples cut and cleaned before transportation.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrBrownExam2ObtainAnswer, false) }
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Finds must not be handled by anyone.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrPurpleExam2ObtainAnswer, false) }
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Strike rock repeatedly until powdered.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrGreenExam2ObtainAnswer, false) }
                ...
                .let { branch ->
                    ...
                    branch.onValue(3)
                            ...
                            .endWith { _, player ->
                                if(getQuestStage(player, "The Dig Site") == 4) {
        ...
        b.onQuestStages("The Dig Site", 1,2,3)
                // This is kinda messy due to the dialogue being reused in different stages.
                .branch { player ->
                    if (getQuestStage(player, "The Dig Site") == 2 && !inInventory(player, Items.SEALED_LETTER_683)){
                        return@branch 1 // Reuse quest stage 1 if sealed letter is not in inventory.
                    }
                    return@branch getQuestStage(player, "The Dig Site")
                }
                .let{ branch ->
                    val continuePath = b.placeholder()
                    branch.onValue(1)
                    ...
                    branch.onValue(2)
                            ...
                            .betweenStage { _, player, _, _ ->
                                ...
                                if(getQuestStage(player, "The Dig Site") == 2) {
                                    setQuestStage(player, "The Dig Site", 3)
                                }
                            }
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("The study of gardening, planing and fruiting vegetation.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrGreenExam1ObtainAnswer, false) }
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Magic users, miners and their escorts.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrBrownExam1ObtainAnswer, false) }
                ...
                .options().let { optionBuilder ->
                    ...
                    optionBuilder.optionIf("Heat-resistant clothing to be worn at all times.") {
                        player -> return@optionIf !getAttribute(player, TheDigSite.attrPurpleExam1ObtainAnswer, false) }
        ...
        b.onPredicate { _ -> true }
                ...
                .options().let { optionBuilder ->
                    optionBuilder.option_playerl("Can I take an exam?")
                            ...
                            .endWith { _, player ->
                                if(getQuestStage(player, "The Dig Site") == 0) {
