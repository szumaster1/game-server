package content.region.misc.quest.zep.dialogue

import content.region.misc.quest.zep.cutscene.FirstExperimentCutscene
import content.region.misc.quest.zep.cutscene.SecondExperimentCutscene
import core.api.*
        ...
        when (getQuestStage(player, "Enlightened Journey")) {
            ...
            1 -> when (stage) {
                ...
                3 -> when (buttonID) {
                    ...
                    2 -> playerl(FacialExpression.FRIENDLY, "Err, no. I can't see that kind of detail.").also {
                        stage = 4
                    }
                }
            ...
            7 -> when (stage) {
                ...
                6 -> if (!hasSapling && !removeItem(player, Item(Items.COINS_995, 30000))) {
                    ...
                    npcl(FacialExpression.FRIENDLY, "You already have one! Don't be greedy.").also {
                        stage = END_DIALOGUE
                    }
                }
