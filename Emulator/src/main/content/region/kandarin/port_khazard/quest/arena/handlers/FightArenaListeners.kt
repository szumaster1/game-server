    ...
    override fun defineListeners() {
        ...
        on(FULL_ARMOR_STAND, IntType.SCENERY, "borrow") { player, _ ->
            if (getQuestStage(player, "Fight Arena") >= 10 && !allInEquipment(player,
                ...
                replaceScenery(
                    FULL_ARMOR_STAND_1!!.asScenery(),
                    EMPTY_STAND, 10, location(2619, 3196, 0))
                ...
                replaceScenery(
                    FULL_ARMOR_STAND_1!!.asScenery(),
                    ONLY_HELM_STAND, 10, location(2619, 3196, 0))
                addItem(player, ARMOR, 1)
                ...
                replaceScenery(
                    FULL_ARMOR_STAND_1!!.asScenery(),
                    ONLY_ARMOR_STAND, 10, location(2619, 3196, 0))
                addItem(player, HELMET, 1)
        ...
        onUseWith(IntType.SCENERY,
            ...
            if (getQuestStage(player, "Fight Arena") == 88) {
                ...
                content.region.kandarin.port_khazard.quest.arena.cutscene.JeremyRescueCutscene(player).start()
            }
