...
/**
 * Represents the Mourner headquarters dialogue (Biohazard quest).
 */
class MournerHeadquartersDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when(stage){
            ...
            /*
             * Plague City Quest dialogue.
             */

            1 -> npcl(FacialExpression.SAD, "What are you up to?").also { stage++ }
            2 -> playerl(FacialExpression.NEUTRAL, "Just sight-seeing.").also { stage++ }
            3 -> npcl(FacialExpression.FRIENDLY, "This is no place for sight-seeing. Don't you know there's been a plague outbreak?").also { stage++ }
            4 -> playerl(FacialExpression.FRIENDLY, "Yes, I had heard.").also { stage++ }
            5 -> npcl(FacialExpression.FRIENDLY, "Then I suggest you leave as soon as you can.").also { stage++ }
            6 -> playerl(FacialExpression.FRIENDLY, "Thanks for the advice.").also { stage = END_DIALOGUE }

            /*
             * Biohazard Quest dialogue.
             */

            100 -> if (npc!!.id == NPCs.MOURNER_370) {
                npc("You're here at last! I don't know what I've", "eaten but I feel like I'm on death's door.").also { stage = 104 }
            } else {
            ...
            106 -> options("Just hold your breath and count to ten.", "The best I can do is pray for you.", "There's nothing I can do, it's fatal.").also { stage++ }
            107 -> when (buttonID) {
