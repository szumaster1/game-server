    ...
    override fun defineListeners() {
        ...
        onUseWith(IntType.SCENERY, Items.RAT_POISON_24, Scenery.FOOD_TROUGH_40) { player, _, _ ->
            ...
            if (removeItem(player, Items.RAT_POISON_24)) {
                ...
                setAttribute(player, ClockTower.RATS_POISONED_ATTR, true)
                runTask(player, 1) {
        ...
        on(Scenery.GATE_39, IntType.SCENERY, "go-through") { player, node ->
            if (getAttribute(player, ClockTower.RATS_POISONED_ATTR, false)) {
                ...
                setAttribute(player, ClockTower.ASK_ABOUT_RATS_ATTR, true)
            }
            return@on true
        }
        ...
        on(Items.BLACK_COG_21, IntType.GROUNDITEM, "take") { player, groundItem ->
            ...
            if (hasSpaceFor(player, Item(Items.BLACK_COG_21)) && getAttribute(player,
                    ClockTower.BLACK_COG_COOLED_ATTR, false)) {
            ...
            if (hasSpaceFor(player, Item(Items.BLACK_COG_21)) && (inInventory(player, Items.BUCKET_OF_WATER_1929, 1) || inEquipment(player, Items.ICE_GLOVES_1580)) && !getAttribute(player,
                    ClockTower.BLACK_COG_COOLED_ATTR, false)) {
