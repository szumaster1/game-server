        ...
        when (questStage) {
            0 -> {
                when (stage) {
                    ...
                    2 -> options("Why can't you sleep, what's wrong?", "Sorry! I'm too busy to hear your problems!").also { stage++ }
                    3 -> when (buttonID) {
                    ...
                    8 -> options("Can I help at all?", "I'm sorry to hear that! I hope you find his blanket.").also { stage++ }
                    9 -> when (buttonID) {
            ...
            20 -> {
                when (stage) {
                    ...
                    40 -> options("I've no time for that, sorry.", "Where should I look?", "Can I come to the party?").also { stage++ }
                    41 -> when (buttonID) {
