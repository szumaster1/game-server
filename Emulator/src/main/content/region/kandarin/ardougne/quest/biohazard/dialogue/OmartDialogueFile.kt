        ...
        when {
            (questStage in 2..3) -> {
                when (stage) {
                    ...
                    5 -> npc("Try asking Jerico, if he's not too busy with his pigeons.", "I'll be waiting here for you.").also { stage++ }
                    6 -> end()
                }
            }
            ...
            (questStage == 4) -> {
                when (stage) {
                    0 -> {
                        npc("Well done, the guards are having real trouble with those", "birds. You must go now traveller, it's your only chance.")
                    ...
                    5 -> npc("Don't take too long, those mourners will soon be", "rid of those birds.").also {
                        stage = END_DIALOGUE
                    }
                    6 -> {
                        end()
            ...
            (questStage in 4..99) -> {
                when (stage) {
                    ...
                    1 -> npc("Hello traveller. The guards are still distracted", "if you wish to cross the wall.").also { stage++ }
                    2 -> options("Ok, lets do it.", "I'll be back soon.").also { stage++ }
                    3 -> when (buttonID) {
                        1 -> player("Ok, lets do it.").also { stage = 5 }
                        2 -> player("I'll be back soon.").also { stage++ }
                    }
                    4 -> npc("Don't take too long, those mourners will soon be", "rid of those birds.").also { stage = END_DIALOGUE }
                    5 -> {
                        end()
                        sendMessage(player!!, "You climb up the rope ladder...")
                        runTask(player!!, 2) {
