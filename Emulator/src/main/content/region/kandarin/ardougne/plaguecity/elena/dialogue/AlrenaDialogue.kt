...
import content.region.kandarin.ardougne.plaguecity.elena.PlagueCityListeners
...
class AlrenaDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (getQuestStage(player, "Plague City") == 1) {
            playerl(FacialExpression.FRIENDLY, "Hello, Edmond has asked me to help find your daughter.")
        } else {
            playerl(FacialExpression.FRIENDLY, "Hello Madam.")
        }
        return true
    }
    ...
    override fun handle(componentID: Int, buttonID: Int): Boolean {
        when (getQuestStage(player!!, "Plague City")) {
            ...
            0 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.NEUTRAL, "Oh, hello there.").also { stage = 2 }
            ...
            1 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.NEUTRAL, "Yes he told me. I've begun making your special gas mask, but I need some dwellberries to finish it.").also { stage = 2 }
            ...
            2 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.FRIENDLY, "Hello darling, I think Edmond had a good idea of how to get into West Ardougne, you should hear his idea.").also { stage = 2 }
            ...
            4 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.FRIENDLY, "Hi, have you managed to get through to West Ardougne?").also { stage = 2 }
            ...
            5 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.FRIENDLY, "Hello, any word on Elena?").also { stage = 2 }
            ...
            99 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.NEUTRAL, "Thank you, thank you! Elena beat you back by minutes.").also { stage = END_DIALOGUE }
            }

            100 -> when (stage) {
                START_DIALOGUE -> npcl(FacialExpression.FRIENDLY, "Thank you for rescuing my daughter! Elena has told me of your bravery in entering a house that could have been plague infected. I can't thank you enough!").also { stage = END_DIALOGUE }
            }
        }
        return true
    }
