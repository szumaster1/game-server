    ...
    class ChestPulse(val player: Player, val isLoot: Boolean, val chest: Scenery) : Pulse() {
        ...
        enum class Rewards(val id: Int, val type: Type, val message: String) {
            BONES(
                id = Items.BONES_2530,
                type = Type.ITEM,
                message = "Oh! Some bones. Delightful."
            ),
            EMERALD(
                id = Items.EMERALD_1605,
                type = Type.ITEM,
                message = "Ooh! A lovely emerald!"
            ),
            ROTTEN_APPLE(
            ...
            CHAOS_DWARF(
                id = NPCs.CHAOS_DWARF_119,
                type = Type.NPC,
                message = "You've gotta be kidding me, a dwarf?!"
            ),
            RAT(
                id = NPCs.RAT_47,
                type = Type.NPC,
