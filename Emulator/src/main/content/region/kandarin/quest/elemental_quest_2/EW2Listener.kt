package content.region.kandarin.quest.elemental_quest_2
...
class EW2Listener : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(Items.SPELL_SCROLL_2396, IntType.ITEM, "read") { player, _ ->
            ...
            setQuestStage(player, "Elemental Workshop II", 3)
            return@on true
        }
        ...
        on(Scenery.BOOKCASE_17382, IntType.SCENERY, "search") { player, _ ->
            if (isQuestComplete(player, "Elemental Workshop I")
                ...
                setQuestStage(player, "Elemental Workshop II", 1)
        ...
        on(Scenery.MACHINERY_18594, IntType.SCENERY, "search") { player, _ ->
            ...
            setQuestStage(player, "Elemental Workshop II", 4)
        ...
        onUseWith(IntType.SCENERY, Items.KEY_9722, Scenery.HATCH_18595) { player, _, _ ->
            ...
            setQuestStage(player, "Elemental Workshop II", 5)
        ...
        on(EW2Utils.LeftLever, IntType.SCENERY, "pull") { player, _ ->
            ...
            if (player.getAttribute(EW2Utils.PullSupport, true)) {
                SceneryBuilder.add(core.game.node.scenery.Scenery(EW2Utils.BrokenCraneUp, location(1954, 5145, 2)))
                //core.game.node.scenery.Scenery(BrokenCraneUp, Location(1954, 5145, 2)),-1)
                //addScenery(BrokenCraneUp, Location.create(1954, 5145, 2))
        ...
        on(EW2Utils.NorthLever, IntType.SCENERY, "pull") { player, _ ->
            ...
            if (getAttribute(player, "ew2:door-lock-cart", false)) {
                ...
                SceneryBuilder.add(core.game.node.scenery.Scenery(EW2Utils.PipingDoorOpen, location(1953, 5163, 2)))
        ...
        on(EW2Utils.WaterValveLeft, IntType.SCENERY, "turn") { player, _ ->
            ...
            if (player.getAttribute(EW2Utils.FillingWaterTank, false) == true) {
                runTask(player, 3) {
                    SceneryBuilder.add(core.game.node.scenery.Scenery(18660, location(1951, 5164, 2)))
                ...
                runTask(player, 3) {
                    SceneryBuilder.add(core.game.node.scenery.Scenery(18661, location(1951, 5164, 2)))
