...
class FightArena : Quest(QuestName.FIGHT_ARENA, 61, 60, 2, Vars.VARP_QUEST_FIGHT_ARENA_PROGRESS, 0, 1, 14) {
     ...
     * The prosperous Servil family have been abducted by the infamous General Khazard.
     * He plans to have the family battle for his entertainment in the Fight Arena.
     * Can you rescue the Servils before the tyrant has these innocent (not to mention wealthy)
     * civilians slain?
     */
