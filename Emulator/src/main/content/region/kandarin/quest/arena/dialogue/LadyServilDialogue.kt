...
class LadyServilDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun open(vararg args: Any?): Boolean {
        ...
        if (getQuestStage(player, QuestName.FIGHT_ARENA) == 10) {
            playerl(FacialExpression.FRIENDLY, "Hello Lady Servil.")
        } else if (getQuestStage(player, QuestName.FIGHT_ARENA) == 30) {
            playerl(FacialExpression.FRIENDLY, "Lady Servil, I have managed to infiltrate General Khazard's arena.")
        } else if (getQuestStage(player, QuestName.FIGHT_ARENA) == 70) {
        ...
        when (getQuestStage(player!!, QuestName.FIGHT_ARENA)) {
            0 -> when (stage) {
                ...
                9 -> {
                    ...
                    setQuestStage(player!!, QuestName.FIGHT_ARENA, 10)
            ...
            99 -> when (stage) {
                ...
                3 -> {
                    ...
                    finishQuest(player, QuestName.FIGHT_ARENA)
                }
            }
