        ...
        when (stage) {
            0 -> {
                if (isQuestComplete(player!!, QuestName.HOLY_GRAIL)) {
                    ...
                    stage = 20
                } else if (getQuestStage(player!!, QuestName.HOLY_GRAIL) >= 50 && player!!.hasItem(Item(Items.HOLY_GRAIL_19, 1))) {
            ...
            1 -> npcl(FacialExpression.NEUTRAL, "Ah yes... the Holy Grail...").also {
                if (getQuestStage(player!!, QuestName.HOLY_GRAIL) >= 10) {
                    setQuestStage(player!!, QuestName.HOLY_GRAIL, 20)
                }
                stage++
            }
