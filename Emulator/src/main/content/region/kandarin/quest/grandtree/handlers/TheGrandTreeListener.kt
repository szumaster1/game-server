...
class TheGrandTreeListener : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(TheGrandTreeUtils.INVASION_PLANS_SCROLL, IntType.ITEM, "read") { player, _ ->
            ScrollInterface.scrollSetup(player, Components.MESSAGESCROLL_220, TheGrandTreeUtils.INVASION_PLANS_SCROLL_CONTENT)
            return@on true
        }
        ...
        on(32319, IntType.SCENERY, "search") { player, node ->
            ...
            if (node.location == TheGrandTreeUtils.ROOTS_LOCATION[getAttribute(player, TheGrandTreeUtils.DRACONIA_ROCK, 1)]) {
