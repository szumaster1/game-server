 ...
 */
@Initializable
class CharlieGTDialogue(player: Player? = null) : Dialogue(player) {
            ...
            46 -> {
                when (stage) {
                    ...
                    10 -> npcl(FacialExpression.FRIENDLY, "Good luck!").also {
                        setQuestStage(player!!, QuestName.THE_GRAND_TREE, 47)
                        stage = END_DIALOGUE
                    }
                }
            }
                        ...
                        GameWorld.Pulser.submit(object : Pulse(0) {
                            ...
                            override fun pulse(): Boolean {
                                when (count) {
                                    ...
                                    2 -> {
                                        sendNPCDialogue(player!!, npc.id, "Traveller please accept my apologies! Glough had no right to arrest you! I just think he's scared of humans. Let me get you out of there.", FacialExpression.OLD_DEFAULT)
                                    }
                                    ...
                                    8 -> {
                                        unlock(player!!)
                                        npc.clear()
                                        setQuestStage(player!!, QuestName.THE_GRAND_TREE, 55)
                                        return true
                                    }
                                }
                                count++
