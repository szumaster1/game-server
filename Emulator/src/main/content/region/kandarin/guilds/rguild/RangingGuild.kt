package content.region.kandarin.guilds.rguild
 ...
 */
class RangingGuild : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(TARGET, IntType.SCENERY, "fire-at") { player, node ->
            ...
            if (!inInventory(player, Items.BRONZE_ARROW_882) || player.equipment[EquipmentContainer.SLOT_WEAPON] == null || (!player.equipment[EquipmentContainer.SLOT_WEAPON].definition.name.lowercase().contains("shortbow", true) && !player.equipment[EquipmentContainer.SLOT_WEAPON].definition.name.lowercase().contains("longbow", true))) {
