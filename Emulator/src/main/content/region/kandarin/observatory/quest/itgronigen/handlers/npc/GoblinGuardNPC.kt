package content.region.kandarin.observatory.quest.itgronigen.handlers.npc
...
class GoblinGuardNPC(id: Int = 0, location: Location? = null) : AbstractNPC(id, location) {
    ...
    companion object {
        fun spawnGoblinGuard(player: Player) {
            ...
            guard.isActive = true
            GameWorld.Pulser.submit(object : Pulse(0, guard) {
    ...
    override fun finalizeDeath(killer: Entity?) {
        if(killer is Player) {
            setQuestStage(killer, "Observatory Quest", 10)
