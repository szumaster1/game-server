package content.region.asgarnia.goblinvillage.quest.dorics.dialogue
...
class DoricDialogue(private val questStage: Int) : DialogueFile() {
    ...
    private fun handleQuestStartDialogue(player: Player?, isWhetstone: Boolean) {
        ...
        when (stage) {
            ...
            30 -> showTopics(Topic(FacialExpression.FRIENDLY, "Yes I will get you the materials.", 40), Topic(FacialExpression.HALF_GUILTY, "No, hitting rocks is for the boring people, sorry.", 100))
    ...
    private fun handleGiveDoricItemsDialogue(player: Player?) {
        ...
        when (stage) {
            ...
            2 -> npcl(FacialExpression.OLD_NORMAL,"Many thanks. Pass them here, please. I can spare you some coins for your trouble, and please use my anvils any time you want.").also { stage++ }
            3 -> {
            ...
            51 -> showTopics(Topic(FacialExpression.HALF_ASKING, "Where can I find those?", 52), Topic(FacialExpression.HAPPY, "Certainly, I'll be right back.", END_DIALOGUE))
