...
class SirReniteeDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            100 -> npc(FacialExpression.HALF_GUILTY, "Hmm, well, mmm, do you have a family crest? I keep", "track of every " + Configuration.SERVER_NAME + " family, you know, so I might", "be able to find yours.").also { stage = 110 }
