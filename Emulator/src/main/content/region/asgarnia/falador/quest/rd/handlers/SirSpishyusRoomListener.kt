...
class SirSpishyusRoomListener : InteractionListener {
    ...
    companion object {
        ...
        private fun checkFinished(player: Player) {
            if (getVarbit(player, RecruitmentDriveUtils.VARBIT_FOX_WEST) == 1 &&
                getVarbit(player, RecruitmentDriveUtils.VARBIT_CHICKEN_WEST) == 1 &&
                getVarbit(player, RecruitmentDriveUtils.VARBIT_GRAIN_WEST) == 1
            ) {
        ...
        private fun checkFail(player: Player): Boolean {
            val eastStatus = listOf(
                getVarbit(player, RecruitmentDriveUtils.VARBIT_FOX_EAST),
                getVarbit(player, RecruitmentDriveUtils.VARBIT_CHICKEN_EAST),
                getVarbit(player, RecruitmentDriveUtils.VARBIT_GRAIN_EAST)
            )
            val westStatus = listOf(
                getVarbit(player, RecruitmentDriveUtils.VARBIT_FOX_WEST),
                getVarbit(player, RecruitmentDriveUtils.VARBIT_CHICKEN_WEST),
                getVarbit(player, RecruitmentDriveUtils.VARBIT_GRAIN_WEST)
            )
    ...
    override fun defineListeners() {
        ...
        on(Scenery.GRAIN_7284, SCENERY, "pick-up") { player, _ ->
            ...
            if (EAST_BORDERS.insideBorder(player)) {
                ...
                setVarbit(player, RecruitmentDriveUtils.VARBIT_GRAIN_EAST, 1)
            }
        ...
        onUnequip(Items.GRAIN_5607) { player, _ ->
            ...
            if (WEST_BORDERS.insideBorder(player)) {
                removeItem(player, Items.GRAIN_5607, Container.EQUIPMENT)
                setVarbit(player, RecruitmentDriveUtils.VARBIT_GRAIN_WEST, 1)
        ...
        on(Scenery.FOX_7277, SCENERY, "pick-up") { player, _ ->
            ...
            if (EAST_BORDERS.insideBorder(player)) {
                ...
                setVarbit(player, RecruitmentDriveUtils.VARBIT_FOX_EAST, 1)
            }
            if (WEST_BORDERS.insideBorder(player)) {
                player.equipment.add(item, 3, true, false)
        ...
        onUnequip(Items.FOX_5608) { player, _ ->
            ...
            if (WEST_BORDERS.insideBorder(player)) {
                removeItem(player, Items.FOX_5608, Container.EQUIPMENT)
                setVarbit(player, RecruitmentDriveUtils.VARBIT_FOX_WEST, 1)
                checkFinished(player)
            }
            return@onUnequip true
        }
        ...
        on(Scenery.CHICKEN_7281, IntType.SCENERY, "pick-up") { player, _ ->
            ...
            if (EAST_BORDERS.insideBorder(player)) {
                ...
                setVarbit(player, RecruitmentDriveUtils.VARBIT_CHICKEN_EAST, 1)
            }
            if (WEST_BORDERS.insideBorder(player)) {
                player.equipment.add(item, 5, true, false)
        ...
        onUnequip(Items.CHICKEN_5609) { player, _ ->
            ...
            if (WEST_BORDERS.insideBorder(player)) {
                removeItem(player, Items.CHICKEN_5609, Container.EQUIPMENT)
                setVarbit(player, RecruitmentDriveUtils.VARBIT_CHICKEN_WEST, 1)
                checkFinished(player)
            }
            return@onUnequip true
        }
