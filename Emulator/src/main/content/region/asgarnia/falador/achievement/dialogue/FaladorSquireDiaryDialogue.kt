package content.region.asgarnia.falador.achievement.dialogue
...
class FaladorSquireDiaryDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            111 -> npc("If you manage to complete a particular set of tasks,", "you will be rewarded for your explorative efforts.").also { stage++ }
            112 -> npc("You can access your Achievement Diary by going to", "the Quest Journal, then clicking on the green star icon", "in the top-right hand corner.").also { stage = 105 }
            120 -> npc("Ah, well there are different rewards for each", "Achievement Diary. For completing each stage of the", "Falador diary, you are presented with a Falador shield.").also { stage++ }
            121 -> npc("There are three shields available, one for each difficulty", "level.").also { stage++ }
            122 -> npc("When you are presented with your rewards, you will", "be told of their uses.").also { stage = 105 }
            130 -> npc("You need to complete all of the tasks in a particular", "difficulty, then you can claim your reward.").also { stage++ }
            131 -> npc("Some of Falador's tasks are simple, some will require", "certain skill levels, and some might require quests to be", "started or completed.").also { stage++ }
            132 -> npc("To claim your Falador Achievement Diary rewards,", "speak to Redbeard the Pirate in Port Sarim, The Chemist", "in Rimmington, or myself.").also { stage = 105 }
            150 -> npc("This is the final stage of the Falador shield: a tower", "shield. It grants you all the benefits fo the buckler", "and kiteshield did, full Prayer restore, and access to", "some interesting new seeds that my friend Wyson has").also { stage++ }
            151 -> npc("found.").also { stage++ }
            152 -> npc("As before, Prayer restore can only be used once per", "day, but this time it restores all of your Prayer points!").also { stage++ }
            153 -> npc("The new seeds I mentioned were discovered by Wyson,", "who can be found in Falador Park. He'll give you some", "new seeds in return for the skin of the giant mole", "beneath Falador Park..").also { stage++ }
            ...
            205 -> npc("As before, Prayer restore can only be used once per", "day, but this time it restores all of your Prayer points!").also { stage++ }
            206 -> npc("The new seeds I mentioned were discovered by Wyson,", "who can be found in Falador Park. He'll give you some", "new seeds in return for the skin of the giant mole", "beneath Falador Park..").also { stage++ }
            207 -> npc("He'll only offer them to you if you're wielding the", "Falador shield, though.").also { stage++ }
            208 -> npc("As well as all these features, the shield is pretty handy", "in combat, and gives you a big Prayer boost.").also { stage++ }
            209 -> player(FacialExpression.AMAZED, "Wow, thanks!").also { stage++ }
