...
class ChemistDiaryDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            132 -> npc("To claim your Falador Achievement Diary rewards,", "speak to Redbeard the Pirate in Port Sarim, Sir Vyvin's", "squire in the White Knight's Castle, or myself.").also { stage = 105 }
            150 -> npc("This is the second stage of the Falador shield: a kite", "shield. It grants you all the benefits fo the buckler, but", "with increased Prayer restore, and Farming experience", "when using the patches near Falador.").also { stage++ }
            151 -> npc("As before, Prayer restore can only be used once per", "day, but it now restores half of your Prayer points.").also { stage++ }
            ...
            204 -> npc("As before, Prayer restore can only be used once per", "day, but it now restores half of your Prayer points.").also { stage++ }
            205 -> npc("The increased Farming experience is only available at", "the allotments, flower and herb patches found just north", "of Port Sarim.").also { stage++ }
            206 -> npc("As well as all of these features, the shield is pretty", "handy in combat, and gives you a good Prayer boost.").also { stage++ }
            207 -> npc("I've even thrown in an old lamp I found. Try as I", "might, I can't fill it with fuel or get it to light.").also { stage++ }
            208 -> player(FacialExpression.AMAZED, "Wow, thanks!").also { stage++ }
