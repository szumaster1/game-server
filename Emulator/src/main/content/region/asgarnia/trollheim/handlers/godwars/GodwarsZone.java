package content.region.asgarnia.trollheim.handlers.godwars;
...
public final class GodwarsZone extends MapZone implements Plugin<Object> {
    ...
    private void handlePillarGrapple(final Player player, final Scenery object) {
        ...
        player.graphics(new Graphic(1036, 96, 30));
    }
    ...
    private void handleIceBridge(final Player player, final Scenery object) {
        ...
        GameWorld.getPulser().submit(new Pulse(1, player) {
            @Override
            public boolean pulse() {
                player.visualize(Animation.create(6988), Graphic.create(68));
                int diffY = 2;
