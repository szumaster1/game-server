package content.region.asgarnia.whitewolf
...
/**
 * Represents the White Wolf Mountain listener.
 */
class WhiteWolfMountain : InteractionListener {

    override fun defineListeners() {

        /*
         * Handles interaction with rock slide.
         */
