...
/**
 * Represents the Dunstan dialogue file.
 */
                ...
                when (stage) {
                    ...
                    2 -> {
                        if (!inInventory(player!!, Items.CERTIFICATE_3114)) {
                            ...
                            sendItemDialogue(player!!, Items.CERTIFICATE_3114, "You give Dunstan the certificate.").also { stage = 5 }
                        }
                    }

                    3 -> npcl(FacialExpression.FRIENDLY, "Good but I need to have the certificate.").also {
                        stage = END_DIALOGUE
                    }

                    5 -> npcl(FacialExpression.FRIENDLY, "Thank you!").also {
                        // Jumps to the next stage immediately in one continuous dialogue (getQuestStage 24, stage 2).
            ...
            24 -> {
                when (stage) {
                    ...
                    2 -> npcl(FacialExpression.FRIENDLY, "Now to keep my end of the bargain. Give me the boots and an iron bar and I'll put on the spikes.").also {
                        if (inInventory(player!!, Items.CLIMBING_BOOTS_3105) && inInventory(
                                player!!,
                                Items.IRON_BAR_2351
                            )
                        ) {
                    ...
                    7 -> sendDoubleItemDialogue(player!!, Items.IRON_BAR_2351, Items.CLIMBING_BOOTS_3105, "You give Dunstan an Iron bar and the climbing boots.").also {
                        if (removeItem(player!!, Item(Items.CLIMBING_BOOTS_3105)) && removeItem(
                                player!!,
                    ...
                    8 -> sendItemDialogue(player!!, Items.SPIKED_BOOTS_3107, "Dunstan has given you the Spiked boots.").also {
                        stage++
