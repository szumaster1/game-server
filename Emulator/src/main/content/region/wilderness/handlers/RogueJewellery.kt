 ...
 */
class RogueJewellery : InteractionListener {

    val JEWELLERY_ITEMS = RogueJewelleryItem.values().map { it.item }.toIntArray()
    ...
    override fun defineListeners() {
        ...
        onUseWith(IntType.NPC, JEWELLERY_ITEMS, NPCs.ROGUE_8122) { player, used, _ ->
            ...
            val jewellery = RogueJewelleryItem.JewelleryMap[used.id] ?: return@onUseWith true
