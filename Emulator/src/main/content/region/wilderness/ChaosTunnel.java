package content.region.wilderness;
 ...
 */
@Initializable
public final class ChaosTunnel extends MapZone implements Plugin<Object> {
    ...
    private void teleport(Player player, Scenery object) {
        ...
        player.teleport(loc);
        player.graphics(Graphic.create(110));
    }
    ...
    private void setStainedTime(Scenery object) {
        object.getAttributes().setAttribute("stained", GameWorld.getTicks() + RandomFunction.random(50, 150));
    }
