...
/**
 * Represents the Old Man Ghosts Ahoy dialogue.
 */
        ...
        when (questStage) {
            in 4..5 -> when (stage) {
                0 -> if (!hasKey && questStage >= 5) {
                    ...
                    options("What is your name?", "I've lost my key to the chest - do you have another one?", "Is this your toy boat?").also { stage++ }
                }
                ...
                9 -> {
                    if (inInventory(player!!, Items.MODEL_SHIP_4253)) {
                        ...
                        npc("No - I made a toy boat a long while ago, but the colours", "on the flag were different.").also { stage = END_DIALOGUE }
                    } else {
                ...
                18 -> {
                    ...
                    setQuestStage(player!!, "Ghosts Ahoy", 5)
                }
