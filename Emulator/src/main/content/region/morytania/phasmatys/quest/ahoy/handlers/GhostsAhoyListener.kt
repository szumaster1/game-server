...
import content.region.morytania.phasmatys.quest.ahoy.handlers.GhostsAhoyUtils.jumpRockPath
...
class GhostsAhoyListener : InteractionListener, InterfaceListener {
    ...
    override fun defineListeners() {
        ...
        on(Items.PETITION_FORM_4283, IntType.ITEM, "count", "drop") { player, node ->
            val score = getAttribute(player, GhostsAhoyUtils.petitionsigns, 0)
