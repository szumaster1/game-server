    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (questStage) {
            1 -> when (stage) {
                ...
                1 -> npc(FacialExpression.ANNOYED, "You dare to speak that name in this place?????").also { stage++ }
                2 -> player("She wants to pass-").also { stage++ }
                3 -> npc(FacialExpression.ANNOYED, "Silence!!").also { stage++ }
                4 -> npc(FacialExpression.ANNOYED, "Or I will incinerate the flesh from your bones!!!").also { stage++ }
                5 -> player("But she-").also { stage++ }
                6 -> npc(FacialExpression.ANGRY, "Get out of my sight!! Or I promise you that you will", "regret your insolence for the rest of eternity!!!").also { stage++ }
                7 -> {
                    end()
                    setQuestStage(player!!, "Ghosts Ahoy", 2)
                }
            }
            ...
            80 -> when (stage) {
                ...
                22 -> {
                    ...
                    setQuestStage(player!!, "Ghosts Ahoy", 99)
                }
            }
        }
    }
