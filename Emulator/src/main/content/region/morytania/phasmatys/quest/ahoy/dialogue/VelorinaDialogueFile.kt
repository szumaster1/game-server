        ...
        when (questStage) {
            0 -> when (stage) {
                ...
                32 -> {
                    ...
                    setQuestStage(player!!, "Ghosts Ahoy", 1)
                }
            }
            ...
            2 -> when (stage) {
                ...
                6 -> when (buttonID) {
                    ...
                    2 -> player("If it was such a long time ago, won't she be", "dead already?").also { stage = 8 }
                }
                ...
                9 -> {
                    ...
                    setQuestStage(player!!, "Ghosts Ahoy", 3)
                }
            }
            ...
            99 -> when (stage) {
                ...
                6 -> {
                    ...
                    finishQuest(player!!, "Ghosts Ahoy")
                }
            }
        }
    }
