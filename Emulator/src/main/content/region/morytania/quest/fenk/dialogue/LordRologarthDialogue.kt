...
class LordRologarthDialogueFile : DialogueBuilderFile() {
    override fun create(b: DialogueBuilder) {
        b.onQuestStages("Creature of Fenkenstrain", 6)
            ...
            .endWith { _, player ->
                if (getQuestStage(player, "Creature of Fenkenstrain") == 6) {
                    setQuestStage(player, "Creature of Fenkenstrain", 7)
                }
            }
        b.onQuestStages("Creature of Fenkenstrain", 7)
            ...
            .npcl("Take the FairyRing of Charos from him.")
            ...
            .npcl("The FairyRing of Charos has many powers, but Fenkenstrain has bent them to his down evil purposes. Without the power of the ring, he will not be able to raise the dead from their sleep.")
        ...
        b.onQuestStages("Creature of Fenkenstrain", 8, 100)
            ...
            .playerl("I stole the FairyRing of Charos from Fenkenstrain.")
