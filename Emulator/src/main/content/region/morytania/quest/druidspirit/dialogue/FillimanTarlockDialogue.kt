        ...
        when (questStage) {
            ...
            45 -> {
                if (inInventory(player, Items.MORT_MYRE_FUNGUS_2970)) {
                    ...
                    playerl(FacialExpression.NEUTRAL, "Hello, I've been blessed but I don't know what to do now.").also { stage = 70 }
                }
            }
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            7 -> {
                ...
                } else sendDialogue("You give the journal to Filliman Tarlock").also {
                    removeItem(player, Items.JOURNAL_2967, Container.INVENTORY); stage = 10; setQuest(30)
                }
            }
            ...
            122 -> {
                ...
                if (NSUtils.hasPlacedCard(player) && NSUtils.hasPlacedFungus(player) && NSUtils.onStone(player)) {
                    ...
                    submitIndividualPulse(player, object : Pulse(4) {
                        ...
                        override fun stop() {
                            visualize(npc, -1, Graphic(266, 80))
                            super.stop()
                        }
                    })
                } else {
            ...
            1001 -> {
                if (inEquipment(player, Items.GHOSTSPEAK_AMULET_552)) {
                    ...
                    npcl(FacialExpression.HALF_GUILTY, "OooOOoOOoOOOOo.").also { stage = 1033 }
                }
            }
