...
class AliTheKebabSellerDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            6 -> npc("Seeing as I'm in the kebab construction industry.", "I mainly help people who have want of a kebab.").also { stage++ }
            7 -> player(FacialExpression.THINKING, "Well then, what kind of kebabs do you, erm, construct?").also { stage++ }
            8 -> npc("I offer two different types of kebabs: the standard", "run-of-the-mill kebab seen throughout Gielinor and", "enjoyed by many a intoxicated dwarf, and my specialty,", "the extra-hot kebab. So which shall it be?").also { stage++ }
            ...
            12 -> sendDialogueOptions(player, "Select one.", "I want a kebab, please.", "Could I have one of those crazy hot kebabs of yours?", "Would you sell me that bottle of special kebab sauce?", "What is the difference between the standard and extra hot?", "I need some information.").also { stage++ }
            13 -> when (buttonId) {
            ...
            30 -> npc("A super kebab it is so. Be careful, they really are as hot as", "they are made out to be.").also { stage++ }
            ...
            41 -> player("Set yourself at east, I have no intention of setting up a", "rival kebab shop.").also { stage++ }
            ...
            44 -> npc("You're not going to put it in drunken Ali's drink", "now, are you? That's what happened last time", "I gave someone the sauce.").also { stage++ }
            45 -> player("No, that would be a bit cliche, I think I'll come up with", "something more original.").also { stage++ }
            46 -> {
            ...
            50 -> npc("If I told you that I would have to kill you. Kebab sales is", "a cut-throat industry. The extra-hot kebab gives", "me the competitive edge on the rest and if I were to", "divulge my secrets to every passing adventurer, well it").also { stage++ }
            51 -> npc("would soon disappear.").also { stage++ }
            52 -> player("So there's no difference except the sauce you use then!").also { stage++ }
            53 -> npc("Shh! Keep your voice down. You should have told me you", "were from the union.").also { stage = 22 }
            60 -> npc("If information is what you need, there are many better", "people to ask than myself who could help you. One of the", "town's street urchins or perhaps the local drunk.", "I may be many things to many people, but a").also { stage++ }
