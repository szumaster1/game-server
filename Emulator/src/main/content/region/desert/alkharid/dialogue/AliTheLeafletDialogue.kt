    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            101 -> when (buttonId) {
                ...
                3 -> playerl(FacialExpression.ASKING, "What is there to do round here, boy?").also { stage = 401 }
            }
            201 -> npcl(FacialExpression.CHILD_FRIENDLY, "Ali Morrisane is the greatest merchant in the east!").also { stage++ }
            202 -> playerl(FacialExpression.HALF_ASKING, "Were you paid to say that?").also { stage++ }
            ...
            305 -> playerl(FacialExpression.ASKING, "Which shops?").also {
            ...
            406 -> playerl(FacialExpression.FRIENDLY, "Thanks for the help!").also { stage = END_DIALOGUE }
        }
        return true
    }
