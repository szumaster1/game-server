...
/**
 * Represents the Gem trader dialogue.
 */
@Initializable
class GemTraderDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            1 -> options("Yes, please.", "No, thank you.", "I'm in search of a man named Avan Fitzharmon").also { stage = 10 }
            ...
            104 -> {
                ...
                setQuestStage(player, "Family Crest", 13)
            }
        }
        return true
    }
