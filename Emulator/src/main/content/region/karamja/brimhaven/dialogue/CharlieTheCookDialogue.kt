...
/**
 * Represents the Charlie the Cook dialogue.
 */
@Initializable
...
/**
 * Represents the Charlie the cook dialogue file.
 */
    ...
    override fun create(b: DialogueBuilder) {
        b.onPredicate { _ -> true }
            ...
            .let { optionBuilder ->
                ...
                optionBuilder.optionIf("I'm looking for a gherkin..."){ player -> return@optionIf getQuestStage(player, QuestName.HEROES_QUEST) >= 3 && HeroesQuest.isPhoenix(player) }
                    .playerl("I'm looking for a gherkin...")
                    .goto(continuePath)

                optionBuilder.optionIf("I'm a fellow member of the Phoenix Gang."){ player -> return@optionIf getQuestStage(player, QuestName.HEROES_QUEST) >= 3 && HeroesQuest.isPhoenix(player) }
