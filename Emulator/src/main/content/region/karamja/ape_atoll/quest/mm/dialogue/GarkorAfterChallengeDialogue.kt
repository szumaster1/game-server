...
import content.region.karamja.ape_atoll.quest.mm.cutscenes.DungeonPlanWithAwowogeiCutScene
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            5 -> npcl(FacialExpression.NEUTRAL, "Listen closely whilst I narrate the details...").also {
                ...
                content.region.karamja.ape_atoll.quest.mm.cutscenes.DungeonPlanWithAwowogeiCutScene(player!!).start()
                stage++
            }
