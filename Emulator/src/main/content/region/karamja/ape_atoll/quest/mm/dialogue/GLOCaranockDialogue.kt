...
class GLOCaranockDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            4 -> playerl("Anyway, I am here on a separate mission. I am investigating the mysterious disappearance of the 10th squad of kings Narnode's Royal Guard. They were to carry out some work in the area.").also { stage++ }
