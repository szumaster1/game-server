        ...
        when (getQuestStage(player!!, "Monkey Madness")) {
            0 -> {
                when(stage){
                    ...
                    17 -> when (buttonID) {
                        1 -> {
                            playerl("Ok, I'll do it.").also { stage++ }
                        }
                        2 -> end()
                    }
                    18 -> {
                        addItemOrDrop(player!!, Items.GNOME_ROYAL_SEAL_4004)
                        sendItemDialogue(player!!, Items.GNOME_ROYAL_SEAL_4004, "Narnode hands you a copy of the Royal Seal.").also { stage++ }
                    }
                    ...
                    21 -> end().also {
                        ...
                        for (i in 0..17) {
                            when (i) {
                                3 -> player!!.packetDispatch.sendString("Monkey Madness: Chapter 1", interfaceId, i)
                                9 -> player!!.packetDispatch.sendString("In which our ${if (player!!.isMale) "hero finds himself" else "heroine finds herself"} drawn back into Glough's", interfaceId, i)
                                10 -> player!!.packetDispatch.sendString("web of deception and deceit.", interfaceId, i)
            ...
            10 -> {
                when(stage) {
                    0 -> npcl("Welcome back, adventurer.").also {
                            stage = END_DIALOGUE
                    }
                }
            }
            11 -> {
                when(stage) {
                    ...
                    3 -> playerl("I met a gnome who goes by the name of Canarock. Do you recognise it?").also { stage++ }
                    4 -> npcl("The name sounds a little familiar, but it is nobody i know personally.").also { stage++ }
                    5 -> playerl("He calls himself a Gnome Liaison Officer. He seemed a little ... odd").also { stage++ }
                    6 -> npcl("Never mind that - Did you find anything out about my 10th squad?").also { stage++ }
                    7 -> playerl("Caranock suggested they were blown off course by extremely southerly winds.").also { stage++ }
                    8 -> npcl("Do you believe him?").also { stage++ }
                    9 -> playerl("I don't have any other information right now.").also { stage++ }
                    10 -> npcl("Very well. I will now prepare some orders. You must convey them to my new High Tree Guardian, Daero.").also { stage++ }
                    11 -> sendItemDialogue(player!!, Items.NARNODES_ORDERS_4005, "Narnode hands you some handwritten orders.").also {
            ...
            96 -> {
                when(stage) {
                    ...
                    1 -> npcl("Yes? How is the mission going ... it has been quite some time since I sent you on your way.").also { stage++ }
                    ...
                    6 -> playerl("With all due respect, sir, if I told you, you would not believe me. I expect Sergeant Garkor will be sending you a full report soon enough.").also { stage++ }
                    ...
                    11 -> sendItemDialogue(player!!, Items.TENTH_SQUAD_SIGIL_4035, "You show King Narnode your sigil.").also { stage++ }
                    12 -> npcl("Well, now. It appears I cannot argue with that. Garkor obviously thinks highly of you, as do I.").also { stage++ }
                    13 -> npcl("No service such as what you have done for me goes unrewarded in my kingdom. I personally made a visit to the Royal Treasury to withdraw your reward.").also { stage++ }
            ...
            100 -> {
                when(stage){
                    ...
                    4 -> npcl("Yes. All members of the Royal Guard must complete a mandatory training programme.").also { stage++ }
                    5 -> playerl("Where do I sign up for this?").also { stage++ }
                    6 -> npcl("The High Tree Guardian Daero is in charge of the training programme. You should know where to find him by now.").also { stage = 99 }
                    99 -> end()
                }
            }
        }
