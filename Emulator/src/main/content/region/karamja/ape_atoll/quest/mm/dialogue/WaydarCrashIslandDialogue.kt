...
import content.region.karamja.ape_atoll.quest.mm.cutscenes.ShipyardCutScene
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            22 -> npcl(FacialExpression.OLD_NORMAL,"Enough. Return here when you are done.").also {
                stage = END_DIALOGUE
                content.region.karamja.ape_atoll.quest.mm.cutscenes.ShipyardCutScene(player!!).start()
