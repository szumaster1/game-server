            ...
            10 -> when (stage) {
                ...
                8 -> {
                    ...
                    if (player!!.inventory.containsItem(Item(Items.GNOME_ROYAL_SEAL_4004))) {
                        sendItemDialogue(player!!, Items.GNOME_ROYAL_SEAL_4004, "You show the shipyard worker the Royal seal.").also { stage = 9 }
                    } else {
                        sendItemDialogue(player!!, Items.GNOME_ROYAL_SEAL_4004, "You don't actually have the Royal Seal.").also { stage = END_DIALOGUE }
                    }
                }
                ...
                12 -> npcl("Anyway. Please step inside, ${if (player!!.isMale) "mister" else "miss"}").also { stage++ }
                13 -> {
                    stage = END_DIALOGUE
