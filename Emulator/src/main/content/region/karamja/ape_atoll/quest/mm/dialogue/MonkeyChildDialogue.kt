...
/**
 * Represents the Monkey child first dialogue.
 */
class MonkeyChildFirstDialogue: DialogueFile(){
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            3 -> npcl("You look strange to me!").also {
...
/**
 * Represents the Monkey child second dialogue.
 */
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            5 -> when (buttonID) {
                ...
                2 -> {}
                3 -> {}
                4 -> npcl("Uh ah! You do look like my uncle!").also {
...
/**
 * Represents the Monkey child third dialogue.
 */
class MonkeyChildThirdDialogue: DialogueFile(){
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            4 -> npcl("Aunty told me to pick loads of bananas. She said if, I got bananas, she'd give me a new toy!").also { stage++ }
            5 -> options("What kind of toy did Aunty say she'd give you?", "How many bananas did aunty want?").also { stage++ }
            6 -> when (buttonID) {
                1 -> {}
                2 -> playerl("How many bananas did aunty want?").also {
                    stage++
                }
            }
...
/**
 * Represents the Monkey child bananas dialogue.
 */
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            4 -> sendItemDialogue(player!!, Items.BANANA_1963, "You give monkey child your bananas.").also {
                // remove 5 bananas from inventory or stop dialog if you don't have enough
                setAttribute(player!!, "/save:mm:talk-banana", true)
                stage++
            }
            5 -> npcl("aunty will be so happy!").also {
                stage++
            }
        }
    }
...
/**
 * Represents the Monkey child talisman dialogue.
 */
class MonkeyChildTalismanDialogue: DialogueFile(){
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            6 -> sendItemDialogue(player!!, Items.MONKEY_TALISMAN_4023, "The monkey child gives you some kind of talisman.").also {
...
/**
 * Represents the Monkey child without amulet dialogue.
 */
