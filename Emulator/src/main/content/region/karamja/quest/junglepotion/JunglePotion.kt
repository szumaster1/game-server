...
class JunglePotion : Quest("Jungle Potion", 81, 80, 1, Vars.VARP_QUEST_JUNGLE_POTION_PROGRESS, 0, 1, 12) {
    ...
    override fun drawJournal(player: Player, stage: Int) {
        ...
        when (stage) {
            0 -> line(player, "<blue>I can start this quest by speaking to <red>Trufitus Shakaya<n><blue>who lives in the main hut in <red>Tai Bwo Wannai<n><blue>village on the island of <red>Karamja.", 11)
            10, 20, 30, 40, 50 -> {
            ...
            60 -> line(player, "<str>I spoke to Trufitus, he needs to commune with the<n><str>gods, he's asked me to help him by collecting herbs.<n><n><str>I have given Trufitus Snakeweed, Ardrigal,<n><str>Sito Foil, Volencia moss and Rogues purse.<n><n><str>Trufitus needs to commune with the gods.<n><blue>I should speak to <red>Trufitus.", 11)
            100 -> line(player, "<str>Trufitus Shakaya of the Tai Bwo Wannai village needed<n><str>some jungle herbs in order to make a potion which would<n><str>help him commune with the gods. I collected five lots<n><str>of jungle herbs for him and he was able to<n><str>commune with the gods.<n><n><str>As a reward he showed me some herblore techniques.<n><n><col=FF0000>QUEST COMPLETE!</col>", 11)
        }
    }
    ...
    override fun finish(player: Player) {
        ...
        player.packetDispatch.sendItemZoomOnInterface(Herb.VOLENCIA_MOSS.product.id, 235, 277, 3 + 2)
