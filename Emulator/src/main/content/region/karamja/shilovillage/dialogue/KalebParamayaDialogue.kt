...
import content.region.karamja.diary.dialogue.KalebParamayaDiaryDialogue
...
class KalebParamayaDialogue(player: Player? = null): Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            5 -> npc("Well, I am a traveller myself, and I have set up this hostel", "for adventurers and travellers who are weary from their", "journey.").also { stage++ }
            6 -> npc("There is a dormitory upstairs if you are tired, it costs", "35 gold pieces which covers the cost of laundry and", "cleaning.").also { stage = 1 }
            7 -> {
                end(); openDialogue(player, KalebParamayaDiaryDialogue(), npc)
            }
            8 -> options("Buy some wine: 1 Gold.", "Buy some Beer: 2 Gold.", "Buy a nights rest: 35 Gold", "Buy a pack of 5 Dorm tickets: 175 Gold").also { stage++ }
            9 -> when (buttonId) {
                1 -> {
