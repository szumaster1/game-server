...
class IslwynDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        ...
        when (stage) {
            ...
            10 -> when (buttonId) {
                1 -> {
                    player(FacialExpression.HALF_GUILTY, "It's a bit of a long tale, but to cut the story short, her", "remains reside in Baxtorian's home. I thought it's where", "she'd want to be. It was I that removed your", "grandmother's ashes.")
                    stage = 11
                }

                2 -> {
                    player(FacialExpression.HALF_GUILTY, "I just guessed.", "Well, now that that's over, I really need to be", "going.")
                    stage = 500
                }

                3 -> {
                    player(FacialExpression.HALF_GUILTY, "On second thought, I really should be going.")
                    stage = 500
                }
            }
            ...
            14 -> when (buttonId) {
                1 -> {
                    player(FacialExpression.HALF_GUILTY, "Maybe I could help. What needs doing to consecrate", "her new tomb?")
                    stage = 15
                }

                2 -> {
                    player(FacialExpression.HALF_GUILTY, "Sounds like you've got a lot to do.")
                    stage = 500
                }
            }
            ...
            19 -> {
                player(FacialExpression.HALF_GUILTY, "How did you know that I have consecrated the tomb?")
                stage = 20
            }
            ...
            27 -> when (buttonId) {
                1 -> {
                    player(FacialExpression.HALF_GUILTY, "Shields are for wimps! Give me the bow!")
                    stage = 30
                }

                2 -> {
                    player(FacialExpression.HALF_GUILTY, "I don't like running and hiding behind mushrooms.", "Shield please!")
                    stage = 301
                }
            }
            ...
            33 -> when (buttonId) {
                ...
                2 -> {
                    player(FacialExpression.HALF_GUILTY, "I need to recharge my current seeds into equipment.")
                    stage = 34
                }
            }
            ...
            35 -> when (buttonId) {
                1 -> {
                    player(FacialExpression.HALF_GUILTY, "Recharge my seed into a bow, please.")
                    stage = 36
                }

                2 -> {
                    player(FacialExpression.HALF_GUILTY, "Recharge my seed into a shield, please.")
                    stage = 3601
                }
            }
