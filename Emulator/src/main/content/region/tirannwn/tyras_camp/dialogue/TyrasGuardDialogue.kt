package content.region.tirannwn.tyras_camp.dialogue
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            1 -> when (buttonId) {
                ...
                3 -> player(FacialExpression.NEUTRAL, "I'll leave you alone.").also { stage = END_DIALOGUE }
            }
            ...
            12 -> when (buttonId) {
                ...
                2 -> player(FacialExpression.NEUTRAL, "Ok, thanks.").also { stage = END_DIALOGUE }
            }
