...
enum class Consumables {
    ...
    ASGOLDIAN_ALE(FakeConsumable(Items.ASGOLDIAN_ALE_7508, arrayOf("I don't think I'd like gold in beer thanks. Leave it for the dwarves."))),
    ...
    PREMADE_BLURB_SP(Drink(intArrayOf(Items.PREMADE_BLURB_SP_2028, Items.COCKTAIL_GLASS_2026),MultiEffect(HealingEffect(6), SkillEffect(Skills.STRENGTH, 6.0, 0.0), SkillEffect(Skills.ATTACK, -4.0, 0.0)))),
    ...
    CUP_OF_TEA_CLAY_MILKY(Drink(intArrayOf(Items.CUP_OF_TEA_7731, Items.EMPTY_CUP_7728), SkillEffect(Skills.CONSTRUCTION, 1.0, 0.0))),
    ...
    CUP_OF_TEA_WHITE_MILKY(Drink(intArrayOf(Items.CUP_OF_TEA_7734, Items.PORCELAIN_CUP_7732), SkillEffect(Skills.CONSTRUCTION, 2.0, 0.0))),
    ...
    CUP_OF_TEA_GOLD_MILKY(Drink(intArrayOf(Items.CUP_OF_TEA_7737, Items.PORCELAIN_CUP_7735), SkillEffect(Skills.CONSTRUCTION, 3.0, 0.0))),
    ...
    FROG_SPAWN(Food(intArrayOf(Items.FROG_SPAWN_5004), RandomHealthEffect(3, 7), "You eat the frogspawn. Yuck.")),
    ...
    RELICYM(Potion(intArrayOf(Items.RELICYMS_BALM4_4842, Items.RELICYMS_BALM3_4844, Items.RELICYMS_BALM2_4846, Items.RELICYMS_BALM1_4848),MultiEffect(SetAttributeEffect("disease:immunity", 300), RemoveTimerEffect("disease")))),
    ...
    SARA_BREW(Potion(intArrayOf(Items.SARADOMIN_BREW4_6685, Items.SARADOMIN_BREW3_6687, Items.SARADOMIN_BREW2_6689, Items.SARADOMIN_BREW1_6691),MultiEffect(PercentHeal(0, .15),SkillEffect(Skills.ATTACK, 0.0, -0.10),SkillEffect(Skills.STRENGTH, 0.0, -0.10),SkillEffect(Skills.MAGIC, 0.0, -0.10),SkillEffect(Skills.RANGE, 0.0, -0.10),SkillEffect(Skills.DEFENCE, 0.0, 0.25)))),
    ...
    COMBAT(Potion(intArrayOf(Items.COMBAT_POTION4_9739, Items.COMBAT_POTION3_9741, Items.COMBAT_POTION2_9743, Items.COMBAT_POTION1_9745),MultiEffect(SkillEffect(Skills.STRENGTH, 3.0, .1), SkillEffect(Skills.ATTACK, 3.0, .1)))),
    ...
    ANTIFIRE(Potion(intArrayOf(Items.ANTIFIRE_POTION4_2452, Items.ANTIFIRE_POTION3_2454, Items.ANTIFIRE_POTION2_2456, Items.ANTIFIRE_POTION1_2458), SetAttributeEffect("fire:immune", 600, true))),
    GUTH_REST(Potion(intArrayOf(Items.GUTHIX_REST4_4417, Items.GUTHIX_REST3_4419, Items.GUTHIX_REST2_4421, Items.GUTHIX_REST1_4423),MultiEffect(RemoveTimerEffect("poison"), EnergyEffect(5), HealingEffect(5)))),
    ...
    BLAMISH_OIL(FakeConsumable(Items.BLAMISH_OIL_1582, arrayOf("You know... I'd really rather not."))),
    ...
    RELIC_MIX(BarbarianMix(intArrayOf(Items.RELICYMS_MIX2_11437, Items.RELICYMS_MIX1_11439),MultiEffect(RemoveTimerEffect("disease"), SetAttributeEffect("disease:immunity", 300), HealingEffect(3)))),
