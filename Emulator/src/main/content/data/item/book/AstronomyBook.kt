...
class AstronomyBook : InteractionListener {
        ...
        private val CONTENTS = arrayOf(
            PageSet(
                Page(
                    ...
                    BookLine("in " + GameWorld.settings!!.name + ".", 56),
                    BookLine("", 57),
            ...
            PageSet(
                Page(
                    ...
                    BookLine("in " + GameWorld.settings!!.name + ", which are", 59),
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterfaceListener.pageSetup(
            ...
            content.data.item.book.AstronomyBook.Companion.TITLE,
            content.data.item.book.AstronomyBook.Companion.CONTENTS
        )
        return true
    }
