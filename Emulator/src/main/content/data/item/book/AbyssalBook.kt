...
class AbyssalBook : InteractionListener {
        ...
        private val CONTENTS = arrayOf(
            ...
            PageSet(
                ...
                Page(
                    ...
                    BookLine("people at will into Abyssal", 74),
                    BookLine("Space. The only downside to", 75),
                    BookLine("this method of teleportation", 76),
                ),
            ),
            PageSet(
                Page(
            ...
            PageSet(
                ...
                Page(
                    ...
                    BookLine("along with me", 73),
                    BookLine("recommendations on how best", 74),
                    BookLine("to thwart their research", 75),
                    BookLine("further.", 76),
                )
            ),
            PageSet(
                ...
                Page(
                    ...
                    BookLine("", 73),
                    BookLine("Until my next report, I remain", 74),
                    BookLine("as ever a loyal servant.", 75),
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterfaceListener.pageSetup(player, BookInterfaceListener.FANCY_BOOK_3_49,
            content.data.item.book.AbyssalBook.Companion.TITLE,
            content.data.item.book.AbyssalBook.Companion.CONTENTS
        )
        return true
    }
