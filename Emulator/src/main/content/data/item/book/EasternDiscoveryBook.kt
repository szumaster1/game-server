...
/**
 * Represents the Eastern discovery book.
 */
class EasternDiscoveryBook : InteractionListener {
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterfaceListener.pageSetup(
            ...
            content.data.item.book.EasternDiscoveryBook.Companion.TITLE,
            content.data.item.book.EasternDiscoveryBook.Companion.CONTENTS
        )
        return true
    }
