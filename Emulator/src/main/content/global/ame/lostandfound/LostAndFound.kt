 ...
 */
class LostAndFound : InteractionListener {
            ...
            if (LostAndFoundUtils.isOddAppendage(player, node.asScenery())) {
                ...
                queueScript(player, 4, QueueStrength.SOFT) {
                    ...
                    if (getAttribute(player, LostAndFoundUtils.essenceMine, false)) {
                        addItem(player, if (getStatLevel(player, Skills.MINING) > 30) Items.PURE_ESSENCE_7936 else Items.RUNE_ESSENCE_1436, randomRewardAmount)
                    }
