        ...
        queueScript(player, 1, QueueStrength.SOFT) { stage: Int ->
            when (stage) {
                ...
                1 -> {
                    ...
                    sendUnclosableDialogue(player, true, "There has been a fault in the teleportation matrix. Please operate the", "odd appendage out to be forwarded to your destination.")
