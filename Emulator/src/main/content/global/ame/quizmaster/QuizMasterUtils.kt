...
object QuizMasterUtils {
    ...
    val WRONG = arrayOf(
        arrayOf("Huh...? Didn't you know that one?", "You're supposed to pick the ODD ONE OUT.", "Now, let's start again..."),
        arrayOf("No. No, that's not right at all.", "You're supposed to pick the ODD ONE OUT.", "Now let's start again..."),
        ...
        arrayOf("No, no, no... That's completely WRONG!", "You're supposed to pick the ODD ONE OUT.", "Now, let's start again..."),
