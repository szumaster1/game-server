 ...
 * Pinball listeners.
 */
class Pinball : InteractionListener, MapArea {
    ...
    override fun defineListeners() {
        on(PinballUtils.pillars, IntType.SCENERY, "tag") { player, node ->
            ...
            if(node.id in PinballUtils.wrongPillars.indices) {
                ...
                sendString(player, "Score: 0", Components.PINBALL_INTERFACE_263, 1)
                ...
                sendString(player, "Score: " + getAttribute(player, PinballUtils.PINBALL_SCORE, this.toString()) + "", Components.PINBALL_INTERFACE_263, 1)
