 ...
 * Evil bob listeners.
 */
class EvilBob : InteractionListener, MapArea {
    ...
    override fun defineListeners() {
        ...
        on(EvilBobUtils.fishingSpot, IntType.SCENERY, "net") { player, _ ->
            if (getAttribute(player, EvilBobUtils.attentiveNewSpot, false) || getAttribute(player,
                    EvilBobUtils.eventComplete, false)) {
