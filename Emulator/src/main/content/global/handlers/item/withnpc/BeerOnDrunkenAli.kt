...
/**
 * Handles use the beer on drunken ali.
 */
class BeerOnDrunkenAli : InteractionListener {
                    ...
                    when (random) {
                        ...
                        3 -> {
                            sendChat(with.asNpc(), "Wha'? Are you lookin' at me? Are you lookin' at me?").also {
                                runTask(player, 2) { sendChat(with.asNpc(), "You know something? You're drunk, you are.") }
                            }
                        }
