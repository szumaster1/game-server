...
class FishbowlOptionHandler : OptionHandler() {
    ...
    override fun newInstance(arg: Any?): Plugin<Any> {
        ...
        PluginManager.definePlugin(FishbowlDialogue())
        PluginManager.definePlugin(FeedPetFishHandler())
    ...
    class AquariumPlugin : OptionHandler() {
        ...
        override fun newInstance(arg: Any?): Plugin<Any?> {
            ...
            PluginManager.definePlugin(TinyNetHandler())
            return this
        }
        ...
        fun getFish(player: Player): Boolean {
            if (!player.inventory.containsAtLeastOneItem(TINY_NET)) {
                ...
                val fishChance = arrayOf(WeightedChanceItem(FISHBOWL_BLUE, 1, blueChance), WeightedChanceItem(FISHBOWL_GREEN, 1, greenChance), WeightedChanceItem(FISHBOWL_SPINE, 1, spineChance))
    ...
    companion object {
        ...
        private val ANIM_FEED = Animation(Animations.FEEDING_FISHBOWL_2781)
    }
}