...
val seaBoots = intArrayOf(Items.FREMENNIK_SEA_BOOTS_1_14571, Items.FREMENNIK_SEA_BOOTS_2_14572, Items.FREMENNIK_SEA_BOOTS_3_14573)
val enchantedLyre = intArrayOf(Items.ENCHANTED_LYRE1_3691, Items.ENCHANTED_LYRE2_6125, Items.ENCHANTED_LYRE3_6126, Items.ENCHANTED_LYRE4_6127, Items.ENCHANTED_LYRE5_14590, Items.ENCHANTED_LYRE6_14591)

class SeaBootsListener : InteractionListener {

    override fun defineListeners() {

        /*
         * Handles sea boots options.
         */
                ...
                override fun handle(componentID: Int, buttonID: Int) {
                    ...
                    when (stage) {
                        ...
                        1 -> when (buttonID) {
                            ...
                            2 -> {
                                if (inEquipmentOrInventory(player, Items.FREMENNIK_SEA_BOOTS_1_14571)) {
                                    sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_1_14571, "Your Fremennik sea boots will bring you certain benefits within the Fremennik area.")
                                    stage = 7
                                    ...
                                    sendItemDialogue(player, Items.ENCHANTED_LYRE1_3691, "You may use lyre once per day without draining any of its enchantment.")
                                    stage = 8
                                }
                            }
                            ...
                            3 -> {
                                if (inEquipmentOrInventory(player, Items.FREMENNIK_SEA_BOOTS_1_14571)) {
                                    ...
                                    sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_2_14572, "Your Fremennik sea boots will bring you certain benefits within the Fremennik area.")
                                    stage = 10
                                } else if (inEquipmentOrInventory(player, Items.FREMENNIK_SEA_BOOTS_3_14573)) {
                                    sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_3_14573, "Your lyre currently teleports you to " + if (getAttribute(player, LyreTeleport.LYRE_TELEPORT_ALT, false)) "Waterbirth Island." else "Relleka.")
                                    stage = 13
                            ...
                            4 -> {
                                if (inEquipmentOrInventory(player, Items.FREMENNIK_SEA_BOOTS_2_14572)) {
                                    ...
                                    sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_3_14573, "Your Fremennik sea boots will bring you certain benefits within the Fremennik area.")
                                    stage = 15
                                }
                            }
                        ...
                        6 -> when (buttonID) {
                            1 -> {
                                ...
                                if (hasAnItem(player, *enchantedLyre).container == player.inventory) {
                                    ...
                                    stage = 0
                                } else if (inInventory(player, Items.RAW_SHARK_383) && hasAnItem(player, Items.ENCHANTED_LYRE_3690).container == player.inventory && removeItem(player, Items.ENCHANTED_LYRE_3690, Container.INVENTORY) && removeItem(player, Items.RAW_SHARK_383, Container.INVENTORY)) {
                        ...
                        7 -> sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_1_14571, "If you speak to Peer the Seer, he will deposit items into your bank. The Fossegrimen's enchantment will give your lyre extra charges, if you make her an offering in person.").also { stage = 0 }
                        ...
                        10 -> {
                            sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_2_14572, "If you speak to Peer the Seer, he will deposit items into your bank. The Fossegrimen's enchantment will give your lyre extra charges, if you make her an offering in person.")
                            stage++
                        }

                        11 -> {
                            sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_2_14572, "As Regent of Miscellania, the people will appreciate your efforts more and your approval rating will increase faster. There is also a broken section of pier on Miscellania that you can use to quickly travel between")
                            stage++
                        }
                        ...
                        15 -> {
                            sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_3_14573, "If you speak to Peer the Seer, he will deposit items into your bank. The Fossegrimen's enchantment will give your lyre extra charges, if you make her an offering in person.")
                            stage++
                        }

                        16 -> {
                            sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_3_14573, "As Regent of Miscellania, the people will appreciate your efforts more and your approval rating will increase faster. There is also a broken section of pier on Miscellania that you can use to quickly travel between")
                            stage++
                        }
                        ...
                        18 -> {
                            sendItemDialogue(player, Items.FREMENNIK_SEA_BOOTS_3_14573, "Advisor Ghrim will accept flat-packed furniture as a contribution to the coffers of Miscellania.")
                            stage = 0
                        }
                    }
                }
