...
/**
 * Handles fruit cutting.
 */
class FruitCutListener : InteractionListener {

    /**
     * Representing different types of fruits.
     *
    ...
    /**
     * Represents the fruit cutting dialogue.
     */
    inner class FruitCuttingDialogue(val fruit: Int, val chunk: Int, val slice: Item) : DialogueFile() {
