...
/**
 * Handles usage of machete.
 */
class Machete : InteractionListener{

//  val THATCHSPAR = intArrayOf(Items.THATCH_SPAR_LIGHT_6281, Items.THATCH_SPAR_MED_6283, Items.THATCH_SPAR_DENSE_6285)
    val MACHETE = intArrayOf(Items.MACHETE_975, Items.OPAL_MACHETE_6313, Items.JADE_MACHETE_6315, Items.RED_TOPAZ_MACHETE_6317)
