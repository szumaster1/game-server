 ...
 */
@Initializable
class GodswordHiltAttach : UseWithHandler(11702, 11704, 11706, 11708) {
    ...
    override fun handle(event: NodeUsageEvent): Boolean {
        ...
        if (player.inventory.replace(null, item.slot, false) !== item || player.inventory.replace(null, baseItem.slot, false) !== baseItem) {
