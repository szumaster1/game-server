...
/**
 * Handles the toys options.
 */
class ToysOption : InteractionListener {
    ...
    companion object {
        ...
        private val MARIONETTES = intArrayOf(Items.RED_MARIONETTE_6867, Items.BLUE_MARIONETTE_6865, Items.GREEN_MARIONETTE_6866)
