...
/**
 * Handles reclaim lost items from diango store.
 */
@Initializable
class DiangoReclaimInterface : ComponentPlugin() {
    ...
    override fun newInstance(arg: Any?): Plugin<Any> {
        ...
        ITEMS.addAll(listOf(*HOLIDAY_ITEMS))
        return this
    }
    ...
    companion object {
        ...
        val ITEMS: MutableList<Item> = ArrayList(20)

        val HOLIDAY_ITEMS: Array<Item> = arrayOf(
