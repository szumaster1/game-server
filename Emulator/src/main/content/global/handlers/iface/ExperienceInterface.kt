...
/**
 * Represents the stats advancement interface.
 */
@Initializable
class ExperienceInterface : ComponentPlugin() {
    ...
    override fun handle(player: Player, component: Component, opcode: Int, button: Int, slot: Int, itemId: Int): Boolean {
        if (button == 2) {
            ...
            if (confirmedSkill == -1) {
                ...
                caller ?: return true
                if (caller is Plugin<*>) caller.handleSelectionCallback(confirmedSkill, player)
    ...
    companion object {
        ...
        @JvmField val COMPONENT_ID = Components.STATS_ADVANCEMENT_134
    }
}
