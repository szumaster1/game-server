...
val FEMALE_HAIR_STYLES = intArrayOf(
    F_BALD,
    F_BUN,
    F_DREAD,
    F_LONG,
...
val MALE_HAIR_STYLES = intArrayOf(
    M_BALD,
    M_DREAD,
    M_LONG,
    M_MEDIUM,
...
val MALE_FACIAL_STYLES = intArrayOf(
    MF_GOATEE,
    MF_LONG_BEARD,
    MF_MEDIUM_BEARD,
    MF_MOUSTACHE,
...
class HairdresserInterface : ComponentPlugin() {
    override fun open(player: Player?, component: Component?) {
        ...
        sendAnimationOnInterface(
            player,
            core.game.dialogue.FacialExpression.HAPPY.animationId,
            usedInterface,
            player_head_child
        )
