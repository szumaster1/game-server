...
/**
 * Handles book & scroll read option.
 */
...
class PageSet(vararg pages: Page) { val pages: Array<Page> = pages as Array<Page> }

class Page(vararg lines: BookLine) { val lines: Array<BookLine> = lines as Array<BookLine> }
