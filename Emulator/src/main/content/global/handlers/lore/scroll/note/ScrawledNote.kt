package content.global.handlers.lore.scroll.note
    ...
    override fun defineListeners() {
        on(Items.SCRAWLED_NOTE_717, IntType.ITEM, "read") { player, _ ->
            openInterface(player, Components.BLANK_SCROLL_222).also {
                content.global.handlers.lore.scroll.note.ScrawledNote.Companion.ScrawledNoteContent(
                    player
                )
            }
            return@on true
