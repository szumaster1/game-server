...
class IorwerthsMessageScroll : InteractionListener {
    ...
    override fun defineListeners() {
        on(iorwerthsscroll, IntType.ITEM, "read") { player, _ ->
            ...
            sendString(player, "Your Majesty King Lathas<br>Your man did well. The path is now open for the dark lord to enter this realm. You will yet live to see Camelot crushed under foot.", kingsmessage, 1)
