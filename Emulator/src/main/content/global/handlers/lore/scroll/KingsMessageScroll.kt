package content.global.handlers.lore.scroll
...
class KingsMessageScroll : InteractionListener {
    ...
    override fun defineListeners() {
        on(kingsscroll, IntType.ITEM, "read") { player, _ ->
            ...
            sendString(player, "Squire ${player.username}<br>You are needed to serve the Kingdom of Kandarin. At last our magi have reopened the well of voyage. We must discuss your next commission.", kingsmessage, 1)
