...
/**
 * Represents the Thanksgiving event book.
 */
class ThanksgivingEventBook : InteractionListener {
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterface.pageSetup(player, BookInterface.FANCY_BOOK_3_49,
            content.global.handlers.lore.book.ThanksgivingEventBook.Companion.TITLE,
            content.global.handlers.lore.book.ThanksgivingEventBook.Companion.CONTENTS
        )
        return true
    }
