package content.global.handlers.lore.book.tome
...
class CrumblingTome : InteractionListener {
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterface.pageSetup(player, BookInterface.FANCY_BOOK_3_49,
            content.global.handlers.lore.book.tome.CrumblingTome.Companion.TITLE,
            content.global.handlers.lore.book.tome.CrumblingTome.Companion.CONTENTS
        )
        return true
    }
