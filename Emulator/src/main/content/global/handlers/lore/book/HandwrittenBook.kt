...
/**
 * Represents the Handwritten book.
 */
class HandwrittenBook : InteractionListener {
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterface.pageSetup(player, BookInterface.FANCY_BOOK_3_49,
            content.global.handlers.lore.book.HandwrittenBook.Companion.TITLE,
            content.global.handlers.lore.book.HandwrittenBook.Companion.CONTENTS
        )
        return true
    }
