...
class GoblinBook : InteractionListener {
    ...
    companion object {
        ...
        private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
            BookInterface.pageSetup(player, BookInterface.FANCY_BOOK_26,
                content.global.handlers.lore.book.GoblinBook.Companion.TITLE,
                content.global.handlers.lore.book.GoblinBook.Companion.CONTENTS
            )
            return true
        }
    }
    ...
    override fun defineListeners() {
        on(Items.GOBLIN_BOOK_10999, IntType.ITEM, "read") { player, _ ->
            BookInterface.openBook(player, BookInterface.FANCY_BOOK_26, content.global.handlers.lore.book.GoblinBook.Companion::display)
            return@on true
        }
    }
