    ...
    override fun defineListeners() {
        on(Items.NECROMANCY_BOOK_4837, IntType.ITEM, "read") { player, _ ->
            if(getAttribute(player, "zfe:missed-page" ,false)) {
                ...
                sendItemDialogue(player, Items.NECROMANCY_BOOK_4837,"This book uses very strange language and some incomprehensible symbols. It has a very dark feeling to it. As you're looking through the book, you notice that one of the pages has been torn and half of it is missing.")
            }
            return@on true
        }
    }
