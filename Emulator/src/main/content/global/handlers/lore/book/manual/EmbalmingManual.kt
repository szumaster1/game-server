package content.global.handlers.lore.book.manual
...
/**
 * Represents the Embalming manual.
 */
class EmbalmingManual : InteractionListener {
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterface.pageSetup(player, BookInterface.FANCY_BOOK_3_49,
            content.global.handlers.lore.book.manual.EmbalmingManual.Companion.TITLE,
            content.global.handlers.lore.book.manual.EmbalmingManual.Companion.CONTENTS
        )
        return true
    }
