package content.global.handlers.lore.book.journal
...
class EdernJournal : InteractionListener {
    ...
    private fun display(player: Player, pageNum: Int, buttonID: Int): Boolean {
        BookInterface.pageSetup(player, BookInterface.FANCY_BOOK_3_49,
            content.global.handlers.lore.book.journal.EdernJournal.Companion.TITLE,
            content.global.handlers.lore.book.journal.EdernJournal.Companion.CONTENTS
        )
        return true
    }
