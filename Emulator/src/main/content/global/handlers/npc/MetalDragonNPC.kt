...
class MetalDragonNPC(id: Int = 0, location: Location? = null) : AbstractNPC(id, location) {
    ...
    companion object {
        private val DRAGONFIRE: SwitchAttack = DragonfireSwingHandler.get(false, 52, Animation(81, Priority.HIGH), null, null, Projectile.create(null as Entity?, null, 54, 40, 36, 41, 46, 20, 255))
    }
}
