 ...
 */
enum class Traps(@JvmField val settings: content.global.skill.hunter.TrapSetting, vararg nodes: TrapNode) {
    BIRD_SNARE(
        content.global.skill.hunter.TrapSetting(
            10006,
            intArrayOf(19175),
            intArrayOf(),
            "lay",
    ...
    BOX_TRAP(
        ...
        content.global.skill.hunter.BoxTrapNode(intArrayOf(5081), 27, 100.0, arrayOf(Item(10092)), 1),
        content.global.skill.hunter.BoxTrapNode(
            intArrayOf(6918, 7289, 7290, 7291, 7292),
            27,
            100.0,
            arrayOf(Item(12184)),
            10
        ),
        content.global.skill.hunter.BoxTrapNode(intArrayOf(1487), 27, 100.0, arrayOf(Item(4033, 1)), 95),
        content.global.skill.hunter.BoxTrapNode(intArrayOf(7021, 7022, 7023), 48, 150.0, arrayOf(Item(12551, 1)), 1),
        content.global.skill.hunter.BoxTrapNode(intArrayOf(5079), 53, 198.0, arrayOf(Item(10033, 1)), 1),
        content.global.skill.hunter.BoxTrapNode(
            intArrayOf(5428, 5430, 5449, 5450, 5451),
            56,
            150.0,
            arrayOf(Item(12188)),
            1
        ),
        content.global.skill.hunter.BoxTrapNode(intArrayOf(5080), 63, 265.0, arrayOf(Item(10034, 1)), 1),
        content.global.skill.hunter.BoxTrapNode(intArrayOf(7012, 7014), 66, 400.0, arrayOf(Item(12535)), 1),
        content.global.skill.hunter.BoxTrapNode(intArrayOf(8654), 73, 315.0, arrayOf(Item(14861)), 1),
        object : content.global.skill.hunter.BoxTrapNode(intArrayOf(7010, 7011), 77, 0.0, arrayOf(Item(12539, 1)), 1) {
            override fun canCatch(wrapper: content.global.skill.hunter.TrapWrapper, npc: NPC): Boolean {
                //old xp: 726
    ...
    IMP_BOX(MagicBoxSetting(), TrapNode(intArrayOf(708, 709, 1531), 71, 450.0, intArrayOf(-1, 19226), arrayOf(Item(10027)))),
    DEAD_FALL(content.global.skill.hunter.DeadfallSetting(), TrapNode(intArrayOf(5089), 23, 128.0, intArrayOf(19213, 19214, 19218), arrayOf(Item(10113), Item(526))), TrapNode(intArrayOf(5088), 33, 168.0, intArrayOf(19211, 19212, 19217), arrayOf(Item(10129), Item(526))), TrapNode(intArrayOf(5086), 37, 204.0, intArrayOf(19208, 19208, 19217), arrayOf(Item(10105), Item(526))), TrapNode(intArrayOf(7039), 44, 200.0, intArrayOf(28939, 28940, 28941), arrayOf(Item(12567), Item(526))), TrapNode(intArrayOf(5087), 51, 200.0, intArrayOf(19209, 19210, 19216), arrayOf(Item(10109), Item(526)))),
    NET_TRAP(NetTrapSetting(), TrapNode(intArrayOf(5117), 29, 152.0, intArrayOf(), arrayOf(Item(10149))), TrapNode(intArrayOf(5114), 47, 224.0, intArrayOf(), arrayOf(Item(10146))), TrapNode(intArrayOf(6921), 29, 152.0, intArrayOf(), arrayOf(Item(12130))), TrapNode(intArrayOf(5115), 59, 272.0, intArrayOf(), arrayOf(Item(10147))), TrapNode(intArrayOf(5116), 67, 304.0, intArrayOf(), arrayOf(Item(10148))));
    ...
    fun dismantle(player: Player, scenery: Scenery) {
        val instance = content.global.skill.hunter.HunterManager.getInstance(player)
    ...
    /**
     * Called when a npc is hooked.
     *
     * @param wrapper   the wrapper.
     * @param npc       the npc.
     */
    fun catchNpc(wrapper: content.global.skill.hunter.TrapWrapper, npc: NPC) {
     ...
     * @param wrapper   the wrapper.
     */
    fun addHook(wrapper: content.global.skill.hunter.TrapWrapper): TrapHook {
     ...
     * @return the wrapper.
     */
    fun getByHook(location: Location): content.global.skill.hunter.TrapWrapper? {
        for (hook in hooks) {
