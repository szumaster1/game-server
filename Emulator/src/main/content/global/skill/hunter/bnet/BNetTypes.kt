 ...
 * @author Vexia
 */
enum class BNetTypes(val node: content.global.skill.hunter.bnet.BNetNode) {
    RUBY_HARVEST(
        content.global.skill.hunter.bnet.BNetNode(
            intArrayOf(5085),
            intArrayOf(15, 80, 75),
            doubleArrayOf(24.0, 300.0, 50.0),
            arrayOf(Graphic(913), Graphic(917)),
            ChanceItem(10020)
        )
    ),
    SAPPHIRE_GLACIALIS(
        content.global.skill.hunter.bnet.BNetNode(
            ...
            arrayOf(Graphic(912), Graphic(916)),
            ChanceItem(10018)
        )
    ),
    SNOWRY_KNIGHT(
        content.global.skill.hunter.bnet.BNetNode(
            ...
            arrayOf(Graphic(911), Graphic(915)),
            ChanceItem(10016)
        )
    ),
    BLACK_WARLOCK(
        content.global.skill.hunter.bnet.BNetNode(
            ...
            arrayOf(Graphic(910), Graphic(914)),
            ChanceItem(10014)
        )
    ),
    BABY_IMPLING(
