 ...
 */
class BNetPulse(player: Player?, node: NPC?, private val type: content.global.skill.hunter.bnet.BNetNode) : SkillPulse<NPC?>(player, node) {
    ...
    override fun checkRequirements(): Boolean {
        ...
        if (type.hasWeapon(player)) {
            ...
            sendMessage(player, "You need to be wielding a butterfly net to catch " + (if (type is content.global.skill.hunter.bnet.ImplingNode) "implings" else "butterflies") + ".")
            return false
