 ...
 * @author Vexia
 */
class MagicBoxSetting : content.global.skill.hunter.TrapSetting(10025, intArrayOf(19223), intArrayOf(1470, 1472, 1476, 1474), "activate", 19224, Animation.create(5208), Animation.create(9726), 27) {
    ...
    override fun addTool(player: Player, wrapper: content.global.skill.hunter.TrapWrapper, type: Int) {
        if (!wrapper.isCaught) {
