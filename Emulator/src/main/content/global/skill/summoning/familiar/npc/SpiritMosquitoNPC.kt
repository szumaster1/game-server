 ...
 */
@Initializable
class SpiritMosquitoNPC(owner: Player? = null, id: Int = NPCs.SPIRIT_MOSQUITO_7331) : content.global.skill.summoning.familiar.Familiar(owner, id, 1200, 12778, 3, WeaponInterface.STYLE_ACCURATE) {
