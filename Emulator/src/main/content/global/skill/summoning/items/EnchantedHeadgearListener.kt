...
class EnchantedHeadgearListener : InteractionListener {
    ...
    override fun defineListeners() {
        ...
        on(NPCs.PIKKUPSTIX_6970, IntType.NPC, "Enchant") { player, _ ->
            ...
            if (!isQuestComplete(player, QuestName.WOLF_WHISTLE)) {
