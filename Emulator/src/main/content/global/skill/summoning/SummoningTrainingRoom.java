...
public final class SummoningTrainingRoom extends OptionHandler {
            ...
            case "open":
                if (quest.getStage(player) < 40) {
                    ...
                    if (player.getAttribute("has-key", false) || player.getInventory().remove(TRAPDOOR_KEY)) {
                        setAttribute(player, "has-key", true);
            ...
            case "search":
                if (quest.getStage(player) == 30 && !player.getAttribute("searched-body", false)) {
                    ...
                    if (!player.getInventory().containsItem(BONES) && player.getInventory().add(BONES)) {
                        setAttribute(player, "/save:searched-body", true);
    ...
    public static final class FluffyCutscene extends CutscenePlugin {
        ...
        public void open() {
            ...
            setAttribute(player, "wolf-dial", player.getDialogueInterpreter().getDialogue());
            setAttribute(player, "in-cutscene", this);
            player.lock();
        }
        ...
        public void end() {
            super.end();
            removeAttribute(player, "in-cutscene");
                    ...
                    case 50:// second cutscene.
                        switch (stage) {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                PacketRepository.send(CameraViewPacket.class, new CameraContext(player, CameraType.RESET, 1000, 13, 0, 1, 100));
                                ...
                                break;
                            case -5:
                                setAttribute(player, "in-cutscene", cutscene);
                                close();
                                stage = 6;
                                break;
                            case 6:
