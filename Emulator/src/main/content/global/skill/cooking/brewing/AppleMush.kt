 ...
 * Apple mush listener.
 */
class AppleMush : InteractionListener {
            ...
            override fun pulse(): Boolean {
                when (counter++) {
                    0 -> {
                        ...
                        replaceScenery(Object(EMPTY_BARREL, BARREL_LOCATION), APPLE_BARREL, -1)
                    }

                    3 -> replaceScenery(Object(APPLE_BARREL, BARREL_LOCATION), APPLE_MUSH_BARREL, -1)
                    ...
                    11 -> {
                        ...
                        replaceScenery(Object(APPLE_MUSH_BARREL, BARREL_LOCATION), EMPTY_BARREL, -1)
