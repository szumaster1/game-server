...
import content.global.skill.gathering.farming.CompostBins.Companion.forObject
...
@JvmOverloads constructor(owner: Player? = null, id: Int = 6871) :
    ...
    override fun specialMove(special: FamiliarSpecial): Boolean {
        ...
        val cbin = forObject(special.node.asScenery()) ?: return false
    ...
    companion object {
        private val ITEMS = arrayOf(Item(6032), Item(6034), Item(5318), Item(5319), Item(5324), Item(5322), Item(5320), Item(5323), Item(5321), Item(5305), Item(5307), Item(5308), Item(5306), Item(5309), Item(5310), Item(5311), Item(5101), Item(5102), Item(5103), Item(5104), Item(5105), Item(5106), Item(5096), Item(5097), Item(5098), Item(5099), Item(5100), Item(5291), Item(5292), Item(5293), Item(5294), Item(5295), Item(12176), Item(5296), Item(5298), Item(5299), Item(5300), Item(5301), Item(5302), Item(5303), Item(5304))
    }
}
