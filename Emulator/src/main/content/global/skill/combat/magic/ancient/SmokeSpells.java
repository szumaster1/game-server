...
public final class SmokeSpells extends CombatSpell {
    ...
    private SmokeSpells(SpellType type, int level, double baseExperience, int sound, int impactSound, Animation anim, Graphic start, Projectile projectile, Graphic end, Item... runes) {
