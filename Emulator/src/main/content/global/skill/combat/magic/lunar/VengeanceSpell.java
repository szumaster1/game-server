...
public final class VengeanceSpell extends MagicSpell {
    ...
    public Plugin<SpellType> newInstance(SpellType arg) throws Throwable {
        // Vengeance other
        SpellBook.LUNAR.register(19, new VengeanceSpell(93, 78, Animation.create(4411), new Graphic(725, 96), Runes.ASTRAL_RUNE.getItem(3), Runes.DEATH_RUNE.getItem(2), Runes.EARTH_RUNE.getItem(10)));
        // Vengeance
        SpellBook.LUNAR.register(14, new VengeanceSpell(94, 112, Animation.create(4410), new Graphic(726, 96), Runes.ASTRAL_RUNE.getItem(4), Runes.DEATH_RUNE.getItem(2), Runes.EARTH_RUNE.getItem(10)));
        return this;
    }
