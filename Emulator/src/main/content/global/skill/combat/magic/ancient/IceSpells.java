...
public final class IceSpells extends CombatSpell {
    ...
    private IceSpells(SpellType type, int level, double baseExperience, int impactSound, Animation anim, Graphic start, Projectile projectile, Graphic end, Item... runes) {
