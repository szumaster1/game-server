...
/**
 * Represents the Dwarven mine crevice shortcut.
 */
class DwarvenMineCreviceShortcut : InteractionListener {
    ...
    override fun defineListeners() {
        on(Scenery.CREVICE_30868, IntType.SCENERY, "squeeze-through") { player, _ ->
            ...
            val movement = ForceMovement(player, player.location, destination, Animation(Animations.DUCK_UNDER_OBSTACLE_2240))
