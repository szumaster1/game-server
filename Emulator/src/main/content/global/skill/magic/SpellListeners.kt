...
object SpellListeners {
    ...
    fun run(button: Int, type: Int, book: String, player: Player, node: Node? = null) {
        ...
        if (type in intArrayOf(content.global.skill.magic.SpellListener.NPC, content.global.skill.magic.SpellListener.OBJECT, content.global.skill.magic.SpellListener.PLAYER, content.global.skill.magic.SpellListener.GROUND_ITEM)) {
