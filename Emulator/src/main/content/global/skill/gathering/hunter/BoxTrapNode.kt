 ...
 */
open class BoxTrapNode(npcIds: IntArray, level: Int, experience: Double, rewards: Array<Item>, private val summoningLevel: Int) : TrapNode(npcIds, level, experience, intArrayOf(19188, 19189), rewards) {
