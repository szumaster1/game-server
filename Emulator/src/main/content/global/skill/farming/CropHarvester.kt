            ...
            return object : Pulse(0) {
                override fun pulse(): Boolean {
                    ...
                    val anim = when (requiredItem) {
                        ...
                        Items.SECATEURS_5329 -> if (fPatch.type == PatchType.TREE_PATCH) Animation(2277) else Animation(
                            7227
                        )

                        Items.MAGIC_SECATEURS_7409 -> if (fPatch.type == PatchType.TREE_PATCH) Animation(3340) else Animation(
                            7228
                        )
                    ...
                    val sendHarvestMessages = fPatch.type != PatchType.FLOWER_PATCH
