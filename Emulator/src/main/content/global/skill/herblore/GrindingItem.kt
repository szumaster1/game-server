...
enum class GrindingItem(val items: List<Item>, val product: Item, val message: String) {
    ...
    BIRDS_NEST(
        items = listOf(
            Item(Items.BIRDS_NEST_5070), Item(Items.BIRDS_NEST_5071),
            Item(Items.BIRDS_NEST_5072), Item(Items.BIRDS_NEST_5073),
            Item(Items.BIRDS_NEST_5074), Item(Items.BIRDS_NEST_5075)
        ),
