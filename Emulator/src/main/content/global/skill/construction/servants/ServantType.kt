...
/**
 * Represents different types of servants.
 */
enum class ServantType(val npcId: Int, val cost: Int, val capacity: Int, val level: Int, val timer: Int, vararg val food: Item?) {
    NONE(
        npcId = -1,
        cost = -1,
        capacity = -1,
    ...
    companion object {
        /**
         * Get the servant type based on the given id.
         *
         * @param id the npc id.
         * @return the servant type or `null` if not found.
         */
        @JvmStatic
