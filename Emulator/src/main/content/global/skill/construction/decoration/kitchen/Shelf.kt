 ...
 */
class Shelf : InteractionListener {
    ...
    inner class ShelfDialogue(player: Player? = null) : Dialogue(player) {
        ...
        override fun open(vararg args: Any): Boolean {
            ...
            when (id) {
                ...
                13546 -> showTopics(Topic("Kettle", 1, true), Topic("Teapot", 1, true), Topic("Clay cup", 1, true), Topic("Empty beer glass", 1, true))
                13547 -> showTopics(Topic("Kettle", 1, true), Topic("Teapot", 1, true), Topic("Clay cup", 1, true), Topic("Empty beer glass", 1, true), Topic("Cake tin", 1, true))
                13548 -> showTopics(Topic("Kettle", 2, true), Topic("Teapot", 2, true), Topic("Clay cup", 2, true), Topic("Empty beer glass", 2, true), Topic("Bowl", 2, true))
                13549 -> showTopics(Topic("Kettle", 3, true), Topic("Teapot", 3, true), Topic("Clay cup", 3, true), Topic("Empty beer glass", 3, true), Topic("More Options", 3, true))
                13550, 13551 -> showTopics(Topic("Kettle", 5, true), Topic("Teapot", 5, true), Topic("Porcelain cup", 5, true), Topic("Empty beer glass", 5, true), Topic("More Options", 5, true))
            }
            return true
        }
