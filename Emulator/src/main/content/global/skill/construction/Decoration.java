...
public enum Decoration {
    ...
    GARDEN_HABITAT(new int[]{
        ...
        44561,
        44562,
        44563 }, 15222, 37, 201, new Item[] { new Item(Items.BAGGED_PLANT_1_8431, 1), new Item(Items.BAGGED_PLANT_2_8433, 1), new Item(Items.BAGGED_PLANT_3_8435, 1) }),
    JUNGLE_HABITAT(new int[]
        {
            ...
            44627,
            44628,
            44629 }, 15223, 47, 278, new Item[] { new Item(Items.BAGGED_PLANT_3_8435, 3), new Item(Items.BAGGED_WILLOW_TREE_8423, 1), new Item(Items.BUCKET_OF_WATER_1929, 5) }),
    DESERT_HABITAT(new int[]
        {
            ...
            44693,
            44694,
            44695 }, 15224, 57, 238, new Item[] { new Item(Items.BUCKET_OF_SAND_1783, 10), new Item(Items.LIMESTONE_BRICK_3420, 5), new Item(15237, 1) }),
    POLAR_HABITAT(new int[]
        {
            ...
            44759,
            44760,
            44761 }, 15225, 67, 373, new Item[] { new Item(Items.AIR_RUNE_556, 1000), new Item(Items.WATER_RUNE_555, 1000), new Item(15239, 1) }),
    VOLCANIC_HABITAT(new int[]
        {
            ...
            44825,
            44826,
            44827 }, 15226, 77, 77, new Item[] { new Item(Items.FIRE_RUNE_554, 1000), new Item(Items.EARTH_RUNE_557, 1000), new Item(Items.BAGGED_DEAD_TREE_8417, 1), new Item(Items.STONE_SLAB_13245, 5) }),
    ...
    /**
     * The item ID of the flatpack requirement.
     */
     ...
     * @param invisibleNode Whether the node is invisible.
     */
    ...
    /**
     * Constructs a new {@code Decoration} object.
     */
    ...
    /**
     * If this node should be invisible to user build options
     * @return the int ID of the flatpack item for this decoration (if it exists).
     */
