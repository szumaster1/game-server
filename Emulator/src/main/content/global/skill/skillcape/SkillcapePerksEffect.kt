 ...
 */
enum class SkillcapePerksEffect(val attribute: String, val effect: ((Player) -> Unit)? = null) {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun isActive(perk: SkillcapePerksEffect, player: Player): Boolean {
         ...
         */
        fun forSkillcape(skillcape: Skillcape): SkillcapePerksEffect {
