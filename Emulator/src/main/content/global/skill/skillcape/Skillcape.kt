...
enum class Skillcape {
    ATTACK, STRENGTH, DEFENCE, RANGING, PRAYER, MAGIC, RUNECRAFTING, HITPOINTS, AGILITY, HERBLORE, THIEVING, CRAFTING, FLETCHING, SLAYER, CONSTRUCTION, MINING, SMITHING, FISHING, COOKING, FIREMAKING, WOODCUTTING, FARMING, HUNTING, SUMMONING, NONE;
