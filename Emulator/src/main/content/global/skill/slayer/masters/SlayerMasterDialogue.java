package content.global.skill.slayer.masters;
    ...
    public boolean handle(int interfaceId, int buttonId) {
        ...
        switch (stage) {
            ...
            case 1:
                ...
                break;
            case 10:
                interpreter.sendDialogues(master.getNpc(), getExpression(master), "I'm " + (master.getNpc() == 8273 ? "the lowest level Slayer Master available." : "one of the elite Slayer Masters."), master.getNpc() == 8273 ? "The other Slayer Masters are spread around the world." : "I can teach you about the ways of the Slayer.");
                stage = 11;
                break;
            case 11:
