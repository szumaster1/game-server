    ...
    public boolean handle(int interfaceId, int buttonId) {
        ...
        switch (type) {
            case "hard":
                switch (buttonId) {
                    ...
                    case 3:
                        sendInputDialogue(player, true, "Enter the amount:", (value) -> {
                            player.getPulseManager().run(new HardLeatherCraftingPulse(player, null, (int) value));
                ...
                player.getPulseManager().run(new HardLeatherCraftingPulse(player, null, amt));
                break;
            case "dragon":
                int index = 0;
                ...
                switch (buttonId) {
                    ...
                    case 12:
                        ...
                        sendInputDialogue(player, InputType.AMOUNT, "Enter the amount:", (value) -> {
                            player.getPulseManager().run(new DragonCraftingPulse(player, null, hidee, (int) value));
                            return Unit.INSTANCE;
                        });
                        return true;
                }
                ...
                player.getPulseManager().run(new DragonCraftingPulse(player, null, hide, amt));
                break;
        }
        return true;
    }
