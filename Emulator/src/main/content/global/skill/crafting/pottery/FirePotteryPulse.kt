...
class FirePotteryPulse(player: Player?, node: Item?, val pottery: Pottery, var amount: Int) :
    ...
    override fun reward(): Boolean {
        ...
        if (removeItem(player, pottery.unfinished)) {
            ...
            /*
             * Diary: Spin a bowl on the pottery wheel and fire it in the oven in Barbarian Village.
             */
            ...
            /*
             * Diary: Fire a pot in the kiln in the Barbarian Village potter's house.
             */
