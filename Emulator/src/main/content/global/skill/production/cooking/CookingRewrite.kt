...
class CookingRewrite : InteractionListener {
    ...
    companion object {
        val COOKING_OBJs = intArrayOf(
            114, 2724, 2725, 2726, 2728, 2729, 2730, 2731, 2732, 2859, 3038, 3039,
            3769, 3775, 4172, 4265, 4266, 4618, 4650, 5165, 5249, 5275, 5499, 5631,
            5632, 5981, 6093, 6094, 6095, 6096, 8712, 8750, 9085, 9086, 9087, 9374,
            9439, 9440, 9441, 9682, 10377, 10433, 10824, 11404, 11405, 11406, 12102,
            12269, 12796, 13337, 13528, 13529, 13531, 13533, 13536, 13539, 13542,
            13881, 14169, 14919, 15156, 15398, 16893, 17640, 17641, 17642, 17643,
            18039, 20000, 20001, 21302, 21620, 21792, 21795, 22154, 22713, 22714,
            23046, 24283, 24284, 24285, 24313, 24329, 25155, 25156, 25440, 25441,
            25465, 25730, 27251, 27297, 29139, 30017, 32099, 33498, 33500, 34410,
            34495, 34546, 34565, 35449, 36815, 36816, 36973, 37426, 37597, 37629,
            37726, 40110
        )
        ...
        fun cook(player: Player, scenery: Scenery?, initial: Int, product: Int, amount: Int) {
            ...
            val cookingPulse = when {
                ...
                CookableItems.intentionalBurn(initial) -> IntentionalBurnPulse(player, scenery!!, initial, product, amount)
                else -> StandardCookingPulse(player, scenery!!, initial, product, amount)
            }
