...
internal constructor(override var player: Player, override var scenery: Scenery, override var initial: Int, override var product: Int, override var amount: Int) : StandardCookingPulse(player, scenery, initial, product, amount) {
