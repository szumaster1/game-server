 ...
 */
@Initializable
class ThievingDoorHandler : OptionHandler() {
    ...
    /**
     * Constructs a new `PickableDoor` `Object`.
     *
    ...
    inner class PickableDoor(
        ...
        fun pickLock(player: Player, door: Scenery) {
            ...
            if (getStatLevel(player, Skills.THIEVING) < level) {
                ...
                player.impactHandler.manualHit(player, RandomFunction.random(1, 3), ImpactHandler.HitsplatType.NORMAL)
                sendMessageWithDelay(player, if (hit) "You have activated a trap on the lock." else "You fail to pick the lock.", 1)
                return
            }
    ...
    companion object {
         ...
         * The door ids.
         */
        private val DOORS = intArrayOf(42028, 2550, 2551, 2554, 2555, 2556, 2557, 2558, 2559, 5501, 7246, 9565, 13314, 13317, 13320, 13323, 13326, 13344, 13345, 13346, 13347, 13348, 13349, 15759, 34005, 34805, 34806, 34812)
    }
}