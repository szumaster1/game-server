...
enum class Pickpocket(val ids: IntArray, val requiredLevel: Int, val low: Double, val high: Double, val experience: Double, val stunDamageMin: Int, val stunDamageMax: Int, val stunTime: Int, val message: String?, val table: WeightBasedTable) {
     ...
     */
    MAN(
        ids = intArrayOf(NPCs.MAN_1, NPCs.MAN_2, NPCs.MAN_3, NPCs.WOMAN_4, NPCs.WOMAN_5, NPCs.WOMAN_6, NPCs.MAN_16, NPCs.MAN_24, NPCs.WOMAN_25, NPCs.MAN_170, NPCs.MAN_1086,NPCs.HENGEL_2683, NPCs.ANJA_2684, NPCs.MAN_3224, NPCs.MAN_3915, NPCs.WOMAN_3226, NPCs.WOMAN_3227, NPCs.WOMAN_5924, NPCs.MAN_5923),
        requiredLevel = 1,
        low = 180.0,
        high = 240.0,
        experience = 8.0,
