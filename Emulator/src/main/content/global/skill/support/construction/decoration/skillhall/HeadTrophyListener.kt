...
class AbyssalDemonHeadTrophyDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            6 -> npcl(
                FacialExpression.CHILD_EVIL_LAUGH,
                "You'll get an$DARK_RED ABYSSAL WHIPPING</col>!"
            ).also { stage++ }
            ...
            12 -> npc(
                FacialExpression.CHILD_FRIENDLY,
                "Poor deluded fool. There is no hope for you at all."
            ).also { stage = END_DIALOGUE }
...
class BasiliskHeadTrophyDialogue : DialogueFile() {
    ...
    private val randomWord_0 =
        RandomFunction.getRandomElement(arrayOf("boring", "fat", "hideous", "puny", "smelly", "stupid"))
    private val randomWord_1 =
        RandomFunction.getRandomElement(arrayOf("beetle", "chicken", "egg", "mud", "slime", "worm"))
    private val randomWord_2 =
        RandomFunction.getRandomElement(arrayOf("brained", "eating", "like", "loving", "smelling", "witted"))
    private val randomWord_3 =
        RandomFunction.getRandomElement(arrayOf("basilisk", "idiot", "lizard", "mudworm", "slimeball", "weakling"))
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            4 -> playerl(
                ...
                "You're a $randomWord_0 $randomWord_1 $randomWord_2 $randomWord_3."
            ).also { stage++ }
            ...
            24 -> when (buttonID) {
                1 -> playerl(
                    FacialExpression.FRIENDLY,
                    "That's why I won't do it again! There's be no point!"
                ).also { stage = 15 }
            ...
            29 -> npcl(
                FacialExpression.CHILD_FRIENDLY,
                "All right then. Apology accepted. Now leave me alone."
            ).also { stage = END_DIALOGUE }
            ...
            34 -> npcl(
                FacialExpression.CHILD_FRIENDLY,
                "Perhaps if you were to move to one side of me."
            ).also { stage++ }
            ...
            37 -> npcl(FacialExpression.CHILD_FRIENDLY, "Oh, it's moved away. I can see now.").also {
                stage = END_DIALOGUE
            }
        }
    }
...
class CockatriceHeadTrophyDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            9 -> playerl(
                FacialExpression.FRIENDLY,
                "Don't take it personally. You look good on my wall."
            ).also { stage++ }

            10 -> npcl(
                FacialExpression.CHILD_FRIENDLY,
                "I don't care! I think I looked better with a body!"
            ).also { stage = END_DIALOGUE }
            ...
            100 -> npc(FacialExpression.CHILD_FRIENDLY, "House owner deaded me! That wasn't very nice!").also {
                stage = END_DIALOGUE
            }
        }
    }
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        if (randomConversation == 1) {
            when (stage) {
                ...
                300 -> player(
                    FacialExpression.LOUDLY_LAUGHING,
...
class KingBlackDragonHeadTrophyDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        when (stage) {
            ...
            22 -> playerl(
                FacialExpression.FRIENDLY,
                "Now that you're just a stuffed head? I don't think so!"
            ).also { stage = END_DIALOGUE }
