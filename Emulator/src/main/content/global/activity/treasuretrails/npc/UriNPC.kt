...
class UriNPC : AbstractNPC {
    ...
    private var clueScroll: content.global.activity.treasuretrails.clue.ClueScrollPlugin? = null
    ...
    class UriDialogue : Dialogue {
        ...
        private fun canSpeak(): Boolean {
            val scroll = asUri().clueScroll as content.global.activity.treasuretrails.scroll.EmoteClueScroll?
