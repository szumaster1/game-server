 ...
 * @author Vexia
 */
class TreasureTrailManager : LoginListener, PersistPlayer {
    /**
     * The player.
     */
    val player: Player?
    ...
    /**
     * Constructs a new [TreasureTrailManager].
     *
     ...
     * @param clue the clue.
     */
    fun startTrail(clue: content.global.activity.treasuretrails.clue.ClueScrollPlugin) {
        setClue(clue)
     ...
     * @param clue the clue.
     */
    fun setClue(clue: content.global.activity.treasuretrails.clue.ClueScrollPlugin) {
        clueId = clue.clueId
        level = clue.level
    }
