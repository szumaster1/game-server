...
import content.global.activity.champion.handlers.npc.LeonDCourNPC.Companion.spawnFinalChampion
 ...
 */
class ChampionChallenge : InteractionListener, MapArea {
    ...
    companion object {
        ...
        fun isFinalBattle(player: Player) {
            ...
            if (allVarbitsSet) {
                player.lock(1)
                sendNPCDialogueLines(player, NPCs.LEON_DCOUR_3067, FacialExpression.NEUTRAL, false, "You have done well brave adventurer, but I would test", "your mettle now. You may arrange the fight with", "Larxus at your leisure.")
