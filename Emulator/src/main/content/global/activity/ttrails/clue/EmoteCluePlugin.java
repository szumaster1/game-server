package content.global.activity.ttrails.clue;

import content.global.activity.ttrails.ClueLevel;
import content.global.activity.ttrails.npc.UriNPC;
...
public final class EmoteCluePlugin extends EmoteClueScroll {
	...
	public Plugin<Object> newInstance(Object arg) throws Throwable {
		...
		register(new EmoteCluePlugin("fishing-guild-blow", 2683, ClueLevel.HARD, emote, new int[][] {{2890}, {2493}, {1347}}, "Blow a raspberry in the<br>Fighing Guild bank. Beware<br>of double agents!<br>Equip and elemental shield<br>,blue dragonhide chaps<br>and a rune warhammer.", new ZoneBorders(2586, 3418, 2590, 3422)));
		emote = Emotes.CHEER;
		...
		register(new EmoteCluePlugin("observatory-think", 2727, ClueLevel.MEDIUM, emote, Emotes.SPIN, new int[][] {{1109}, {1099}, {1698}}, "Think in the centre of<br>the Observatory. Spin<br>before you talk to me.<br>Equip a mithril chain<br>body, green<br>dragonhide chaps and<br>a ruby amulet.", new ZoneBorders(2439, 3160, 2442, 3163)));
		emote = Emotes.WAVE;
		...
		register(new EmoteCluePlugin("castle-wars-yawn", 2739, ClueLevel.MEDIUM, emote, Emotes.SHRUG, new int[][] { { 1698 }, { 1329 }, ClueScrollPlugin.WILDERNESS_CAPES}, "Yawn in the Castle<br>Wars lobby. Shrug<br>before you talk to me.<br>Equip ruby amulet, a<br>mithril scimitar and a<br>Wilderness cape.", new ZoneBorders(2434, 3061, 2464, 3102)));
