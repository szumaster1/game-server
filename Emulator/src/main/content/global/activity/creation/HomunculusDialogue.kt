...
class HomunculusDialogue : DialogueFile() {
    ...
    override fun handle(componentID: Int, buttonID: Int) {
        ...
        when (stage) {
            ...
            1 -> npcl(FacialExpression.OLD_NORMAL, "Good! I gain know from alchemists and builders. Me make beings.").also { stage++ }
            ...
            4 -> npcl(FacialExpression.OLD_NORMAL, "Yes, you right!").also { stage++ }
            5 -> playerl(FacialExpression.HALF_ASKING, "So what do you need me to do?").also { stage++ }
            6 -> npcl(FacialExpression.OLD_NORMAL, "Inspect symbol of life altars around dungeon. You see item give. Use item on altar. Activate altar to create, you fight.").also { stage++ }
