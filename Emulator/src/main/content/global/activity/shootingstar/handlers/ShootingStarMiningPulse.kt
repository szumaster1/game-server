package content.global.activity.shootingstar.handlers
 ...
 */
class ShootingStarMiningPulse(player: Player?, node: Scenery?, val star: content.global.activity.shootingstar.handlers.ShootingStar) : SkillPulse<Scenery?>(player, node) {
    ...
    override fun checkRequirements(): Boolean {
        ...
        if (!star.isDiscovered && !player.isArtificial) {
            ...
            content.global.activity.shootingstar.handlers.ShootingStarPlugin.Companion.submitScoreBoard(player)
        ...
        if (freeSlots(player) < 1 && !inInventory(player,
                content.global.activity.shootingstar.handlers.ShootingStarPlugin.Companion.STAR_DUST, 1)) {
    ...
    override fun reward(): Boolean {
        ...
        if (content.global.activity.shootingstar.handlers.ShootingStarPlugin.Companion.getStarDust(player) < 200) {
            addItem(player, content.global.activity.shootingstar.handlers.ShootingStarPlugin.Companion.STAR_DUST, 1)
        }
    ...
    fun rollBlueprint(player: Player) {
        val chance = when (star.level) {
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_9 -> 250
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_8 -> 500
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_7 -> 750
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_6 -> 1000
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_5 -> 2000
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_4 -> 3000
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_3 -> 4000
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_2 -> 5000
            content.global.activity.shootingstar.handlers.ShootingStarType.LEVEL_1 -> 10000
        }
