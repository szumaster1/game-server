...
class EstateAgentDialogue(player: Player? = null) : Dialogue(player) {
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            3 -> npc("I can sell you a starting house in Rimmington for", "1000 coins. As you increase your construction skill you", "will be able to have your house moved to other areas", "and redecorated in other styles.").also { stage++ }
            ...
            11 -> options("Rimmington (5,000)", "Taverley (5,000)", "Pollnivneach (7,500)", "Rellekka (10,000)", "More...").also { stage++ }
            12 -> when (buttonId) {
            ...
            32 -> when (buttonId) {
                ...
                5 -> options("Tropical wood (15,000)", "Fancy stone (25,000)", "Previous...", "Back").also { stage++ }
            }
            33 -> when (buttonId) {
            ...
            102 -> npc(FacialExpression.JOLLY, "I see you have recently achieved 99 construction.", "Would you like to buy a cape for 99,0000 gp?").also { stage++ }
