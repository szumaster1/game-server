...
public final class ClanJoinNotification extends
    ...
    getDescriptor() {
        return ManagementProtos.internal_static_management_ClanJoinNotification_descriptor;
    }

    @Override
    protected FieldAccessorTable
    internalGetFieldAccessorTable() {
        return ManagementProtos.internal_static_management_ClanJoinNotification_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        ClanJoinNotification.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ClanJoinNotification)) {
            return super.equals(obj);
        }
        ClanJoinNotification other = (ClanJoinNotification) obj;
    ...
    /**
     * Parse from clan join notification.
     *
     * @param data the data
     * @return the clan join notification
     * @throws InvalidProtocolBufferException the invalid protocol buffer exception
     */
    public static ClanJoinNotification parseFrom(
     ...
     * @throws InvalidProtocolBufferException the invalid protocol buffer exception
     */
    public static ClanJoinNotification parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
     ...
     */
    public static ClanJoinNotification parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    /**
     * Parse delimited from clan join notification.
     *
     * @param input the input
     * @return the clan join notification
     * @throws IOException the io exception
     */
    public static ClanJoinNotification parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
     ...
     * @throws IOException the io exception
     */
    public static ClanJoinNotification parseDelimitedFrom(
            java.io.InputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
     ...
     * @return the builder
     */
    public static Builder newBuilder(ClanJoinNotification prototype) {
    ...
    public static final class Builder extends
        ...
        @Override
        public ClanJoinNotification getDefaultInstanceForType() {
            return ClanJoinNotification.getDefaultInstance();
        }

        @Override
        public ClanJoinNotification build() {
            ClanJoinNotification result = buildPartial();
        ...
        @Override
        public ClanJoinNotification buildPartial() {
            ClanJoinNotification result = new ClanJoinNotification(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof ClanJoinNotification) {
                return mergeFrom((ClanJoinNotification) other);
            } else {
         ...
         * @return the builder
         */
        public Builder mergeFrom(ClanJoinNotification other) {
            if (other == ClanJoinNotification.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
                ...
                com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                throws java.io.IOException {
            ClanJoinNotification parsedMessage = null;
            try {
                parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
            } catch (com.google.protobuf.InvalidProtocolBufferException e) {
                parsedMessage = (ClanJoinNotification) e.getUnfinishedMessage();
    ...
    private static final ClanJoinNotification DEFAULT_INSTANCE;

    static {
        DEFAULT_INSTANCE = new ClanJoinNotification();
    }
     ...
     */
    public static ClanJoinNotification getDefaultInstance() {
     ...
     */
    @Deprecated
    public static final com.google.protobuf.Parser<ClanJoinNotification>
